...
$(document).ready(function () {
    ...
    setTimeout(function () { $('.gallary-hero-slogan').addClass('animated fadeInDown') }, 0); //300
    setTimeout(function () { $('.gallary-hero-description').addClass('animated fadeInUp') }, 0); //500
	...
	function homeHero() {
		...
		$('.gallary-hero-typo').css({"padding-bottom": subscriptionHeight + 70});
	}
