!function(e) {
    ...
    function r(e, t) {
        ...
        function() {
            var n, r = arguments[0];
            for (n = "[" + (e ? e + ":" : "") + r + "] http://errors.angularjs.org/1.6.8/" + (e ? e + "/" : "") + r,
    ...
    function i(e) {
        if (null == e || E(e))
            return !1;
        if (or(e) || w(e) || Rn && e instanceof Rn)
            return !0;
    ...
    function o(e, t, n) {
        ...
        if (e)
            if (S(e))
                for (r in e)
                    "prototype" !== r && "length" !== r && "name" !== r && e.hasOwnProperty(r) && t.call(n, e[r], r, e);
            else if (or(e) || i(e)) {
        ...
        for (var r = e.$$hashKey, i = 0, o = t.length; i < o; ++i) {
            ...
            if (y(a) || S(a))
                for (var s = Object.keys(a), c = 0, l = s.length; c < l; c++) {
                    var d = s[c]
                      , f = a[d];
                    n && y(f) ? x(f) ? e[d] = new Date(f.valueOf()) : k(f) ? e[d] = new RegExp(f) : f.nodeName ? e[d] = f.cloneNode(!0) : O(f) ? e[d] = f.clone() : (y(e[d]) || (e[d] = or(f) ? [] : {}),
                    u(e[d], [f], !0)) : e[d] = f
                }
        }
    ...
    function U(e, t, r) {
        function i(e, t, n) {
            ...
            if (or(e)) {
                ...
                for (r in e)
                    Hn.call(e, r) && (t[r] = a(e[r], n));
            return i ? t.$$hashKey = i : delete t.$$hashKey,
            t
        }
        function a(e, t) {
            if (!y(e))
            ...
            var n = !1
              , r = function(e) {
                ...
                case "[object RegExp]":
                    return (t = new RegExp(e.source,e.toString().match(/[^/]*$/)[0])).lastIndex = e.lastIndex,
                    t;
                case "[object Blob]":
            ...
            return void 0 === r && (r = or(e) ? [] : Object.create(Yn(e)),
            n = !0),
            u.push(e),
            c.push(r),
            n ? i(e, r, t) : r
        ...
        if (r = n(r) ? r : NaN,
        t) {
            if ((s = t) && A(s.length) && ar.test(Qn.call(s)) || "[object ArrayBuffer]" === Qn.call(t))
                throw Xn("cpta");
            if (e === t)
                throw Xn("cpi");
    ...
    function P(e, t) {
        ...
        if (r === typeof t && "object" === r) {
            if (!or(e)) {
                if (x(e))
                    return !!x(t) && V(e.getTime(), t.getTime());
                if (k(e))
                    return !!k(t) && e.toString() === t.toString();
                if (_(e) || _(t) || E(e) || E(t) || or(t) || x(t) || k(t))
                    return !1;
                for (n in r = oe(),
                e)
                    if ("$" !== n.charAt(0) && !S(e[n])) {
                ...
                for (n in t)
                    if (!(n in r) && "$" !== n.charAt(0) && v(t[n]) && !S(t[n]))
                        return !1;
                return !0
            }
            if (!or(t))
    ...
    function B(t, n) {
        var r = n;
        return "string" == typeof t && "$" === t.charAt(0) && "$" === t.charAt(1) ? r = void 0 : E(n) ? r = "$WINDOW" : n && e.document === n ? r = "$DOCUMENT" : _(n) && (r = "$SCOPE"),
        r
    }
    function N(e, t) {
        if (!$(e))
            return A(t) || (t = t ? 2 : null),
            JSON.stringify(e, B, t)
    }
    function R(e) {
    ...
    function q(e, t, n) {
        ...
        return n *= (t = j(t, r)) - r,
        (e = new Date(e.getTime())).setMinutes(e.getMinutes() + n),
        e
    }
    function z(e) {
        e = Rn(e).clone().empty();
    ...
    function H(e) {
        ...
        return o((e || "").split("&"), function(e) {
            ...
            i = e.substring(n + 1)),
            v(r = L(r)) && (i = !v(i) || L(i),
            Hn.call(t, r) ? or(t[r]) ? t[r].push(i) : t[r] = [t[r], i] : t[r] = i))
        }),
        t
    }
    function G(e) {
    ...
    function J(t, n) {
        ...
        o(fr, function(e) {
            e += "app",
            !r && t.hasAttribute && t.hasAttribute(e) && (r = t,
            i = t.getAttribute(e))
        }),
        o(fr, function(e) {
            var n;
            e += "app",
            !r && (n = t.querySelector("[" + e.replace(":", "\\:") + "]")) && (r = n,
            i = n.getAttribute(e))
        }),
        r && (pr ? (a.strictDi = null !== function(e, t) {
            ...
            for (r = 0; r < i; ++r)
                if (n = fr[r] + t,
                w(n = e.getAttribute(n)))
                    return n;
            return null
        }(r, "strict-di"),
        n(r, i ? [i] : [], a)) : e.console.error("Angular: disabling automatic bootstrap. <script> protocol indicates an extension, document.location.href does not match."))
    }
    function Z(t, n, r) {
        y(r) || (r = {}),
        r = c({
        ...
        var i = function() {
            ...
            n.unshift("ng"),
            (i = Te(n, r.strictDi)).invoke(["$rootScope", "$rootElement", "$compile", "$injector", function(e, t, n, r) {
                e.$apply(function() {
                    t.data("$injector", r),
                    n(t)(e)
                })
    ...
    function Y(e) {
        if (!(e = er.element(e).injector()))
            throw Xn("test");
        return e.get("$$testability")
    }
    function X(e, t) {
        return t = t || "_",
        e.replace(hr, function(e, n) {
            return (n ? t : "") + e.toLowerCase()
        })
    }
    function ee(e, t, n) {
        if (!e)
            throw Xn("areq", t || "?", n || "required");
        return e
    }
    function te(e, t, n) {
        return n && or(e) && (e = e[e.length - 1]),
        ee(S(e), t, "not a function, got " + (e && "object" == typeof e ? e.constructor.name || "Object" : typeof e)),
        e
    }
    function ne(e, t) {
        if ("hasOwnProperty" === e)
    ...
    function re(e, t, n) {
        if (!t)
            return e;
        for (var r, i = e, o = (t = t.split(".")).length, a = 0; a < o; a++)
            r = t[a],
            e && (e = (i = e)[r]);
    ...
    function fe(e, t) {
        var n, r, i = t.createDocumentFragment(), a = [];
        if (Sr.test(e)) {
            for (n = i.appendChild(t.createElement("div")),
            r = (kr.exec(e) || ["", ""])[1].toLowerCase(),
            r = _r[r] || _r._default,
            n.innerHTML = r[1] + e.replace(Er, "<$1></$2>") + r[2],
            r = r[0]; r--; )
                n = n.lastChild;
            a = T(a, n.childNodes),
    ...
    function pe(t) {
        ...
        n ? (n = e.document,
        xe(this, t = (r = Cr.exec(t)) ? [n.createElement(r[1])] : (r = fe(t, n)) ? r.childNodes : [])) : S(t) ? _e(t) : xe(this, t)
    }
    function he(e) {
        return e.cloneNode(!0)
    }
    function ge(e, t) {
        !t && de(e) && Rn.cleanData([e]),
        e.querySelectorAll && Rn.cleanData(e.querySelectorAll("*"))
    }
    function me(e, t, n, r) {
        if (v(r))
            throw xr("offargs");
        ...
        if (a)
            if (t) {
                var s = function(t) {
                    var r = i[t];
                    v(n) && F(r || [], n),
                    v(n) && r && 0 < r.length || (e.removeEventListener(t, a),
                    delete i[t])
                };
                ...
                for (t in i)
                    "$destroy" !== t && e.removeEventListener(t, a),
                    delete i[t]
    }
    function $e(e, t) {
        var n = e.ng339
    ...
    function ye(e, t, n) {
        if (de(e)) {
            var r, i = v(n), o = !i && t && !y(t), a = !t;
            if (e = (e = ve(e, !o)) && e.data,
            i)
                e[le(t)] = n;
            else {
                if (a)
    ...
    function Te(e, t) {
            ...
            return o(e, function(e) {
                ...
                if (!d.get(e)) {
                    ...
                    try {
                        w(e) ? (t = qn(e),
                        v.modules[e] = t,
                        n = n.concat(a(t.requires)).concat(t._runBlocks),
                        r(t._invokeQueue),
                        r(t._configBlocks)) : S(e) ? n.push(p.invoke(e)) : or(e) ? n.push(p.invoke(e)) : te(e, "module")
                    } catch (t) {
                        throw or(e) && (e = e[e.length - 1]),
                        t.message && t.stack && -1 === t.stack.indexOf(t.message) && (t = t.message + "\n" + t.stack),
                        qr("modulerr", e, t.stack || t.message || t)
                    }
                }
            }),
            n
        ...
        function u(e, n) {
            ...
            return {
                invoke: function(e, t, n, r) {
                    ...
                    or(e) && (e = e[e.length - 1]),
                    r = e,
                    Nn || "function" != typeof r)
                        r = !1;
                    else {
                        var o = r.$$ngIsClass;
                        D(o) || (o = r.$$ngIsClass = /^(?:class\b|constructor\()/.test(Function.prototype.toString.call(r))),
                        r = o
                    }
                    return r ? (n.unshift(null),
                    new (Function.prototype.bind.apply(e, n))) : e.apply(t, n)
                },
                instantiate: function(e, t, n) {
                    var r = or(e) ? e[e.length - 1] : e;
                    return (e = i(e, t, n)).unshift(null),
                    new (Function.prototype.bind.apply(r, e))
                },
                get: r,
        ...
        var b = a(e);
        return (v = m.get("$injector")).strictDi = t,
        o(b, function(e) {
            e && v.invoke(e)
        }),
    ...
    function Ie() {
        ...
        this.$get = ["$window", "$location", "$rootScope", function(n, r, i) {
            function o(e) {
                var t;
                e ? (e.scrollIntoView(),
                S(t = a.yOffset) ? t = t() : O(t) ? (t = t[0],
                t = "fixed" !== n.getComputedStyle(t).position ? 0 : t.getBoundingClientRect().bottom) : A(t) || (t = 0),
                t && (e = e.getBoundingClientRect().top,
                n.scrollBy(0, e - t))) : n.scrollTo(0, 0)
            }
            function a(e) {
                var t, n, i;
                (e = w(e) ? e : A(e) ? e.toString() : r.hash()) ? (t = s.getElementById(e)) ? o(t) : (n = s.getElementsByName(e),
                i = null,
    ...
    function Re() {
        this.$get = ["$window", "$log", "$sniffer", "$document", function(e, t, n, r) {
            return new function(e, t, n, r) {
                ...
                var m = 0
                  , v = [];
                c.$$completeOutstandingRequest = i,
                ...
                ;
                var y, b, w = l.href, A = t.find("base"), x = null, C = r.history ? function() {
                    try {
                        return d.state
                    } catch (e) {}
                }
                ...
                c.url = function(t, n, i) {
                    ...
                    t) {
                        ...
                        !r.history || a && o ? (a || (x = t),
                        n ? l.replace(t) : a ? (n = l,
                        i = -1 === (i = t.indexOf("#")) ? "" : t.substr(i),
                        n.hash = i) : l.href = t,
                        l.href !== t && (x = t)) : (d[n ? "replaceState" : "pushState"](i, "", t),
                        s()),
                        x && (x = t),
                        c
                    }
                ...
                c.onUrlChange = function(t) {
                    return k || (r.history && Rn(e).on("popstate", a),
                    Rn(e).on("hashchange", a),
                    k = !0),
                    S.push(t),
                    t
                }
    ...
    function ze(t, n) {
        function r(e, t, n) {
            ...
            return o(e, function(e, o) {
                if (e in b)
                    ...
                    var a = e.match(r);
                    if (!a)
                        throw Zr("iscp", t, o, e, n ? "controller bindings definition" : "isolate scope definition");
                    i[o] = {
                        mode: a[1][0],
                        collection: "*" === a[2],
                        optional: "?" === a[3],
        ...
        this.directive = function e(n, r) {
            ...
            ee(r, "directiveFactory"),
            i.hasOwnProperty(n) || (i[n] = [],
            t.factory(n + "Directive", ["$injector", "$exceptionHandler", function(e, t) {
                var r = [];
                return o(i[n], function(i, a) {
                    try {
                        ...
                        s.index = a,
                        s.name = s.name || n,
                        s.require = (f = (l = s).require || l.controller && l.name,
                        !or(f) && y(f) && o(f, function(e, t) {
                            var n = e.match(d);
                        ...
                        var u = s
                          , c = s.restrict;
                        if (c && (!w(c) || !/[EACM]/.test(c)))
                            throw Zr("badrestrict", c, n);
                        u.restrict = c || "EA",
        ...
        this.aHrefSanitizationWhitelist = function(e) {
            return v(e) ? (n.aHrefSanitizationWhitelist(e),
            this) : n.aHrefSanitizationWhitelist()
        }
        ,
        this.imgSrcSanitizationWhitelist = function(e) {
            return v(e) ? (n.imgSrcSanitizationWhitelist(e),
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(t, n, s, g, b, T, B, N, R, j) {
            function q() {
                try {
                    if (!--Se)
                        ...
                        Zr("infchng", E);
                    B.$apply(function() {
                        for (var e = [], t = 0, n = be.length; t < n; ++t)
                            try {
                                be[t]()
                            } catch (t) {
                                e.push(t)
            ...
            function G(e, t, n, r, i) {
                ...
                return function(t, n, r) {
                    ...
                    if (r = r.futureParentElement,
                    s && s.$$boundTransclude && (s = s.$$boundTransclude),
                    a || (a = (r = r && r[0]) && "foreignobject" !== M(r) && Qn.call(r).match(/SVG/) ? "svg" : "html"),
                    r = "html" !== a ? Rn(fe(a, Rn("<div>").append(e).html())) : n ? Or.clone.call(e) : e,
                    u)
                        for (var c in u)
                            r.data("$" + c + "Controller", u[c].instance);
                    return G.$$addScopeInfo(r, t),
                    n && n(r, t),
                    o && o(t, r, r, s),
                    n || (e = o = null),
                    r
            ...
            function W(e, t, n, r, i, o) {
                for (var a, s, u, c, l, d = [], f = or(e) || e instanceof Rn, p = 0; p < e.length; p++)
                    a = new L,
                    11 === Nn && K(e, p, f),
                    (o = (s = Z(e[p], [], a, 0 === p ? r : void 0, i)).length ? ne(s, e[p], a, t, n, null, [], [], o) : null) && o.scope && G.$$addScopeClass(a.$$element),
                    a = o && o.terminal || !(u = e[p].childNodes) || !u.length ? null : W(u, o ? (o.transcludeOnThisElement || !o.templateOnThisElement) && o.transclude : t),
                    (o || a) && (d.push(p, o, a),
                    c = !0,
                    l = l || o),
                    o = null;
                return c ? function(e, n, r, i) {
                    ...
                    c = d.length; u < c; )
                        ...
                        o = d[u++],
                        n ? (n.scope ? (s = e.$new(),
                        G.$$addScopeInfo(Rn(a), s)) : s = e,
                        n(o, s, a, r, n.transcludeOnThisElement ? J(e, n.transclude, i) : !n.templateOnThisElement && i ? i : !i && t ? J(e, t) : null)) : o && o(e, a.childNodes, void 0, i)
                }
                : null
            }
            function K(e, t, n) {
                ...
                if (i.nodeType === mr)
                    for (; (r = o ? i.nextSibling : e[t + 1]) && r.nodeType === mr; )
                        i.nodeValue += r.nodeValue,
            ...
            function J(e, t, n) {
                ...
                var i, o = r.$$slots = oe();
                for (i in t.$$slots)
                    o[i] = t.$$slots[i] ? J(e, t.$$slots[i], n) : null;
                return r
            }
            function Z(e, t, r, i, o) {
                ...
                case 1:
                    ...
                    for (var p, h, g, m, $ = e.attributes, v = 0, b = $ && $.length; v < b; v++) {
                        ...
                        g = p.value,
                        p = He(h),
                        (m = Oe.test(p)) && (h = h.replace(Yr, "").substr(8).replace(/_(.)/g, function(e, t) {
                            return t.toUpperCase()
                        })),
                        (p = p.match(Me)) && se(p[1]) && (A = h,
                        x = h.substr(0, h.length - 5) + "end",
                        h = h.substr(0, h.length - 6)),
                        f[p = He(h.toLowerCase())] = h,
                        !m && r.hasOwnProperty(p) || (r[p] = g,
                        De(e, p) && (r[p] = !0)),
                        pe(e, t, g, p, m),
                        ae(t, p, "A", i, o, A, x)
                    }
                    if ("input" === s && "hidden" === e.getAttribute("type") && e.setAttribute("autocomplete", "off"),
                    !Ce)
                        break;
                    if (y(f = e.className) && (f = f.animVal),
                    w(f) && "" !== f)
                        for (; e = u.exec(f); )
                            ae(t, p = He(e[2]), "C", i, o) && (r[p] = sr(e[3])),
                            f = f.substr(e.index + e[0].length);
                    break;
                case mr:
                    c = t,
                    l = e.nodeValue,
                    (d = n(l, !0)) && c.push({
                        ...
                        compile: function(e) {
                            ...
                            function(e, n) {
                                var r = n.parent();
                                t || G.$$addBindingClass(r),
                                G.$$addBindingInfo(r, d.expressions),
            ...
            function ne(e, t, n, r, i, a, u, l, d) {
                ...
                function p(e, r, i, a, d) {
                    var f, p, h, g, m, v, b, w;
                    for (f in t === i ? (a = n,
                    w = n.$$element) : a = new L(w = Rn(i),n),
                    m = r,
                    k ? g = r.$new(!0) : A && (m = r.$parent),
                    d && ((b = function(e, t, n, r) {
                        var i;
                        if (_(e) || (r = n,
                        n = t,
                        t = e,
                    ...
                    C && (v = function(e, t, n, r, i, o, a) {
                        ...
                        for (s in r) {
                            var c = r[s]
                              ...
                              , d = c.controller;
                            "@" === d && (d = t[c.name]),
                            l = T(d, l, !0, c.controllerAs),
                            u[c.name] = l,
                            e.data("$" + c.name + "Controller", l.instance)
                        }
                        return u
                    }(w, a, b, C, g, r, k)),
                    k && (G.$$addScopeInfo(w, g, !0, !(E && (E === k || E === k.$$originalDirective))),
                    G.$$addScopeClass(w, !0),
                    g.$$isolateBindings = k.$$isolateBindings,
                    (p = ye(r, a, g, g.$$isolateBindings, k)).removeWatches && g.$on("$destroy", p.removeWatches)),
                    v) {
                        p = C[f],
                        h = v[f];
                        ...
                        if (x) {
                            ...
                            var O = h();
                            O !== h.instance && (h.instance = O,
                            w.data("$" + p.name + "Controller", O),
                            h.bindingInfo.removeWatches && h.bindingInfo.removeWatches(),
                            h.bindingInfo = ye(m, a, h.instance, D, p))
                        } else
                            h.instance = h(),
                            w.data("$" + p.name + "Controller", h.instance),
                            h.bindingInfo = ye(m, a, h.instance, D, p)
                    }
                    ...
                    o(v, function(e) {
                        ...
                        t.$doCheck()),
                        S(t.$onDestroy) && m.$on("$destroy", function() {
                            t.$onDestroy()
                        })
                    }),
                    f = 0,
                    p = u.length; f < p; f++)
                        $e(h = u[f], h.isolateScope ? g : r, w, a, h.require && re(h.directiveName, h.require, w, v), b);
                    var M = r;
                    for (k && (k.template || null === k.templateUrl) && (M = g),
                    e && e(M, i.childNodes, void 0, d),
                    f = l.length - 1; 0 <= f; f--)
                        $e(h = l[f], h.isolateScope ? g : r, w, a, h.require && re(h.directiveName, h.require, w, v), b);
                    o(v, function(e) {
                ...
                for (var h, g, m, v, b, w = -Number.MAX_VALUE, A = d.newScopeDirective, C = d.controllerDirectives, k = d.newIsolateScopeDirective, E = d.templateDirective, D = d.nonTlbTranscludeDirective, O = !1, F = !1, U = d.hasElementTranscludeDirective, V = n.$$element = Rn(t), P = r, B = !1, N = !1, R = 0, j = e.length; R < j; R++) {
                    ...
                    w > h.priority)
                        break;
                    if ((b = h.scope) && (h.templateUrl || (y(b) ? (de("new/isolated scope", k || A, h, V),
                    k = h) : de("new/isolated scope", k, h, V)),
                    A = A || h),
                    g = h.name,
                    !B && (h.replace && (h.templateUrl || h.template) || h.transclude && !h.$$tlb)) {
                        for (b = R + 1; B = e[b++]; )
                    ...
                    if (!h.templateUrl && h.controller && (C = C || oe(),
                    de("'" + g + "' controller", C[g], h, V),
                    C[g] = h),
                    b = h.transclude)
                        if (O = !0,
                        h.$$tlb || (de("transclusion", D, h, V),
                        D = h),
                        "element" === b)
                            U = !0,
                            w = h.priority,
                            m = V,
                            V = n.$$element = Rn(G.$$createComment(g, n[g])),
                            t = V[0],
                            ge(i, Kn.call(m, 0), t),
                            m[0].$$parentNode = m[0].parentNode,
                            P = te(N, m, r, w, a && a.name, {
                    ...
                    if (h.template)
                        ...
                        de("template", E, h, V),
                        E = h,
                        b = S(h.template) ? h.template(V, n) : h.template,
                        b = _e(b),
                        h.replace) {
                            if (a = h,
                            m = Sr.test(b) ? We(fe(h.templateNamespace, sr(b))) : [],
                            t = m[0],
                            1 !== m.length || 1 !== t.nodeType)
                                throw Zr("tplrt", g, "");
                            ge(i, V, t),
                            b = Z(t, [], j = {
                                $attr: {}
                    ...
                    if (h.templateUrl)
                        ...
                        E = h,
                        h.replace && (a = h),
                        p = ce(e.splice(R, e.length - R), V, n, i, O && P, u, l, {
                    ...
                    h.terminal && (p.terminal = !0,
                    w = Math.max(w, h.priority))
                }
                return p.scope = A && !0 === A.scope,
                p.transcludeOnThisElement = O,
                p.templateOnThisElement = F,
                p.transclude = P,
                d.hasElementTranscludeDirective = U,
                p
            }
            function re(e, t, n, r) {
                var i;
                if (w(t)) {
                    ...
                    var s = a[1] || a[3];
                    a = "?" === a[2];
                    if ("^^" === s ? n = n.parent() : i = (i = r && r[t]) && i.instance,
                    !i) {
                        var u = "$" + t + "Controller";
            ...
            function ae(e, n, o, a, s, u, c) {
                ...
                if (i.hasOwnProperty(n))
                    for (var d = 0, p = (s = t.get(n + "Directive")).length; d < p; d++)
                        if (n = s[d],
                        ($(a) || a > n.priority) && -1 !== n.restrict.indexOf(o)) {
                            if (u && (n = f(n, {
                                $$start: u,
                                $$end: c
                            })),
                            !n.$$bindings) {
                                ...
                                if (y(h.scope) && (!0 === h.bindToController ? (m.bindToController = r(h.scope, g, !0),
                                m.isolateScope = {}) : m.isolateScope = r(h.scope, g, !1)),
                                y(h.bindToController) && (m.bindToController = r(h.bindToController, g, !0)),
                                m.bindToController && !h.controller)
                                    throw Zr("noctrl", g);
            ...
            function ue(e, t) {
                var n = t.$attr
                  , r = e.$attr;
                o(e, function(r, i) {
                    "$" !== i.charAt(0) && (t[i] && t[i] !== r && (r = r.length ? r + ("style" === i ? ";" : " ") + t[i] : t[i]),
                    e.$set(i, r, !0, n[i]))
                }),
                o(t, function(t, i) {
            ...
            function ce(e, t, n, r, i, a, u, c) {
                var l, d, p = [], h = t[0], m = e.shift(), $ = f(m, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: m
                }), v = S(m.templateUrl) ? m.templateUrl(t, n) : m.templateUrl, b = m.templateNamespace;
                return t.empty(),
                g(v).then(function(s) {
                    var f, g;
                    if (s = _e(s),
                    m.replace) {
                        if (s = Sr.test(s) ? We(fe(b, sr(s))) : [],
                        f = s[0],
                        1 !== s.length || 1 !== f.nodeType)
                            throw Zr("tplrt", m.name, v);
                        s = {
                            $attr: {}
                        },
                        ge(r, t, f);
                    ...
                    d = W(t[0].childNodes, i); p.length; ) {
                        ...
                        if (!s.$$destroyed) {
                            if (g !== h) {
                                var C = g.className;
                                c.hasElementTranscludeDirective && m.replace || (w = he(f)),
                                ge(A, Rn(g), w),
                                H(Rn(w), C)
                            }
                            g = l.transcludeOnThisElement ? J(s, l.transclude, x) : x,
                            l(d, s, w, r, g)
                        }
                    }
                    p = null
                ...
                function(e, t, n, r, i) {
                    e = i,
                    t.$$destroyed || (p ? p.push(t, n, r, e) : (l.transcludeOnThisElement && (e = J(t, l.transclude, i)),
                    l(d, t, n, r, e)))
                }
            }
            function le(e, t) {
            ...
            function de(e, t, n, r) {
                ...
                if (t)
                    throw Zr("multidir", t.name, i(t.$$moduleName), n.name, i(n.$$moduleName), e, z(r))
            }
            function fe(t, n) {
                switch (t = Gn(t || "html")) {
                case "svg":
            ...
            function pe(e, t, r, i, o) {
                var a = function(e, t) {
                  ...
                  , u = n(r, !o, a, s);
                if (u) {
                    if ("multiple" === i && "select" === M(e))
                        throw Zr("selmulti", z(e));
                    if (m.test(i))
                        ...
                        compile: function() {
                            return {
                                pre: function(e, t, o) {
                                    ...
                                    u && (o[i] = u(e),
                                    (t[i] || (t[i] = [])).$$inter = !0,
                                    (o.$$observers && o.$$observers[i].$$scope || e).$watch(u, function(e, t) {
            ...
            function ge(t, n, r) {
                ...
                for (u && u.replaceChild(r, a),
                t = e.document.createDocumentFragment(),
                i = 0; i < s; i++)
                    t.appendChild(n[i]);
                for (Rn.hasData(a) && (Rn.data(r, Rn.data(a)),
                Rn(a).off("$destroy")),
                Rn.cleanData(t.querySelectorAll("*")),
                i = 1; i < s; i++)
                    delete n[i];
                n[0] = r,
                n.length = 1
            ...
            function ve(e, t) {
                if (k)
                    throw Zr("missingattr", e, t)
            }
            function ye(e, t, r, i, a) {
                function s(t, n, i) {
                    S(r.$onChanges) && !V(n, i) && (be || (e.$$postDigest(q),
                    be = []),
                    c || (c = {},
                    be.push(u)),
                    c[t] && (i = c[t].previousValue),
                    c[t] = new Le(i,n))
                }
                function u() {
                    r.$onChanges(c),
                ...
                return o(i, function(i, o) {
                    var u, c, f, h, g = i.attrName, m = i.optional;
                    switch (i.mode) {
                    case "@":
                        m || Hn.call(t, g) || (ve(g, a.name),
                        r[o] = t[g] = void 0),
                        m = t.$observe(g, function(e) {
                            (w(e) || D(e)) && (s(o, e, r[o]),
                            r[o] = e)
                        }),
                        t.$$observers[g].$$scope = e,
                        w(u = t[g]) ? r[o] = n(u)(e) : D(u) && (r[o] = u),
                        d[o] = new Le(Qr,r[o]),
                        l.push(m);
                        break;
                    case "=":
                        ...
                        f = c.assign || function() {
                            throw u = r[o] = c(e),
                            Zr("nonassign", t[g], g, a.name)
                        }
                        ,
                        u = r[o] = c(e),
                        (m = function(t) {
                            return h(t, r[o]) || (h(t, u) ? f(e, t = r[o]) : r[o] = t),
                            u = t
                        }
                        ).$stateful = !0,
                        m = i.collection ? e.$watchCollection(t[g], m) : e.$watch(b(t[g], m), null, c.literal),
                        l.push(m);
                        break;
                    case "<":
                        if (!Hn.call(t, g)) {
                        ...
                        break;
                    case "&":
                        if (m || Hn.call(t, g) || ve(g, a.name),
                        (c = t.hasOwnProperty(g) ? b(t[g]) : p) === p && m)
                            break;
                        r[o] = function(t) {
                            return c(e, t)
                        }
            ...
            var be, we = /^\w/, Ae = e.document.createElement("div"), xe = O, Ce = U, Se = E;
            L.prototype = {
                $normalize: He,
                $addClass: function(e) {
                ...
                $updateClass: function(e, t) {
                    ...
                    (n = Ge(t, e)) && n.length && R.removeClass(this.$$element, n)
                },
                $set: function(e, t, n, r) {
                    var i = De(this.$$element[0], e)
                      , a = Ur[e]
                      , u = e;
                    if (i ? (this.$$element.prop(e, t),
                    r = i) : a && (this[a] = t,
                    u = a),
                    this[e] = t,
                    r ? this.$attr[e] = r : (r = this.$attr[e]) || (this.$attr[e] = r = X(e, "-")),
                    "a" === (i = M(this.$$element)) && ("href" === e || "xlinkHref" === e) || "img" === i && "src" === e)
                        this[e] = t = j(t, "src" === e);
                    else if ("img" === i && "srcset" === e && v(t)) {
                        i = "",
                        a = sr(t);
                        for (var c = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = (c = /\s/.test(a) ? c : /(,)/,
                        a = a.split(c),
            ...
            return G.$$addBindingInfo = A ? function(e, t) {
                ...
                or(t) ? n = n.concat(t) : n.push(t),
                e.data("$binding", n)
            }
            : p,
            G.$$addBindingClass = A ? function(e) {
                H(e, "ng-binding")
            }
            : p,
            G.$$addScopeInfo = A ? function(e, t, n, r) {
                e.data(n ? r ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", t)
            }
            : p,
            G.$$addScopeClass = A ? function(e, t) {
        ...
        this.$get = ["$injector", "$window", function(n, i) {
            ...
            return function(r, a, s, u) {
                ...
                w(r)) {
                    ...
                    if (d = u[1],
                    f = f || u[3],
                    !(r = e.hasOwnProperty(d) ? e[d] : re(a.$scope, d, !0) || (t ? re(i, d, !0) : void 0)))
                        throw ei("ctrlreg", d);
                    te(r, d, !0)
                }
                return s ? (s = (or(r) ? r[r.length - 1] : r).prototype,
                l = Object.create(s || null),
                f && o(a, f, l, d || r.name),
                c(function() {
                    var e = n.invoke(r, l, a, d);
                    return e !== l && (y(e) || S(e)) && (l = e,
                    f && o(a, f, l, d || r.name)),
                    l
                }, {
                    instance: l,
                    identifier: f
                })) : (l = n.instantiate(r, a, d),
                f && o(a, f, l, d || r.name),
                l)
            }
        }
    ...
    function tt(e, t) {
        if (w(e)) {
            ...
            if (i)
                if ((r = n = (n = t("Content-Type")) && 0 === n.indexOf(ri)) || (r = (r = i.match(oi)) && ai[r[0]].test(i)),
                r)
                    try {
                        e = R(i)
                    } catch (t) {
    ...
    function ot() {
        ...
        this.$get = ["$browser", "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", "$sce", function(i, a, s, u, l, d, f, h) {
            function g(n) {
                ...
                function A(e) {
                    var t = c({}, e);
                    return t.data = it(e.data, e.headers, e.status, x.transformResponse),
                    200 <= (e = e.status) && 300 > e ? t : d.reject(t)
                }
                if (!y(n))
                    throw r("$http")("badreq", n);
                if (!w(h.valueOf(n.url)))
                    throw r("$http")("badreq", n.url);
                var x = c({
                    method: "get",
                ...
                x.headers = function(t) {
                    var n, r, i, a, s, u, l, d = e.headers, f = c({}, t.headers);
                ...
                x.paramSerializer = w(x.paramSerializer) ? f.get(x.paramSerializer) : x.paramSerializer,
                i.$$incOutstandingRequestCount();
                var C = []
                  , k = [];
                return n = d.resolve(x),
                o(b, function(e) {
                    (e.request || e.requestError) && C.unshift(e.request, e.requestError),
                    (e.response || e.responseError) && k.push(e.response, e.responseError)
                }),
                (n = u(n = (n = u(n, C)).then(function(n) {
                    ...
                    function(n, r) {
                        ...
                        var p, b, A = d.defer(), x = A.promise, C = n.headers, k = "jsonp" === Gn(n.method), E = n.url;
                        return k ? E = h.getTrustedResourceUrl(E) : w(E) || (E = h.valueOf(E)),
                        _ = E,
                        D = n.paramSerializer(n.params),
                        0 < D.length && (_ += (-1 === _.indexOf("?") ? "?" : "&") + D),
                        E = _,
                        k && (E = function(e, t) {
                            var n = e.split("?");
                            if (2 < n.length)
                            ...
                            return o(n = H(n[1]), function(n, r) {
                                if ("JSON_CALLBACK" === n)
                                    throw ui("badjsonp", e);
                                if (r === t)
                                    throw ui("badjsonp", t, e)
                            }),
                            e += (-1 === e.indexOf("?") ? "?" : "&") + t + "=JSON_CALLBACK"
                        }(E, n.jsonpCallbackParam)),
                        g.pendingRequests.push(n),
                        x.then(f, f),
                        !n.cache && !e.cache || !1 === n.cache || "GET" !== n.method && "JSONP" !== n.method || (p = y(n.cache) ? n.cache : y(e.cache) ? e.cache : m),
                        p && (v(b = p.get(E)) ? b && S(b.then) ? b.then(c, c) : or(b) ? u(b[1], b[0], se(b[2]), b[3], b[4]) : u(b, 200, {}, "OK", "complete") : p.put(E, x)),
                        $(b) && ((b = Zt(n.url) ? s()[n.xsrfCookieName || e.xsrfCookieName] : void 0) && (C[n.xsrfHeaderName || e.xsrfHeaderName] = b),
                        a(n.method, E, r, function(e, n, r, i, o) {
                            function a() {
                                u(n, e, r, i, o)
                            }
                            p && (200 <= e && 300 > e ? p.put(E, [e, n, nt(r), i, o]) : p.remove(E)),
                            t ? l.$applyAsync(a) : (a(),
                            l.$$phase || l.$apply())
                        }, C, n.timeout, n.withCredentials, n.responseType, i(n.eventHandlers), i(n.uploadEventHandlers))),
                        x;
                        var _, D
                    }(n, i).then(A, A)
                }), k)).finally(function() {
                ...
                return function(a, s, u, c, l, d, f, p, h, g) {
                    ...
                    "jsonp" === Gn(a))
                        ...
                        A.onload = function() {
                            ...
                            0 === n && (n = t ? 200 : "file" === Jt(s).protocol ? 404 : 0),
                            y(c, n, t, A.getAllResponseHeaders(), e, "complete")
                        }
                        ,
                        A.onerror = function() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(n, r, i) {
            ...
            function u(o, u, f, p) {
                function h(e) {
                    try {
                        var t = e;
                        return e = f ? i.getTrusted(f, t) : i.valueOf(t),
                        p && !v(e) ? e : ae(e)
                    } catch (e) {
                        r(ci.interr(o, e))
                    }
                ...
                if (f && 1 < C.length && ci.throwNoconcat(o),
                !u || A.length) {
                    var k = function(e) {
    ...
    function ct() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function(e, t, n, r, i) {
            ...
            return o.cancel = function(e) {
                return !!(e && e.$$intervalId in a) && (a[e.$$intervalId].promise.$$state.pur = !0,
    ...
    function dt(e, t) {
        ...
        t.$$host = n.hostname,
        t.$$port = d(n.port) || fi[n.protocol] || null
    }
    function ft(e, t, n) {
        if (hi.test(e))
            throw pi("badpath", e);
        (r = "/" !== e.charAt(0)) && (e = "/" + e),
        e = Jt(e);
        for (var r, i = (r = (r && "/" === e.pathname.charAt(0) ? e.pathname.substring(1) : e.pathname).split("/")).length; i--; )
            r[i] = decodeURIComponent(r[i]),
            n && (r[i] = r[i].replace(/\//g, "%2F"));
        n = r.join("/"),
        t.$$path = n,
        t.$$search = H(e.search),
    ...
    function $t(e, t, n) {
        ...
        this.$$parseLinkUrl = function(r, i) {
            ...
            !0) : (v(o = ht(e, r)) ? (a = o,
            a = n && v(o = ht(n, o)) ? t + (ht("/", o) || o) : e + a) : v(o = ht(t, r)) ? a = t + o : t === r + "/" && (a = t),
            a && this.$$parse(a),
            !!a);
            var o, a
        }
    ...
    function vt(e, t, n) {
        ...
        this.$$parse = function(r) {
            var i;
            $(o = ht(e, r) || ht(t, r)) || "#" !== o.charAt(0) ? this.$$html5 ? i = o : (i = "",
            $(o) && (e = r,
            this.replace())) : $(i = ht(n, o)) && (i = o),
            ft(i, this, !1),
            r = this.$$path;
            var o, a = /^\/[A-Z]:(\/.*)/;
            pt(i, o = e) && (i = i.replace(o, "")),
        ...
        this.$$compose = function() {
            ...
            this.$$url = lt(this.$$path) + (t ? "?" + t : "") + r,
            this.$$absUrl = e + (this.$$url ? n + this.$$url : ""),
            this.$$urlUpdatedByLocation = !0
        }
        ,
        this.$$parseLinkUrl = function(t, n) {
            return gt(e) === gt(t) && (this.$$parse(t),
            !0)
        }
    }
    function yt(e, t, n) {
        ...
        this.$$parseLinkUrl = function(r, i) {
            return i && "#" === i[0] ? (this.hash(i.slice(1)),
            !0) : (e === gt(r) ? o = r : (a = ht(t, r)) ? o = e + n + a : t === r + "/" && (o = t),
            o && this.$$parse(o),
            !!o);
            var o, a
        }
    ...
    function At() {
        ...
        this.html5Mode = function(e) {
            return D(e) ? (t.enabled = e,
            this) : y(e) ? (D(e.enabled) && (t.enabled = e.enabled),
            D(e.requireBase) && (t.requireBase = e.requireBase),
            (D(e.rewriteLinks) || w(e.rewriteLinks)) && (t.rewriteLinks = e.rewriteLinks),
            this) : t
        }
        ,
    ...
    function Et(e, t, n) {
        ...
        case wi.MemberExpression:
            Et(e.object, t, a),
            e.computed && Et(e.property, t, a),
            e.constant = e.object.constant && (!e.computed || e.property.constant),
            e.toWatch = e.constant ? [] : [e];
            break;
        case wi.CallExpression:
            r = n = !!e.filter && !t(e.callee.name).$stateful,
            i = [],
    ...
    function Ut(e, t, n) {
        this.ast = new wi(e,n),
        this.astCompiler = n.csp ? new Ft(t) : new Mt(t)
    }
    function Vt(e) {
    ...
    function Pt() {
        ...
        this.$get = ["$filter", function(i) {
            function a(e, t) {
                ...
                case "string":
                    return o = e = e.trim(),
                    (r = n[o]) || ((r = new Ut(r = new bi(h),i,h).parse(e)).constant ? r.$$watchDelegate = d : r.oneTime ? r.$$watchDelegate = r.literal ? l : c : r.inputs && (r.$$watchDelegate = u),
                    n[o] = r),
                    f(r, t);
                case "function":
                    return f(e, t);
            ...
            function s(e, t, n) {
                return null == e || null == t ? e === t : !("object" == typeof e && (e = Vt(e),
                "object" == typeof e && !n)) && (e === t || e != e && t != t)
            }
            function u(e, t, n, r, i) {
                ...
                if (1 === (u = r.inputs).length) {
                    ...
                    return e.$watch(function(e) {
                        var t = u(e);
                        return s(t, a, u.isPure) || (o = r(e, void 0, void 0, [t]),
                        a = t && Vt(t)),
                        o
                    }, t, n, i)
                }
                for (var c = [], l = [], d = 0, f = u.length; d < f; d++)
                    c[d] = s,
                    l[d] = null;
                return e.$watch(function(e) {
                    for (var t = !1, n = 0, i = u.length; n < i; n++) {
                        var a = u[n](e);
                        (t || (t = !s(a, c[n], u[n].isPure))) && (l[n] = a,
                        c[n] = a && Vt(a))
                    }
            ...
            function f(e, t) {
                ...
                ;
                r = !e.inputs;
                return n && n !== u ? (i.$$watchDelegate = n,
                i.inputs = e.inputs) : t.$stateful || (i.$$watchDelegate = u,
    ...
    function Bt(e, t, n) {
        ...
        function u(r) {
            !n || r.pending || 2 !== r.status || r.pur || (0 === w && 0 === A.length && e(s),
            A.push(r)),
        ...
        function l(e, t) {
            e.$$state.status || (t === e ? f(e, b("qcycle", t)) : function e(t, n) {
                ...
                try {
                    (y(n) || S(n)) && (o = n.then),
                    S(o) ? (t.$$state.status = -1,
                    o.call(n, function r(e) {
                        a || (a = !0,
                        function e(t, n) {
                            function r(n) {
                                a || (a = !0,
        ...
        var x = m;
        return v.prototype = a.prototype,
        v.defer = i,
        v.reject = h,
        v.when = m,
        v.resolve = x,
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(r, s, u) {
            ...
            l.prototype = {
                ...
                $watch: function(e, t, r, i) {
                    ...
                    if (t = S(t) ? t : p,
                    o.$$watchDelegate)
                        return o.$$watchDelegate(this, t, r, o, e);
                    var a = this
                      , u = a.$$watchers
                      , c = {
                        fn: t,
                ...
                $watchCollection: function(e, t) {
                    ...
                    n.$stateful = !0;
                    var r, o, a, u = this, c = 1 < t.length, l = 0, d = s(e, n), f = [], p = {}, h = !0, g = 0;
                ...
                $digest: function() {
                    var i, o, s, c, l, f, p, h, $ = e, y = [];
                    d("$digest"),
                    u.$$checkUrlChange(),
                    this === v && null !== a && (u.defer.cancel(a),
                    m()),
                    n = null;
                    do {
                        for (l = !1,
                                ...
                                for (c.$$digestWatchIndex = c.length; c.$$digestWatchIndex--; )
                                    try {
                                        if (i = c[c.$$digestWatchIndex])
                                            if ((o = (0,
                                            i.get)(f)) === (s = i.last) || (i.eq ? P(o, s) : nr(o) && nr(s))) {
                                                if (i === n) {
                                                    l = !1;
                                                    break e
                                                }
                ...
                $destroy: function() {
                    if (!this.$$destroyed) {
                        ...
                        this.$$destroyed = !0,
                        this === v && u.$$applicationDestroyed(),
                        f(this, -this.$$watchersCount),
                        this.$$listenerCount)
                            h(this, this.$$listenerCount[t], t);
                        ...
                        function e(t) {
                            9 === Nn && (t.$$childHead && e(t.$$childHead),
                ...
                $broadcast: function(e, t) {
                    ...
                    for (var a, s, u = T([o], arguments, 1); n = i; ) {
                        for (o.currentScope = n,
                        a = 0,
                        s = (i = n.$$listeners[e] || []).length; a < s; a++)
                            if (i[a])
                                try {
                                    i[a].apply(null, u)
                                } catch (e) {
        ...
        return v(e) && o(e, function(e) {
            t.push(function(e) {
                ...
                if (w(e)) {
                    if (-1 < e.indexOf("***"))
                        throw xi("iwcard", e);
                    return e = ur(e).replace(/\\\*\\\*/g, ".*").replace(/\\\*/g, "[^:/.?&;]*"),
                    new RegExp("^" + e + "$")
                }
                if (k(e))
    ...
    function zt() {
        ...
        this.resourceUrlWhitelist = function(t) {
            return arguments.length && (e = qt(t)),
            e
        }
        ,
        this.resourceUrlBlacklist = function(e) {
            return arguments.length && (t = qt(e)),
            t
        }
        ,
        this.$get = ["$injector", function(n) {
            ...
            s[Ci.RESOURCE_URL] = i(s[Ci.URL]),
            {
                ...
                getTrusted: function(n, i) {
                    if (null === i || $(i) || "" === i)
                        return i;
                    if ((c = s.hasOwnProperty(n) ? s[n] : null) && i instanceof c)
                        return i.$$unwrapTrustedValue();
                    if (n === Ci.RESOURCE_URL) {
                        var a, u, c = Jt(i.toString()), l = !1;
                        for (a = 0,
                        u = e.length; a < u; a++)
                            if (r(e[a], c)) {
                                l = !0;
    ...
    function Gt() {
        ...
        this.$get = ["$exceptionHandler", "$templateCache", "$http", "$q", "$sce", function(t, n, r, i, o) {
            function a(s, u) {
                ...
                w(s) && !$(n.get(s)) || (s = o.getTrustedResourceUrl(s));
                ...
                r.get(s, c({
                    ...
                    return u || (e = ki("tpload", s, e.status, e.statusText),
                    t(e)),
                    i.reject(e)
                })
            }
    ...
    function Kt() {
        this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(e, t, n, r, i) {
            function o(o, s, u) {
                ...
                s = o,
                o = p);
                var c, l = Kn.call(arguments, 3), d = v(u) && !u, f = (d ? r : n).defer(), h = f.promise;
            ...
            var a = {};
            return o.cancel = function(e) {
                return !!(e && e.$$timeoutId in a) && (a[e.$$timeoutId].promise.$$state.pur = !0,
    ...
    function Jt(e) {
        return Nn && (Ei.setAttribute("href", e),
        e = Ei.href),
        Ei.setAttribute("href", e),
        {
            href: Ei.href,
    ...
    function Yt(e) {
        ...
        return function() {
            ...
            if (e !== i)
                ...
                r = {},
                a = 0; a < e.length; a++)
                    0 < (s = (o = e[a]).indexOf("=")) && (u = t(o.substring(0, s)),
                    $(r[u]) && (r[u] = t(o.substring(s + 1))));
            return r
        }
    }
    function Xt() {
    ...
    function tn() {
        return function(e, t, n, o) {
            ...
            case "object":
                ...
                l = a,
                d = y(s = t) && c in s,
                !0 === u ? u = P : S(u) || (u = function(e, t) {
                    return !($(e) || (null === e || null === t ? e !== t : y(t) || y(e) && !m(e) || (e = Gn("" + e),
                    t = Gn("" + t),
                    -1 === e.indexOf(t))))
                }
                ),
    ...
    function nn(e, t, n, r, i, o) {
        ...
        if ("string" === s && "!" === t.charAt(0))
            return !nn(e, t.substring(1), n, r, i);
        if (or(e))
        ...
        case "object":
            ...
            if (i) {
                for (u in e)
                    if (u.charAt && "$" !== u.charAt(0) && nn(e[u], t, n, r, !0))
                        return !0;
                return !o && nn(e, t, n, r, !1)
            }
            if ("object" === s) {
                for (u in t)
                    if (!S(o = t[u]) && !$(o) && !nn((a = u === r) ? e : e[u], o, n, r, a, a))
                        return !1;
                return !0
            }
            return n(e, t);
    ...
    function on(e) {
        ...
        return function(e, n, r) {
            ...
            null == e ? e : sn(e, t.PATTERNS[1], t.GROUP_SEP, t.DECIMAL_SEP, r).replace(/\u00A4/g, n)
        }
    }
    function an(e) {
        var t = e.NUMBER_FORMATS;
    ...
    function sn(e, t, n, r, i) {
        ...
        if (o)
            ...
            for (function(e, t, n, r) {
                var i = e.d
                  , o = i.length - e.i;
                if (r = i[n = (t = $(t) ? Math.min(Math.max(n, o), r) : +t) + e.i],
                0 < n) {
                ...
                var t, n, r, i, o, a = 0;
                for (-1 < (n = e.indexOf(Oi)) && (e = e.replace(Oi, "")),
                0 < (r = e.search(/e/i)) ? (0 > n && (n = r),
                n += +e.slice(r + 1),
                e = e.substring(0, r)) : 0 > n && (n = e.length),
                r = 0; e.charAt(r) === Mi; r++)
                    ;
                if (r === (o = e.length))
                    t = [0],
            ...
            a = u.reduce(function(e, t) {
                ...
                u.unshift(0),
                s++;
            for (0 < s ? o = u.splice(s, u.length) : (o = u,
            u = [0]),
            s = [],
            u.length >= t.lgSize && s.unshift(u.splice(-t.lgSize, u.length).join("")); u.length > t.gSize; )
                s.unshift(u.splice(-t.gSize, u.length).join(""));
    ...
    function hn(e) {
        ...
        return function(n, r, i) {
            ...
            w(n) && (n = Vi.test(n) ? d(n) : function(e) {
                var n;
                if (n = e.match(t)) {
                    e = new Date(0);
                    var r = 0
            ...
            !x(n) || !isFinite(n.getTime()))
                return n;
            for (; r; )
                (s = Ui.exec(r)) ? r = (c = T(c, s, 1)).pop() : (c.push(r),
                r = null);
    ...
    function mn() {
        return function(e, t, n) {
            return t = 1 / 0 === Math.abs(Number(t)) ? Number(t) : d(t),
            nr(t) ? e : (A(e) && (e = e.toString()),
            i(e) ? (n = 0 > (n = !n || isNaN(n) ? 0 : d(n)) ? Math.max(0, e.length + n) : n,
            0 <= t ? $n(e, n, n + t) : 0 === n ? $n(e, t, e.length) : $n(e, Math.max(0, n + t), n)) : e)
        }
    }
    function $n(e, t, n) {
    ...
    function vn(e) {
        ...
        function n(e, t) {
            ...
            if (r === (i = t.type)) {
                var i = e.value
                  , o = t.value;
                "string" === r ? (i = i.toLowerCase(),
                o = o.toLowerCase()) : "object" === r && (y(i) && (i = e.index),
                y(o) && (o = t.index)),
                i !== o && (n = i < o ? -1 : 1)
            } else
                n = r < i ? -1 : 1;
        ...
        return function(o, a, s, u) {
            ...
            var c = a.map(function(t) {
                ...
                if (S(t))
                    r = t;
                else if (w(t) && ("+" !== t.charAt(0) && "-" !== t.charAt(0) || (n = "-" === t.charAt(0) ? -1 : 1,
                t = t.substring(1)),
                "" !== t && (r = e(t)).constant)) {
                    var i = r();
                    r = function(e) {
            ...
            return (o = Array.prototype.map.call(o, function(e, n) {
                return {
                    ...
                    predicateValues: c.map(function(r) {
                        ...
                        return r = typeof i,
                        null === i ? (r = "string",
                        i = "null") : "object" === r && (S(i.valueOf) && t(i = i.valueOf()) || m(i) && t(i = i.toString())),
                        {
                            value: i,
                            type: r,
                            index: n
    ...
    function wn(e) {
        e.$$classCache = {},
        e.$$classCache[wo] = !(e.$$classCache[bo] = e.$$element.hasClass(bo))
    }
    function An(e) {
        function t(e, t, n) {
        ...
        e.clazz.prototype.$setValidity = function(e, o, a) {
            $(o) ? (this.$pending || (this.$pending = {}),
            r(this.$pending, e, a)) : (this.$pending && i(this.$pending, e, a),
            xn(this.$pending) && (this.$pending = void 0)),
            D(o) ? o ? (i(this.$error, e, a),
            r(this.$$success, e, a)) : (r(this.$error, e, a),
            i(this.$$success, e, a)) : (i(this.$error, e, a),
            i(this.$$success, e, a)),
            this.$pending ? (t(this, "ng-pending", !0),
            this.$valid = this.$invalid = void 0,
            n(this, "", null)) : (t(this, "ng-pending", !1),
            this.$valid = xn(this.$error),
            this.$invalid = !this.$valid,
            n(this, "", this.$valid)),
            n(this, e, o = this.$pending && this.$pending[e] ? void 0 : !this.$error[e] && (!!this.$$success[e] || null)),
            this.$$parentForm.$setValidity(e, o, this)
        }
    }
    function xn(e) {
        if (e)
    ...
    function Sn(e, t, n, r, i, o) {
        ...
        var u, c = function(e) {
            ...
            !s) {
                var i = t.val();
                e = e && e.type,
                "password" === a || n.ngTrim && "false" === n.ngTrim || (i = sr(i)),
        ...
        t.on("change", c),
        Yi[a] && r.$$hasNativeValidators && a === n.type && t.on("keydown wheel mousedown", function(e) {
            if (!u) {
                var t = this.validity
                  , n = t.badInput
                  , r = t.typeMismatch;
    ...
    function En(e, t, n, r) {
        return function(i, o, a, s, u, c, l) {
            ...
            s.$parsers.push(function(e) {
                return s.$isEmpty(e) ? null : t.test(e) ? (e = n(e, p),
                m && (e = q(e, m)),
                e) : void 0
            }),
        ...
        ["$parse", function(s) {
            return {
                ...
                link: function(u, c, l) {
                    ...
                    var p, h = ":" === (g = l[e].trim()).charAt(0) && ":" === g.charAt(1), g = s(g, h ? i : r), m = h ? function(e) {
                        (e = r(e)) !== p && f(e)
                    }
                    : f, $ = c.data("$classCounts"), v = !0;
                    $ || ($ = oe(),
                    c.data("$classCounts", $)),
                    "ngClass" !== e && (a || (a = s("$index", function(e) {
                        return 1 & e
                    })),
    ...
    function Pn(e, t, n, r, i, o, a, s, u) {
        ...
        (c = this).$$scope.$watch(function(e) {
            return (e = c.$$ngModelGet(e)) === c.$modelValue || c.$modelValue != c.$modelValue && e != e || c.$$setModelValue(e),
            e
        })
    }
    function Tn(e) {
    ...
    var Nn, Rn, jn, qn, zn = {
        objectMaxDepth: 5
    }, Ln = /^\/(.+)\/([a-z]*)$/, Hn = Object.prototype.hasOwnProperty, Gn = function(e) {
        return w(e) ? e.toLowerCase() : e
    }, Wn = function(e) {
        return w(e) ? e.toUpperCase() : e
    }, Kn = [].slice, Jn = [].splice, Zn = [].push, Qn = Object.prototype.toString, Yn = Object.getPrototypeOf, Xn = r("ng"), er = e.angular || (e.angular = {}), tr = 0;
    ...
    p.$inject = [],
    h.$inject = [];
    var rr, ir, or = Array.isArray, ar = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/, sr = function(e) {
        return w(e) ? e.trim() : e
    }, ur = function(e) {
        ...
        return lr.name_ = i
    }, dr = /:/g, fr = ["ng-", "data-ng-", "ng:", "x-ng-"], pr = (rr = e.document,
    !(ir = rr.currentScript) || (ir instanceof e.HTMLScriptElement || ir instanceof e.SVGScriptElement) && [(ir = ir.attributes).getNamedItem("src"), ir.getNamedItem("href"), ir.getNamedItem("xlink:href")].every(function(e) {
        if (!e)
            return !0;
        if (!e.value)
            return !1;
    ...
    o({
            ...
            if (de(e)) {
                ...
                (l = function(e, t) {
                    ...
                    if (r) {
                        ...
                        1 < r && (n = se(n));
                        for (var a = 0; a < r; a++)
                            e.isImmediatePropagationStopped() || o(u, e, n[a])
                    }
                }
                ).elem = u = e,
                l));
                for (var a = (r = 0 <= t.indexOf(" ") ? t.split(" ") : [t]).length, s = function(t, r, a) {
                    var s = i[t];
                    s || ((s = i[t] = []).specialHandlerWrapper = r,
                    "$destroy" === t || a || e.addEventListener(t, o)),
                    s.push(n)
                }; a--; )
                    t = r[a],
                    Ar[t] ? (s(Ar[t], Me),
        ...
        append: function(e, t) {
            if (1 === (n = e.nodeType) || 11 === n)
                for (var n = 0, r = (t = new pe(t)).length; n < r; n++)
                    e.appendChild(t[n])
        },
        ...
        pe.prototype[t] = function(t, n, r) {
            for (var i, o = 0, a = this.length; o < a; o++)
                $(i) ? v(i = e(this[o], t, n, r)) && (i = Rn(i)) : xe(i, e(this[o], t, n, r));
            return v(i) ? i : this
        }
    }),
    ...
    Ve.prototype = {
        ...
        delete: function(e) {
            return e = this._transformKey(e),
            -1 !== (e = this._idx(e)) && (this._keys.splice(e, 1),
    ...
    Te.$$annotate = function(e, t, n) {
        ...
        if ("function" == typeof e) {
            if (!(r = e.$inject)) {
                ...
                e.length) {
                    if (t)
                        throw w(n) && n || (n = e.name || ((i = Pe(i = e)) ? "function(" + (i[1] || "").replace(/[\s\r\n]+/, " ") + ")" : "fn")),
                        qr("strictdi", n);
            ...
            or(e) ? (te(e[t = e.length - 1], "fn"),
            r = e.slice(0, t)) : te(e, "fn", !0);
        return r
    }
    ;
    var zr = r("$animate")
        ...
        this.$get = ["$$AnimateRunner", "$rootScope", function(n, r) {
            ...
            return {
                ...
                push: function(o, s, u, c) {
                    ...
                    u.to && o.css(u.to),
                    (u.addClass || u.removeClass) && (s = u.addClass,
                    c = u.removeClass,
                    s = i(u = e.get(o) || {}, s, !0),
                    c = i(u, c, !1),
                    (s || c) && (e.set(o, u),
      ...
      , Gr = ["$provide", function(e) {
        ...
        this.customFilter = function(e) {
            return 1 === arguments.length && (r = S(e) ? e : null),
            r
        }
        ,
        this.classNameFilter = function(e) {
            if (1 === arguments.length && (n = e instanceof RegExp ? e : null) && /[(\s|\/)]ng-animate[(\s|\/)]/.test(n.toString()))
                throw n = null,
                zr("nongcls", "ng-animate");
            return n
        }
        ,
        this.$get = ["$$animateQueue", function(e) {
            ...
            return {
                ...
                addClass: function(t, n, r) {
                    return (r = Ne(r)).addClass = Be(r.addclass, n),
                    e.push(t, "addClass", r)
                },
                removeClass: function(t, n, r) {
                    return (r = Ne(r)).removeClass = Be(r.removeClass, n),
                    e.push(t, "removeClass", r)
                },
                setClass: function(t, n, r, i) {
                    return (i = Ne(i)).addClass = Be(i.addClass, n),
                    i.removeClass = Be(i.removeClass, r),
                    e.push(t, "setClass", i)
                },
                animate: function(t, n, r, i, o) {
                    return (o = Ne(o)).from = o.from ? c(o.from, n) : n,
                    o.to = o.to ? c(o.to, r) : r,
                    o.tempClasses = Be(o.tempClasses, i || "ng-inline-animate"),
                    e.push(t, "animate", o)
                }
            }
        }
    ...
    Le.prototype.isFirstChange = function() {
    ...
    var Yr = /^((?:x|data)[:\-_])/i
      ...
      , ni = function() {
        this.$get = ["$document", function(e) {
            return function(t) {
                return t ? !t.nodeType && t instanceof Rn && (t = t[0]) : t = e[0].body,
                t.offsetWidth + 1
            }
        }
        ]
        ...
        this.$get = function() {
            ...
            return {
                createCallback: function(n) {
                    var r, i = "angular.callbacks." + (n = "_" + (e.$$counter++).toString(36)), o = ((r = function(e) {
                        r.data = e,
                        r.called = !0
                    }
                    ).id = n,
    ...
    bi.prototype = {
        ...
        throwError: function(e, t, n) {
            ...
            t = v(t) ? "s " + t + "-" + this.index + " [" + this.text.substring(t, n) + "]" : " " + n,
            mi("lexerr", e, t, this.text)
        },
        readNumber: function() {
        ...
        readString: function(e) {
            ...
            for (var n = "", r = e, i = !1; this.index < this.text.length; ) {
                ...
                r = r + o;
                if (i)
                    "u" === o ? ((i = this.text.substring(this.index + 1, this.index + 5)).match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + i + "]"),
                    this.index += 4,
                    n += String.fromCharCode(parseInt(i, 16))) : n += yi[o] || o,
                    i = !1;
                else if ("\\" === o)
                    i = !0;
                else {
    ...
    wi.Program = "Program",
    wi.ExpressionStatement = "ExpressionStatement",
    wi.AssignmentExpression = "AssignmentExpression",
    wi.ConditionalExpression = "ConditionalExpression",
    wi.LogicalExpression = "LogicalExpression",
    wi.BinaryExpression = "BinaryExpression",
    wi.UnaryExpression = "UnaryExpression",
    wi.CallExpression = "CallExpression",
    wi.MemberExpression = "MemberExpression",
    wi.Identifier = "Identifier",
    wi.Literal = "Literal",
    wi.ArrayExpression = "ArrayExpression",
    wi.Property = "Property",
    wi.ObjectExpression = "ObjectExpression",
    wi.ThisExpression = "ThisExpression",
    wi.LocalsExpression = "LocalsExpression",
    wi.NGValueParameter = "NGValueParameter",
    wi.prototype = {
        ast: function(e) {
            return this.text = e,
        ...
        primary: function() {
            ...
            this.consume(")")) : this.expect("[") ? e = this.arrayDeclaration() : this.expect("{") ? e = this.object() : this.selfReferential.hasOwnProperty(this.peek().text) ? e = U(this.selfReferential[this.consume().text]) : this.options.literals.hasOwnProperty(this.peek().text) ? e = {
                type: wi.Literal,
    ...
    Mt.prototype = {
        compile: function(e) {
            ...
            (n = Ot(e)) && (this.state.computing = "assign",
            r = this.nextId(),
            this.recurse(n, r),
            this.return_(r),
            ...
            e = new Function("$filter","getStringValue","ifDefined","plus",e)(this.$filter, Ct, St, kt),
        ...
        recurse: function(e, t, n, r, i, a) {
            ...
            !a && v(e.watchId))
                t = t || this.nextId(),
                this.if_("i", this.lazyAssign(t, this.computedMember("i", e.watchId)), this.lazyRecurse(e, t, n, r, i, !0));
            else
                switch (e.type) {
                case wi.Program:
                ...
                case wi.Identifier:
                    ...
                    f.if_("inputs" === f.stage || f.not(f.getHasOwnProperty("l", e.name)), function() {
                        f.if_("inputs" === f.stage || "s", function() {
                            i && 1 !== i && f.if_(f.isNull(f.nonComputedMember("s", e.name)), f.lazyAssign(f.nonComputedMember("s", e.name), "{}")),
                ...
                case wi.MemberExpression:
                    ...
                    t = t || this.nextId(),
                    f.recurse(e.object, s, void 0, function() {
                        f.if_(f.notNull(s), function() {
                            e.computed ? (u = f.nextId(),
                            f.recurse(e.property, u),
                            f.getStringValue(u),
                            i && 1 !== i && f.if_(f.not(f.computedMember(s, u)), f.lazyAssign(f.computedMember(s, u), "{}")),
                            l = f.computedMember(s, u),
                            f.assign(t, l),
                            n && (n.computed = !0,
                            n.name = u)) : (i && 1 !== i && f.if_(f.isNull(f.nonComputedMember(s, e.property.name)), f.lazyAssign(f.nonComputedMember(s, e.property.name), "{}")),
                            l = f.nonComputedMember(s, e.property.name),
                            f.assign(t, l),
                            n && (n.computed = !1,
                ...
                case wi.CallExpression:
                    t = t || this.nextId(),
                    e.filter ? (u = f.filter(e.callee.name),
                    c = [],
                    o(e.arguments, function(e) {
                        var t = f.nextId();
                        f.recurse(e, t),
                    ...
                    s = {},
                    c = [],
                    f.recurse(e.callee, u, s, function() {
                        f.if_(f.notNull(u), function() {
                            ...
                            l = s.name ? f.member(s.context, s.name, s.computed) + "(" + c.join(",") + ")" : u + "(" + c.join(",") + ")",
                            f.assign(t, l)
                        }, function() {
                            f.assign(t, "undefined")
                        }),
                ...
                case wi.AssignmentExpression:
                    ...
                    this.recurse(e.left, void 0, s, function() {
                        f.if_(f.notNull(s.context), function() {
                            f.recurse(e.right, u),
                            l = f.member(s.context, s.name, s.computed) + e.operator + u,
                            f.assign(t, l),
                            r(t || l)
                        })
                    }, 1);
                ...
                case wi.ObjectExpression:
                    ...
                    o(e.properties, function(e) {
                        ...
                        f.recurse(e.key, s)) : s = e.key.type === wi.Identifier ? e.key.name : "" + e.key.value,
                        u = f.nextId(),
                        f.recurse(e.value, u),
                        f.assign(f.member(t, s, e.computed), u)
    ...
    Ft.prototype = {
        ...
        recurse: function(e, t, n) {
            ...
            case wi.MemberExpression:
                ...
                e.computed ? this.computedMember(r, i, t, n) : this.nonComputedMember(r, i, t, n);
            case wi.CallExpression:
                return a = [],
                o(e.arguments, function(e) {
                    a.push(s.recurse(e))
        ...
        "ternary?:": function(e, t, n, r) {
            return function(i, o, a, s) {
                return i = e(i, o, a, s) ? t(i, o, a, s) : n(i, o, a, s),
                r ? {
                    value: i
                } : i
            }
        ...
        identifier: function(e, t, n) {
            return function(r, i, o, a) {
                return r = i && e in i ? i : r,
                n && 1 !== n && r && null == r[e] && (r[e] = {}),
                i = r ? r[e] : void 0,
                t ? {
                    context: r,
                    name: e,
    ...
    Ut.prototype = {
        ...
        parse: function(e) {
            ...
            var t = this.astCompiler.compile(e.ast)
              , n = e.ast;
            return t.literal = 0 === n.body.length || 1 === n.body.length && (n.body[0].expression.type === wi.Literal || n.body[0].expression.type === wi.ArrayExpression || n.body[0].expression.type === wi.ObjectExpression),
            t.constant = e.ast.constant,
            t.oneTime = e.oneTime,
            t
        },
        getAst: function(e) {
            var t = !1;
            return ":" === (e = e.trim()).charAt(0) && ":" === e.charAt(1) && (t = !0,
            e = e.substring(2)),
            {
                ast: this.ast.ast(e),
                oneTime: t
            ...
            return {
                ...
                link: function(n, r, i) {
                    ...
                    i.$observe(t, function(t) {
                        t ? (i.$set(a, t),
                        Nn && o && r.prop(o, i[a])) : "href" === e && i.$set(a, null)
                    })
                }
            }
        }
    ...
    bn.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"],
    bn.prototype = {
        ...
        $removeControl: function(e) {
            ...
            o(this.$pending, function(t, n) {
                this.$setValidity(n, null, e)
            }, this),
            o(this.$error, function(t, n) {
                this.$setValidity(n, null, e)
            }, this),
            o(this.$$success, function(t, n) {
                this.$setValidity(n, null, e)
            }, this),
            F(this.$$controls, e),
            e.$$parentForm = Ni
        ...
        $setDirty: function() {
            this.$$animate.removeClass(this.$$element, Ao),
        ...
        $setPristine: function() {
            this.$$animate.setClass(this.$$element, Ao, xo + " ng-submitted"),
            this.$dirty = !1,
            this.$pristine = !0,
            this.$submitted = !1,
            o(this.$$controls, function(e) {
    ...
    var Xi = {
        ...
        number: function(e, t, n, r, i, o) {
            ...
            Dn(r),
            Sn(0, t, n, r, i, o),
            (v(n.min) || n.ngMin) && (r.$validators.min = function(e) {
        ...
        range: function(e, t, n, r, i, o) {
            ...
            a("min", function(e) {
                u = On(e),
                nr(r.$modelValue) || (s ? (e = t.val(),
                u > e && (e = u,
                t.val(e)),
                r.$setViewValue(e)) : r.$validate())
            })),
            ...
            a("step", function(e) {
                l = On(e),
                nr(r.$modelValue) || (s && r.$viewValue !== t.val() ? r.$setViewValue(t.val()) : r.$validate())
            }))
        },
    ...
    var go = ["$animate", "$compile", function(e, t) {
        ...
        return {
            ...
            compile: function(r, i) {
                ...
                return function(r, i, u, c, l) {
                    var d, f, p, h = 0, g = function() {
                        f && (f.remove(),
                        f = null),
                        d && (d.$destroy(),
                        d = null),
                        p && (n.leave(p).done(function(e) {
                            !1 !== e && (f = null)
                        }),
                        f = p,
                        p = null)
      ...
      , $o = ["$compile", function(t) {
        return {
            ...
            link: function(n, r, i, o) {
                Qn.call(r[0]).match(/SVG/) ? (r.empty(),
                t(fe(o.template, e.document).childNodes)(n, function(e) {
                    r.append(e)
                }, {
      ...
      , xo = "ng-dirty"
      , Co = r("ngModel");
    Pn.$inject = "$scope $exceptionHandler $attrs $element $parse $animate $timeout $q $interpolate".split(" "),
    Pn.prototype = {
        $$initGetterSetters: function() {
            if (this.$options.getOption("getterSetter")) {
                ...
                throw Co("nonassign", this.$$attr.ngModel, z(this.$$element))
        },
        $render: p,
        $isEmpty: function(e) {
        ...
        $setPristine: function() {
            ...
            this.$$animate.addClass(this.$$element, Ao)
        },
        $setDirty: function() {
            this.$dirty = !0,
            this.$pristine = !1,
        ...
        $$runValidators: function(e, t, n) {
            ...
            var a, s, u, c, l = this.$$currentValidationRunId, d = this;
            c = d.$$parserName || "parse",
            ($(d.$$parserValid) ? (r(c, null),
            1) : (d.$$parserValid || (o(d.$validators, function(e, t) {
                r(t, null)
            }),
            ...
            0) ? (a = [],
            s = !0,
            o(d.$asyncValidators, function(n, i) {
                var o = n(e, t);
                if (!o || !S(o.then))
                    throw Co("nopromise", o);
                r(i, void 0),
                a.push(o.then(function() {
                    r(i, !0)
                }, function() {
                    s = !1,
                    r(i, !1)
        ...
        $$debounceViewValueCommit: function(e) {
            ...
            A(t[e]) ? t = t[e] : A(t.default) && (t = t.default),
            this.$$timeout.cancel(this.$$pendingDebounce);
            var n = this;
    ...
    var _o = function() {
            ...
            link: {
                ...
                post: function(e, u, c, l) {
                    function d(e) {
                        ...
                        return t && !t.selected && (t.selected = !0),
                        e
                    }
                    function f(e, t) {
                        e.element = t,
                            ...
                            getOptions: function() {
                                for (var e = [], t = {}, r = v(n) || [], i = a(r), s = i.length, u = 0; u < s; u++) {
                                    var c = r === i ? u : i[u]
                                      , f = b(r[c], c)
                                      , y = d(n, f);
                                    y = new o(c = p(y, f),y,g(n, f),m(n, f),f = $(n, f)),
                                    e.push(y),
                                    t[c] = y
                                }
                                return {
                    ...
                    }(c.ngOptions, u, e), w = n[0].createDocumentFragment();
                    ...
                    b.trackBy && e.$watchCollection(function() {
                        ...
                        if (y) {
                            ...
                            n ? (u[0].value !== n.selectValue && (p.removeUnknownOption(),
                            u[0].value = n.selectValue,
                            n.element.selected = !0),
                            n.element.setAttribute("selected", "selected")) : p.selectUnknownOrEmptyOption(e)
                        }
                    }
                    ,
                    p.readValue = function() {
                        var e = y.selectValueMap[u.val()];
                        return e && !e.disabled ? (p.unselectEmptyOption(),
                        p.removeUnknownOption(),
                        y.getViewValueFromOption(e)) : null
                    }
                    ,
                    ...
                    l && (t(p.emptyOption)(e),
                    u.prepend(p.emptyOption),
                    8 === p.emptyOption[0].nodeType ? (p.hasEmptyOption = !1,
                    p.registerOption = function(e, t) {
                        "" === t.val() && (p.hasEmptyOption = !0,
                        p.emptyOption = t,
                    ...
                    e.$watchCollection(b.getWatchables, function() {
                        var e = y && p.readValue();
                        if (y)
                        ...
                        u[0].appendChild(w),
                        h.$render(),
                        h.$isEmpty(e) || (t = p.readValue(),
                        (b.trackBy || g ? P(e, t) : e === t) || (h.$setViewValue(t),
                        h.$render()))
                    })
                }
            }
      ...
      , Uo = ["$locale", "$interpolate", "$log", function(e, t, n) {
        ...
        return {
            link: function(a, s, u) {
                ...
                var l, d = u.count, f = u.$attr.when && s.attr(u.$attr.when), h = u.offset || 0, g = a.$eval(f) || {}, m = {}, v = t.startSymbol(), y = t.endSymbol(), b = v + d + "-" + h + y, w = er.noop;
                o(u, function(e, t) {
                    var n = i.exec(t);
                    n && (n = (n[1] ? "-" : "") + Gn(n[2]),
                    g[n] = s.attr(u.$attr[t]))
                ...
                a.$watch(d, function(t) {
                    var r = parseFloat(t)
                      , i = nr(r);
                    i || r in g || (r = e.pluralCat(r - h)),
                    r === l || i && nr(l) || (w(),
                    $(i = m[r]) ? (null != t && n.debug("ngPluralize: no rule defined for '" + r + "' in " + f),
                    w = p,
                    c()) : w = a.$watch(i, c),
                    l = r)
                })
      ...
      , Vo = ["$parse", "$animate", "$compile", function(e, t, n) {
        ...
        return {
            ...
            compile: function(r, u) {
                ...
                if (!(d = c.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/)))
                    throw a("iexp", c);
                var d, f = d[1], p = d[2], h = d[3], g = d[4];
                if (!(d = f.match(/^(?:(\s*[$\w]+)|\(\s*([$\w]+)\s*,\s*([$\w]+)\s*\))$/)))
                    throw a("iidexp", f);
                var m = d[3] || d[1]
                  , $ = d[2];
                if (h && (!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(h) || /^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(h)))
                    throw a("badident", h);
                var v, y, b, w, A = {
                    $id: Ue
                };
                ...
                function(e, n, r, u, d) {
                    ...
                    e.$watchCollection(p, function(r) {
                        var u, p, g, v, A, x, C, S, k, E, _ = n[0], D = oe();
                        if (h && (e[h] = r),
                        i(r))
                            S = r,
                            p = y || b;
                            ...
                            S = [],
                            r)
                                Hn.call(r, E) && "$" !== E.charAt(0) && S.push(E);
                        for (v = S.length,
                        E = Array(v),
                        u = 0; u < v; u++)
                            if (A = r === S ? u : S[u],
                        ...
                        for (u = 0; u < v; u++)
                            ...
                            (k = E[u]).scope) {
                                ...
                                k.clone[0] !== g && t.move(ie(k.clone), null, _),
            ...
            compile: function(t) {
                ...
                function(e, t, r, i, o) {
                    ...
                    o(function(e, n) {
                        ...
                        r ? t.append(e) : (a(),
                        n.$destroy())
                    }, null, r = r.ngTransclude || r.ngTranscludeSlot),
      ...
      , Ho = ["$element", "$scope", function(t, n) {
        ...
        o.ngModelCtrl = Lo,
        o.multiple = !1,
        o.unknownOption = Rn(e.document.createElement("option")),
        o.hasEmptyOption = !1,
        o.emptyOption = void 0,
        o.renderUnknownOption = function(e) {
            e = o.generateUnknownOptionValue(e),
            o.unknownOption.val(e),
            t.prepend(o.unknownOption),
            Bn(o.unknownOption, !0),
            t.val(e)
        }
        ,
        ...
        o.writeValue = function(e) {
            ...
            n && Bn(Rn(n), !1),
            o.hasOption(e) ? (o.removeUnknownOption(),
            n = Ue(e),
            t.val(n in o.selectValueMap ? n : e),
            Bn(Rn(t[0].options[t[0].selectedIndex]), !0)) : o.selectUnknownOrEmptyOption(e)
        }
        ,
                        ...
                        n.multiple) {
                            ...
                            i.readValue = function() {
                                ...
                                return o(t.find("option"), function(t) {
                                    t.selected && !t.disabled && (t = t.value,
                                    e.push(t in i.selectValueMap ? i.selectValueMap[t] : t))
                                }),
                                e
                            }
                            ,
                            ...
                            var s, u = NaN;
                            e.$watch(function() {
                                u !== a.$viewValue || P(s, a.$viewValue) || (s = se(a.$viewValue),
                                a.$render()),
                                u = a.$viewValue
                            }),
            ...
            link: function(e, t, n, i) {
                if (i) {
                    ...
                    n.$observe("pattern", function(e) {
                        ...
                        e && !e.test)
                            throw r("ngPattern")("noregexp", a, e, z(t));
                        o = e || void 0,
                        i.$validate()
                    }),
    ...
    e.angular.bootstrap ? e.console && console.log("WARNING: Tried to load angular more than once.") : (function() {
        ...
        if (!gr) {
            var n = lr();
            (jn = $(n) ? e.jQuery : n ? e[n] : void 0) && jn.fn.on ? (Rn = jn,
            c(jn.fn, {
                scope: Or.scope,
            ...
            t = jn.cleanData,
            jn.cleanData = function(e) {
                for (var n, r, i = 0; null != (r = e[i]); i++)
                    (n = jn._data(r, "events")) && n.$destroy && jn(r).triggerHandler("$destroy");
                t(e)
            }
            ) : Rn = pe,
            er.element = Rn,
    ...
    er.module("ngLocale", [], ["$provide", function(e) {
        e.value("$locale", {
            ...
            pluralCat: function(e, t) {
                var n, r, i = 0 | e, o = t;
                return void 0 === o && (o = Math.min((n = e,
                -1 == (r = (n += "").indexOf(".")) ? 0 : n.length - r - 1), 3)),
                Math.pow(10, o),
                1 == i && 0 == o ? "one" : "other"
            }
        })
...
function(e, t) {
    ...
    function n(e, n, r) {
        ...
        return function(e, r, a) {
            var s, u;
            u = (a = a || {}).expires,
            s = t.isDefined(a.path) ? a.path : i,
            t.isUndefined(r) && (u = "Thu, 01 Jan 1970 00:00:00 GMT",
            r = ""),
            t.isString(u) && (u = new Date(u)),
            r = (r = encodeURIComponent(e) + "=" + encodeURIComponent(r)) + (s ? ";path=" + s : "") + (a.domain ? ";domain=" + a.domain : ""),
            r += u ? ";expires=" + u.toUTCString() : "",
            4096 < (a = (r += a.secure ? ";secure" : "").length + 1) && n.warn("Cookie '" + e + "' possibly not set or overflowed because it was too large (" + a + " > 4096 bytes)!"),
            o.cookie = r
        }
    }
        ...
        return ["$animate", function(e) {
            return {
                ...
                link: function(t, n, r, o, a) {
                    var s, u, c, l = n[0], d = r.ngMessage || r.when, f = function(e) {
                        s = e ? i(e) ? e : e.split(/[\s,]+/) : null,
                        o.reRender()
                    };
                    (r = r.ngMessageExp || r.whenExp) ? (f(t.$eval(r)),
                    t.$watchCollection(r, f)) : f(d),
                    o.register(l, c = {
                        test: function(e) {
                            var t = s;
            ...
            controller: ["$element", "$scope", "$attrs", function(i, o, a) {
                function s(e, t) {
                    for (var n = t, r = []; n && n !== e; ) {
                        ...
                        if (i && i.length)
                            return p[i];
                        n.childNodes.length && -1 === r.indexOf(n) ? (r.push(n),
                        n = n.childNodes[n.childNodes.length - 1]) : n.previousSibling ? n = n.previousSibling : (n = n.parentNode,
                        r.push(n))
                    }
                }
                var u = this
                ...
                ,
                o.$watchCollection(a.ngMessages || a.for, u.render),
                ...
                this.register = function(e, t) {
                    ...
                    var r = i[0]
                      , o = p[n];
                    u.head ? (r = s(r, e)) ? (o.next = r.next,
                    r.next = o) : (o.next = u.head,
                    u.head = o) : u.head = o,
                    e.$$ngMessageNode = n,
                    c++,
                    u.reRender()
                ...
                this.deregister = function(e) {
                    ...
                    var n = p[t];
                    (e = s(i[0], e)) ? e.next = n.next : u.head = n.next,
                    delete p[t],
                    u.reRender()
                }
            }
...
ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function(e, t, n) {
    function r(r) {
        function i(e) {
            c.notify && c.notify(e),
            l.progressFunc && n(function() {
                l.progressFunc(e)
            })
        }
        function s(e) {
        ...
        function u() {
            e(r).then(function(e) {
                if (a && r._chunkSize && !r._finished && r._file) {
                    ...
                    r._finished && delete r._finished,
                    c.resolve(e)
            }, function(e) {
                c.reject(e)
            }, function(e) {
        ...
        return r.disableProgress || (r.headers.__setXHR_ = function() {
            return function(e) {
                e && e.upload && e.upload.addEventListener && (r.__XHR = e,
                r.xhrFn && r.xhrFn(e),
                ...
                e.upload.addEventListener("load", function(e) {
                    e.lengthComputable && (e.config = r,
                    i(s(e)))
                }, !1))
            }
        }
        ),
        a ? r._chunkSize && r._end && !r._finished ? (r._start = r._end,
        r._end += r._chunkSize,
        u()) : r.resumeSizeUrl ? e.get(r.resumeSizeUrl).then(function(e) {
            r._start = r.resumeSizeResponseReader ? r.resumeSizeResponseReader(e.data) : parseInt((null == e.data.size ? e.data : e.data.size).toString()),
            ...
            throw e
        }) : (r._chunkSize && (r._start = 0,
        r._end = r._start + r._chunkSize),
        u()) : u(),
        ...
        l.progress = function(e) {
            return l.progressFunc = e,
            l.then(null, null, function(t) {
                e(t)
            }),
            l
        }
        ...
        ,
        l.xhr = function(e) {
            return r.xhrFn = (t = r.xhrFn,
            function() {
                t && t.apply(l, arguments),
                e.apply(l, arguments)
            }
            ),
            l;
        ...
        ,
        o.promisesCount++,
        l.finally && l.finally instanceof Function && l.finally(function() {
            o.promisesCount--
        }),
        l
    }
                ...
                angular.isString(r))
                    ...
                    var s = function(t, n) {
                        ...
                        null != e._start && a) {
                            ...
                            n.append("_currentChunkSize", e._end - e._start),
                            n.append("_chunkNumber", Math.floor(e._start / e._chunkSize)),
                            n.append("_totalSize", e._file.size)),
                            r
                        }
                        return t
                    }(r, t)
                      , u = i.split(",");
                    u[1] && (s.ngfName = u[1].replace(/^\s+|\s+$/g, ""),
                    i = u[0]),
                    e._fileKey = e._fileKey || i,
                    t.append(i, s, s.ngfName || s.name)
                } else if (angular.isObject(r)) {
                    if (r.$$ngfCircularDetection)
                        throw "ngFileUpload: Circular reference in config.data. Make sure specified data for Upload.upload() has no circular reference: " + i;
                    r.$$ngfCircularDetection = !0;
                    try {
                        for (var c in r)
                            if (r.hasOwnProperty(c) && "$$ngfCircularDetection" !== c) {
                                var l = null == e.objectKey ? "[i]" : e.objectKey;
                                r.length && parseInt(c) > -1 && (l = null == e.arrayKey ? l : e.arrayKey),
                                n(t, r[c], i + l.replace(/[ik]/g, c))
                            }
                    } finally {
...
ngFileUpload.service("Upload", ["$parse", "$timeout", "$compile", "$q", "UploadExif", function(e, t, n, r, i) {
    function o(e, t, n, i, o) {
        function s(r, s) {
            if (0 === r.type.indexOf("image")) {
                if (e.pattern && !a.validatePattern(r, e.pattern))
                    return;
                ...
                c.then(function(e) {
                    ...
                    r.$error = "resize",
                    (r.$errorMessages = r.$errorMessages || {}).resize = !0,
        ...
        for (var u = [a.emptyPromise()], c = 0; c < t.length; c++)
            s(t[c], c);
        return r.all(u)
    }
    var a = i;
    ...
    a.updateModel = function(n, i, s, u, c, l, d) {
        function f(r, o, c, d, f) {
            i.$$ngfPrevValidFiles = r,
            i.$$ngfPrevInvalidFiles = o;
            var p = r && r.length ? r[0] : null
              , h = o && o.length ? o[0] : null;
            n && (a.applyModelValidation(n, r),
            n.$setViewValue(f ? p : r)),
            u && e(u)(s, {
                $files: r,
                $file: p,
                $newFiles: c,
        ...
        function p() {
            ...
            (function(e, t, n, i) {
                ...
                if (!s || !a.isResizeSupported() || !e.length)
        ...
        var h, g, m, $, v = [], y = [], b = [];
        g = i.$$ngfPrevValidFiles || [],
        m = i.$$ngfPrevInvalidFiles || [],
        n && n.$modelValue && ($ = n.$modelValue,
        g = angular.isArray($) ? $ : [$]);
        var w = a.attrGetter("ngfKeep", i, s);
        h = (c || []).slice(0),
        ("distinct" === w || !0 === a.attrGetter("ngfKeepDistinct", i, s)) && function() {
            function e(e, t) {
        ...
        if (!w || h.length) {
            ...
            a.validate(h, w ? g.length : 0, n, i, s).then(function(e) {
                var t, n, o, u;
                d ? f(h, [], c, v, A) : (C && C.allowInvalid || x ? b = h : (b = e.validFiles,
                y = e.invalidFiles),
                a.attrGetter("ngfFixOrientation", i, s) && a.isExifSupported() ? (t = b,
                n = i,
                o = s,
                u = [a.emptyPromise()],
...
ngFileUpload.directive("ngfSelect", ["$parse", "$timeout", "$compile", "Upload", function(e, t, n, r) {
    function i(e, t, n, i, a, s, u, c) {
        ...
        function p(t) {
            c.shouldUpdateOn("click", n, e) && v.val() && (v.val(null),
            c.updateModel(i, n, e, d(), null, t, !0))
        }
        var h = function(e, t) {
        ...
        l() || (v = function() {
            ...
            function(e, r) {
                function i(t) {
                    e.attr("id", "ngf-" + t),
                    r.attr("id", "ngf-label-" + t)
                }
                for (var o = 0; o < t[0].attributes.length; o++) {
                    var a = t[0].attributes[o];
                    "type" !== a.name && "class" !== a.name && "style" !== a.name && ("id" === a.name ? (i(a.value),
                    g.push(n.$observe("id", i))) : e.attr(a.name, a.value || "required" !== a.name && "multiple" !== a.name ? a.value : a.name))
                }
            }(e, r),
            o.push({
                el: t,
            ...
            document.body.appendChild(r.append(e)[0]),
            e
        }()),
        v.bind("change", f),
        l() ? t.bind("click", p) : t.bind("click touchstart touchend", function(n) {
            if (t.attr("disabled"))
                return !1;
                ...
                var i = function(e) {
                    ...
                    if (t) {
                        ...
                        if ("touchend" === e.type) {
                            var n = t[0].clientX
                              , r = t[0].clientY;
                            if (Math.abs(n - $) > 20 || Math.abs(r - m) > 20)
        ...
        -1 !== navigator.appVersion.indexOf("MSIE 10") && v.bind("click", function e(t) {
            if (v && !v.attr("__ngf_ie10_Fix_")) {
                ...
                v.unbind("click");
                var n = v.clone();
                return v.replaceWith(n),
                (v = n).attr("__ngf_ie10_Fix_", "true"),
                v.bind("change", f),
                v.bind("click", e),
                v[0].click(),
                !1
        ...
        i && i.$formatters.push(function(e) {
            return (null == e || 0 === e.length) && v.val() && v.val(null),
            e
        }),
        e.$on("$destroy", function() {
            l() || v.parent().remove(),
        ...
        s(function() {
            for (var e = 0; e < o.length; e++) {
                var t = o[e];
                document.body.contains(t.el[0]) || (o.splice(e, 1),
                t.ref.remove())
            }
        }),
...
function() {
        ...
        function u(o) {
            ...
            e.dataUrl(o, a).finally(function() {
                t(function() {
                    ...
                    s ? r.css("background-image", "url('" + (e || "") + "')") : r.attr("src", e),
                    e ? r.removeClass("ng-hide") : r.addClass("ng-hide")
                })
            })
        }
        t(function() {
            var t = n.$watch(i[o], function(t) {
                ...
                return angular.isString(t) ? (r.removeClass("ng-hide"),
                s ? r.css("background-image", "url('" + t + "')") : r.attr("src", t)) : void (!t || !t.type || 0 !== t.type.search((c = r[0],
                "img" === c.tagName.toLowerCase() ? "image" : "audio" === c.tagName.toLowerCase() ? "audio" : "video" === c.tagName.toLowerCase() ? "video" : /./)) || s && 0 !== t.type.indexOf("image") ? r.addClass("ng-hide") : l && e.isResizeSupported() ? (l.resizeIf = function(r, o) {
    ...
    ngFileUpload.filter("ngfDataUrl", ["UploadDataUrl", "$sce", function(e, t) {
        return function(n, r, i) {
            ...
            return n && !o ? (!n.$ngfDataUrlFilterInProgress && angular.isObject(n) && (n.$ngfDataUrlFilterInProgress = !0,
            e.dataUrl(n, r)),
            "") : (n && delete n.$ngfDataUrlFilterInProgress,
            (n && o ? i ? t.trustAsResourceUrl(o) : o : n) || "")
        }
    }
    ])
}(),
ngFileUpload.service("UploadValidate", ["UploadDataUrl", "$q", "$timeout", function(e, t, n) {
            ...
            if (t.length > 2 && "/" === t[0] && "/" === t[t.length - 1])
                ...
                if (i.length > 1)
                    for (var o = 0; o < i.length; o++) {
                        var a = e(i[o]);
                        a.regexp ? (n += "(" + a.regexp + ")",
                        o < i.length - 1 && (n += "|")) : r = r.concat(a.excludes)
                    }
                else
                    0 === t.indexOf("!") ? r.push("^((?!" + e(t.substring(1)).regexp + ").)*$") : (0 === t.indexOf(".") && (t = "*" + t),
                    n = (n = "^" + t.replace(new RegExp("[.\\\\+*?\\[\\^\\]$(){}=!<>|:\\-]","g"), "\\$&") + "$").replace(/\\\*/g, ".*").replace(/\\\?/g, "."))
            }
            return {
                regexp: n,
                excludes: r
    ...
    r.registerModelChangeValidator = function(e, t, n) {
        e && e.$formatters.push(function(i) {
            if (e.$dirty) {
                var o = i;
                i && !angular.isArray(i) && (o = [i]),
                r.validate(o, 0, e, t, n).then(function() {
    ...
    r.applyModelValidation = function(e, t) {
        var n;
        n = e,
        null == t || n.$dirty || (n.$setDirty ? n.$setDirty() : n.$dirty = !0),
    ...
    r.validate = function(e, n, i, o, a) {
            ...
            if (e) {
                for (var u = e.length, c = null; u--; ) {
                    ...
                    if (p) {
                        ...
                        null != h && (s(p, h, u) || (-1 === l.indexOf(t) ? (p.$error = t,
                        (p.$errorMessages = p.$errorMessages || {})[t] = !0,
                        p.$errorParam = h,
        ...
        function u(n, s, u, p, h) {
            function g(t, r, i) {
                function o(o) {
                    if (o())
                        if (-1 === l.indexOf(n)) {
                            if (r.$error = n,
                            (r.$errorMessages = r.$errorMessages || {})[n] = !0,
                            r.$errorParam = i,
            ...
            angular.forEach(e, function(e) {
                var i = t.defer();
                return m.push(i.promise),
                !u || null != e.type && 0 === e.type.search(u) ? void ("dimensions" === n && null != r.attrGetter("ngfDimensions", o) ? r.imageDimensions(e).then(function(t) {
        ...
        (i = i || {}).$ngfValidations = i.$ngfValidations || [],
        angular.forEach(i.$ngfValidations, function(e) {
            e.valid = !0
        });
        var c = function(e, t) {
        ...
        if (null == e || 0 === e.length)
            return r.emptyPromise({
                validFiles: e,
                invalidFiles: []
            });
        e = void 0 === e.length ? [e] : e.slice(0);
        var f = [];
        s("pattern", null, r.validatePattern),
        ...
        if (s("maxTotalSize", null, function(t, n) {
            return !((p += t.size) > r.translateScalars(n)) || (e.splice(0, e.length),
            !1)
        }),
        ...
        g.push(u("ratio", null, /image/, this.imageDimensions, function(e, t) {
            for (var n = t.toString().split(","), i = !1, o = 0; o < n.length; o++)
                Math.abs(e.width / e.height - r.ratioToFloat(n[o])) < .01 && (i = !0);
            return i
        })),
        ...
        t.all(g).then(function() {
            ...
            d = !1,
            s("maxFiles", null, function(e, t, r) {
                return t > n + r
            }),
            h.resolve({
                validFiles: e,
    ...
    r.imageDimensions = function(e) {
        ...
        e.$ngfDimensionPromise = o.promise,
    ...
    r.mediaDuration = function(e) {
        ...
        e.$ngfDurationPromise = o.promise,
...
ngFileUpload.service("UploadResize", ["UploadValidate", "$q", function(e, t) {
    var n = e
      , r = function(e, r, i, o, a, s, u, c) {
        ...
        return f.setAttribute("style", "visibility:hidden;position:fixed;z-index:-100000"),
        document.body.appendChild(f),
        f.onload = function() {
            var e, t, p, h, g, m = f.width, $ = f.height;
            ...
            null == c || !1 !== c(m, $))
                try {
                    ...
                    p = r,
                    h = i,
                    g = u ? Math.max(p / e, h / t) : Math.min(p / e, h / t),
                    {
                        width: e * g,
                        height: t * g,
                        marginX: e * g - p,
                    ...
                    d.width = Math.min(y.width, r),
                    d.height = Math.min(y.height, i),
                    d.getContext("2d").drawImage(f, Math.min(0, -y.marginX / 2), Math.min(0, -y.marginY / 2), y.width, y.height),
                    l.resolve(d.toDataURL(a || "image/WebP", o || .934))
                } catch (e) {
                    l.reject(e)
                }
            else
    ...
    n.resize = function(e, i) {
        ...
        return n.dataUrl(e, !0).then(function(t) {
            r(t, i.width, i.height, i.quality, i.type || e.type, i.ratio, i.centerCrop, i.resizeIf).then(function(r) {
                if ("image/jpeg" === e.type && !1 !== i.restoreExif)
                    try {
                        r = n.restoreExif(t, r)
                    } catch (e) {
                        setTimeout(function() {
    ...
    function e(e, n, r, i, o, a, s, u, c, l) {
                ...
                (function(t, n, i, o) {
                                ...
                                var o = e.createReader()
                                  ...
                                  , g = function() {
                                    o.readEntries(function(i) {
                                        try {
                                            i.length ? (s = s.concat(Array.prototype.slice.call(i || [], 0)),
                                            g()) : (angular.forEach(s.slice(0), function(n) {
                    ...
                    if (t && t.length > 0 && "file:" !== s.location.protocol)
                        for (var $ = 0; $ < t.length; $++) {
                            ...
                            if (p.length > c || h > d || !o && p.length > 0)
                                break
                        }
                    else if (null != n)
                        for (var b = 0; b < n.length; b++) {
                            var w = n.item(b);
                            if ((w.type || w.size > 0) && (p.push(w),
                            h += w.size),
                            p.length > c || h > d || !o && p.length > 0)
                                break
                        }
                    var A = l.defer();
                    ...
                    t.length ? p(t, n) : function(t, n) {
                        if (!u.shouldUpdateOn(t, r, e) || "string" != typeof n)
        ...
        h) {
            ...
            n[0].addEventListener("dragenter", function(t) {
                !d() && u.shouldUpdateOn("drop", r, e) && (t.preventDefault(),
                v(e) && t.stopPropagation())
            }, !1),
            ...
            n[0].addEventListener("drop", function(t) {
                ...
                m && n.removeClass(m),
                m = null,
                f(t.dataTransfer, t, "dropUrl"))
            }, !1),
            n[0].addEventListener("paste", function(t) {
                navigator.userAgent.toLowerCase().indexOf("firefox") > -1 && g("ngfEnableFirefoxPaste", e) && t.preventDefault(),
                !d() && u.shouldUpdateOn("paste", r, e) && f(t.clipboardData || t.originalEvent.clipboardData, t, "pasteUrl")
            }, !1),
            navigator.userAgent.toLowerCase().indexOf("firefox") > -1 && g("ngfEnableFirefoxPaste", e) && (n.attr("contenteditable", !0),
            n.on("keypress", function(e) {
                e.metaKey || e.ctrlKey || e.preventDefault()
            }))
        } else
            !0 === g("ngfHideOnDropNotAvailable", e) && n.css("display", "none")
    }
    function t() {
...
ngFileUpload.service("UploadExif", ["UploadResize", "$q", function(e, t) {
                ...
                65505 === a) {
                    ...
                    for (var c = 0; u > c; c++)
                        if (274 === r.getUint16(o + 12 * c, s)) {
                            ...
                            return l >= 2 && 8 >= l && (r.setUint16(o + 12 * c + 8, 1, s),
    ...
    n.applyExifRotation = function(e) {
        ...
        return n.readOrientation(e).then(function(t) {
            return t.orientation < 2 || t.orientation > 8 ? r.resolve(e) : void n.dataUrl(e, !0).then(function(i) {
                ...
                a.onload = function() {
                    try {
                        o.width = t.orientation > 4 ? a.height : a.width,
                        o.height = t.orientation > 4 ? a.width : a.height;
                        ...
                        )(i, t.orientation, a.width, a.height),
                        i.drawImage(a, 0, 0);
    ...
    n.restoreExif = function(e, t) {
        var n = {
            ...
            encode64: function(e) {
                var t, n, r, i, o, a = "", s = "", u = "", c = 0;
                do {
                    r = (t = e[c++]) >> 2,
                    i = (3 & t) << 4 | (n = e[c++]) >> 4,
                    o = (15 & n) << 2 | (s = e[c++]) >> 6,
                    u = 63 & s,
                    isNaN(n) ? o = u = 64 : isNaN(s) && (u = 64),
                    a = a + this.KEY_STR.charAt(r) + this.KEY_STR.charAt(i) + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(u),
                    t = n = s = "",
                    r = i = o = u = ""
                } while (c < e.length);
                return a
            ...
            decode64: function(e) {
                ...
                do {
                    ...
                    n = (15 & r) << 4 | (i = this.KEY_STR.indexOf(e.charAt(s++))) >> 2,
                    o = (3 & i) << 6 | (a = this.KEY_STR.indexOf(e.charAt(s++))),
                    u.push(t),
                    64 !== i && u.push(n),
                    64 !== a && u.push(o),
                    t = n = o = "",
...
angular.module("siteBuilder.public", ["ngMessages", "ngCookies", "ngFileUpload"]),
angular.module("siteBuilder.public").service("$analytics", [function() {
    var e = this;
    ...
    e.createWebsite = function(t, n) {
        e.event("create-website", "site", t),
        e.event("create-website-succeed", "site", n)
    }
    ,
    e.whois = function() {
...
angular.module("siteBuilder.public").service("$memory", [function() {
    ...
    e.set = function(t, n) {
        ...
        return memoryStorage[r] = JSON.stringify(t),
        r
    }
    ,
    e.get = function(e) {
...
angular.module("siteBuilder.public").directive("mappingCity", ["$mapping", function(e) {
    return {
        ...
        link: function(t, n, r, i) {
            function o() {
                if (delete t.$parent.cities,
                t.state) {
                    var n = e.getCities(t.state);
                    t.$parent.citiesLoading = !0,
                    n.then(function(e) {
                        t.$parent.cities = e.data.cities,
                        t.$parent.citiesLoading = !1
                    })
                }
            }
            o(),
            t.$watch("state", function() {
                i.$setPristine(!1),
                o()
            })
        }
    ...
    return {
        ...
        link: function(e, t, n) {
            t.bind("click", function(e) {
                n.clickConfirm && !confirm(n.clickConfirm) && (e.stopImmediatePropagation(),
                e.preventDefault())
            })
        }
    }
...
angular.module("siteBuilder.public").directive("countDown", ["$interval", function(e) {
    return {
        ...
        link: function(t, n, r) {
            ...
            function a() {
                t.days = Math.floor(i / 86400),
                t.hours = Math.floor(i / 3600 % 24),
                t.minutes = Math.floor(i / 60 % 60),
                t.seconds = Math.floor(i % 60),
                i = i > 0 ? i - 1 : 0
            }
        }
    }
...
angular.module("siteBuilder.public").directive("mappingCountry", ["$mapping", function(e) {
    return {
        ...
        link: function(t, n, r) {
            ...
            t.$parent.countriesLoading = !0,
            i.then(function(e) {
                t.$parent.countries = e.data.countries,
                t.$parent.countriesLoading = !1
            })
        }
    }
}
...
angular.module("siteBuilder.public").directive("invariantCulture", function() {
    return {
        ...
        link: function(e, t, n, r) {
            r.$parsers.push(function(e) {
                return null != e && (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace(/\u06F1/g, "1")).replace(/\u06F2/g, "2")).replace(/\u06F3/g, "3")).replace(/\u06F4/g, "4")).replace(/\u06F5/g, "5")).replace(/\u06F6/g, "6")).replace(/\u06F7/g, "7")).replace(/\u06F8/g, "8")).replace(/\u06F9/g, "9")).replace(/\u06F0/g, "0")).replace(/\u0661/g, "1")).replace(/\u0662/g, "2")).replace(/\u0663/g, "3")).replace(/\u0664/g, "4")).replace(/\u0665/g, "5")).replace(/\u0666/g, "6")).replace(/\u0667/g, "7")).replace(/\u0668/g, "8")).replace(/\u0669/g, "9")).replace(/\u0660/g, "0")),
                e
            })
        }
    }
    ...
    return {
        ...
        link: function(e, t, n) {
            if ("function" == typeof angular.element().modal && t.hasClass("modal")) {
                ...
                t.attr("id", r),
                angular.element(document).on("click", ".edit-link", function(e) {
                    angular.element(window).width() <= 991 || (t.find(".modal-content").html('<iframe src="' + angular.element(e.currentTarget).attr("href") + "?modal=true&modal_id=" + r + '" scrolling="no" style="border:0;width:100%;"></iframe>'),
                    e.preventDefault(),
                    t.modal("show"))
                }),
...
angular.module("siteBuilder.public").directive("dynamicForm", ["$timeout", "$memory", "$window", function(e, t, n) {
    ...
    return {
        ...
        link: function(e, t, n) {
            ...
            void 0 !== i && (e.validation = null,
            e.dynamicForm = i,
            t.bind("submit", function() {
                for (var n in delete e.validation,
                i)
                    0 == n.startsWith("$") && i[n].$setValidity("server", !0);
                r(t)
            }),
    ...
    return {
        ...
        link: function(e, t, n) {
            t.bind("load", function() {
                t.addClass("loading-completed"),
                n.imageLoad && e.$apply(n.imageLoad)
            }),
            t.bind("error", function() {
                t.addClass("loading-error"),
                n.imageLoadError ? e.$apply(n.imageLoadError) : n.imageLoad && e.$apply(n.imageLoad)
            })
        }
    }
}),
    ...
    return {
        ...
        link: function(t, n, r) {
            ...
            function o(e) {
                ...
                if (t.length > 0) {
                    if (t.find(".nav-subset").length < 1)
                        return;
                    if (t.hasClass("expanded"))
                        return;
                    t.parents(".nav-item, .nav-subset-item").addClass("ignore"),
                    a(),
                    i++,
                    t.addClass("expanded"),
                    e.stopPropagation(),
            ...
            function a() {
                i && n.find(".nav-item.expanded, .nav-subset-item.expanded").each(function() {
                    ...
                    if (0 == e.hasClass("ignore"))
                        return e.removeClass("expanded"),
                        void i--;
                    e.removeClass("ignore")
                })
            }
            n.find(".nav-subset-item.active").parents(".nav-item, .nav-subset-item").addClass("active"),
            n.on("click", ".nav-link, .nav-subset-link", o),
            n.find(".nav-item, .nav-subset-item").each(function() {
        ...
        link: function(e, t, n) {
            if ("function" == typeof angular.element().owlCarousel) {
                ...
                r.mousewheel && t.on("mousewheel", function(e) {
                    t.trigger(e.deltaY > 0 ? "next.owl" : "prev.owl"),
                    e.preventDefault()
                }),
                t.owlCarousel(r)
            }
        ...
        link: function(i, o, a) {
            ...
            o.on("click", function(o) {
                if (!s) {
                        ...
                        if (null != o) {
                            if (o.variants && 1 == o.variants.length && "primary" == o.variants[0].title) {
                                ...
                                return u.then(function(e) {
                                    i.trigger("quickBuy_addToCartSucceed", e),
                                    n.addToCart(),
                                    a.quickBuyCallback ? r.location = a.quickBuyCallback : (i.$root.$broadcast("cart.refresh"),
                                    s = !1)
                                }),
                                void u.catch(function(e) {
                                    i.trigger("quickBuy_addToCartFailed", e),
                                    i.toast(e.data.description),
                                    s = !1
                                })
                            }
                            r.location = o.url
                    ...
                    u.catch(function(e) {
                        i.trigger("quickBuy_retrieveFailed", e),
                        i.toast(e.data.description),
                        s = !1
                    }),
                    o.preventDefault()
            ...
            return {
                pre: function(i, o, a) {
                    ...
                    i.ensure = function(n, r) {
                        ...
                        this.cacheName = t.set(i, this.cacheName),
                        this.model ? angular.extend(this.model, i) : this.model = i
                    }
                    ,
                    i.reset = function(e) {
                        if (this.model = e || t.get(this.cacheName),
                        void 0 != this.dynamicForm)
                            for (var n in this.dynamicForm.$setPristine(),
                            this.dynamicForm.$submitted = !1,
                            this.dynamicForm)
                                0 == n.startsWith("$") && this.dynamicForm[n].$setUntouched()
                    }
                    ,
                    i.error = function(e) {
                        var t = {
                        ...
                        if (e && e.data && (angular.extend(t, e.data.context),
                        e.data.description && (t.main = e.data.description)),
                        void 0 != this.dynamicForm)
                            for (var n in t)
                                this.dynamicForm.hasOwnProperty(n) && this.dynamicForm[n].$setValidity("server", !1);
                        this.validation = t,
                        void 0 !== this.focus && "function" == typeof this.focus && this.focus()
                    }
                    ,
                    i.trigger = function(e, t) {
                        var n = window[e];
                        return n && "function" == typeof n && n.call(t),
                        t
                    }
                    ,
                    i.toast = function(e) {
                    ...
                    i.quickview = function(e, t) {
                        if (null != e) {
                            ...
                            n.length < 1 || (n.modal("show"),
                            i.$broadcast("$quickview", {
                                id: e,
                                callback: t
                            }))
                        }
...
angular.module("siteBuilder.public").directive("mappingState", ["$mapping", function(e) {
    return {
        ...
        link: function(t, n, r, i) {
            function o() {
                if (delete t.$parent.states,
                t.country) {
                    var n = e.getStates(t.country);
                    t.$parent.statesLoading = !0,
                    n.then(function(e) {
                        t.$parent.states = e.data.states,
                        t.$parent.statesLoading = !1
                    })
                }
            }
            o(),
            t.$watch("country", function() {
                i.$setPristine(!1),
                o()
            })
        }
...
angular.module("siteBuilder.public").directive("tabs", ["$timeout", function(e) {
    return {
        ...
        restrict: "A",
        link: function(e, t, n) {
            "auto" == n.tabs && (t.find(".nav-tabs .nav-item:first .nav-link").addClass("active"),
            t.find(".tab-content .tab-pane:first").addClass("show active"))
        }
    }
}
]),
...
angular.module("siteBuilder.public").controller("addtocart", ["$scope", "$rootScope", "$cart", "$timeout", "$analytics", function(e, t, n, r, i) {
    e.variants = [],
    e.progress = e.succeed = e.failed = !1,
    e.model = {
        attributes: {},
        quantity: 1,
        price: 0,
    ...
    e.collect = function(t, n, r) {
        e.model.defaultComparePrice = n,
        e.model.defaultDiscount = r,
        e.model.defaultPrice = t
    }
    ,
    e.found = function() {
    ...
    ,
    e.select = function(t) {
        e.trigger("addToCart_select", t),
        angular.extend(e.model, t)
    }
    ,
    e.submit = function() {
        if (e.dynamicForm.$invalid)
            alert("لطفا مشخصات محصول را انتخاب کنید.");
        else {
            e.trigger("addToCart_submit", e.model);
            var r = n.addProduct(e.model.id, e.model.quantity);
            e.progress = !0,
            r.then(function(n) {
                e.trigger("addToCart_submitSucceed", n),
                i.addToCart(),
                t.$broadcast("cart.refresh"),
                angular.element("#success-modal, #product-addtocart-modal").modal(),
                e.progress = !1,
                e.succeed = n.data
            }),
            r.catch(function(t) {
                e.trigger("addToCart_submitFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
...
angular.module("siteBuilder.public").controller("addtowishlist", ["$scope", "$wishes", "$analytics", function(e, t, n) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("addToWhislist_submitSucceed", t),
            n.addToWhislist(),
            e.progress = !1,
            e.succeed = t.data
        }),
        r.catch(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("addToWhislist_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("cart.auth", ["$scope", "$user", "$user.documents", "$mapping", "$window", "$analytics", function(e, t, n, r, i, o) {
    ...
    e.submit = function() {
        if (!e.signedup || !e.upload()) {
            ...
            e.progress = !0,
            n.then(function(t) {
                e.trigger("cartAuth_submitSucceed", t),
                o["signin" == e.model.mode ? "signin" : "signup"]("signin" == e.model.mode ? e.model.username : e.model.name),
                e.progress = !1,
                e.signedup = "signup" == e.model.mode,
                e.upload() || (e.reset(),
                e.succeed = t.data,
                null != t.data.redirect && (i.location = t.data.redirect))
            }),
            n.catch(function(t) {
                e.trigger("cartAuth_submitFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    ,
    e.upload = function() {
        if (null == e.dynamicForm || null == e.dynamicForm.file)
            return !1;
        if ("signup" != e.model.mode)
            return !1;
        if (null == e.document) {
            ...
            return e.progress = !0,
            t.then(function(t) {
                e.trigger("signup_uploadDocumentSucceed", t),
                e.progress = !1,
                e.document = angular.extend(t.data, e.document),
                e.document.file = e.document.path,
                e.upload()
            }),
            t.catch(function(t) {
                e.trigger("signup_uploadDocumentFailed", t),
                e.error(t),
                e.progress = !1
            }),
            !0
        ...
        return e.progress = !0,
        t.then(function(t) {
            e.trigger("signup_createDocumentSucceed", t),
            e.progress = !1,
            e.succeed = t.data
        }),
        t.catch(function(t) {
            e.trigger("signup_createDocumentFailed", t),
            e.error(t),
            e.progress = !1
        }),
        !0
    ...
    e.$watch("model.mode", function(t) {
        if ("signup" == t && null == e.countries) {
            ...
            n.then(function(t) {
                e.trigger("cartAuth_retrieveCountriesSucceed", t),
                e.countries = t.data.countries
            }),
            n.catch(function(t) {
                e.trigger("cartAuth_retrieveCountriesFailed", t),
                e.error(t)
            })
        }
    }),
    e.$watch("model.country_id", function(t) {
        if (e.trigger("cartAuth_retrieveStates", t),
        null != t) {
            e.states = e.cities = void 0;
            var n = r.getStates(t);
            e.progress = !0,
            n.then(function(t) {
                e.trigger("cartAuth_retrieveStatesSucceed", t),
                e.progress = !1,
                e.states = t.data.states
            }),
            n.catch(function(t) {
                e.trigger("cartAuth_retrieveStatesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.$watch("model.state_id", function(t) {
        if (e.trigger("cartAuth_retrieveCities", t),
        null != t) {
            e.cities = void 0;
            var n = r.getCities(t);
            e.progress = !0,
            n.then(function(t) {
                e.trigger("cartAuth_retrieveCitiesSucceed", t),
                e.progress = !1,
                e.cities = t.data.cities
            }),
            n.catch(function(t) {
                e.trigger("cartAuth_retrieveCitiesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
...
angular.module("siteBuilder.public").controller("cart.checkout", ["$scope", "$cart", "$user", "$mapping", "$window", "$analytics", function(e, t, n, r, i, o) {
    ...
    e.retrieve = function() {
        e.loading = !0,
        e.trigger("cartCheckout_retrieve");
        var n = t.get({
            update: !0
        });
        n.then(function(t) {
            e.trigger("cartCheckout_retrieveSucceed", t),
            e.cart = t.data.cart,
            e.model = angular.extend({}, e.model, e.cart, e.cart.contact),
            e.normalize(e.model),
            e.retrieveCountries(),
            e.retrieveProfile(),
            e.locateClient(),
        ...
        n.catch(function(t) {
            e.trigger("cartCheckout_retrieveFailed", t),
            e.error(t),
            e.loading = !1
        })
    }
    ...
    e.retrieveCountries = function() {
        if (0 != e.shippingRequired()) {
            ...
            t.then(function(t) {
                e.trigger("cartCheckout_retrieveCountriesSucceed", t),
                e.countries = t.data.countries
            }),
            t.catch(function(t) {
                e.trigger("cartCheckout_retrieveCountriesFailed", t),
                e.error(t)
            })
        }
    }
    ...
    e.retrieveProfile = function() {
        ...
        t.then(function(t) {
            ...
            e.trigger("cartCheckout_retrieveProfileSucceed", t),
            e.profile = e.normalize(t.data.profile),
            n("name"),
            n("mobile"),
            n("phone"),
            n("email"),
        ...
        t.catch(function(t) {
            e.trigger("cartCheckout_retrieveProfileFailed", t),
            e.loading = !1
        })
    }
    ,
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("cartCheckout_submitSucceed", t),
            o.checkout(e.model.price),
            e.progress = !1,
            e.succeed = t.data,
            null != t.data.redirect && (i.location = t.data.redirect)
        }),
        r.catch(function(t) {
            e.trigger("cartCheckout_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ,
    e.$watch("model.country_id", function(t) {
        if (e.trigger("cartCheckout_retrieveStates", t),
        null != t) {
            e.states = e.cities = void 0;
            var n = r.getStates(t);
            e.progress = !0,
            n.then(function(n) {
                e.trigger("cartCheckout_retrieveStatesSucceed", n),
                e.updateLocation(e.countries, t, 5),
                e.progress = !1,
                e.states = n.data.states
            }),
            n.catch(function(t) {
                e.trigger("cartCheckout_retrieveStatesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.$watch("model.state_id", function(t) {
        if (e.trigger("cartCheckout_retrieveCities", t),
        null != t) {
            e.cities = void 0;
            var n = r.getCities(t);
            e.progress = !0,
            n.then(function(n) {
                e.trigger("cartCheckout_retrieveCitiesSucceed", n),
                e.updateLocation(e.states, t, 10),
                e.progress = !1,
                e.cities = n.data.cities
            }),
            n.catch(function(t) {
                e.trigger("cartCheckout_retrieveCitiesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.normalize = function(e) {
        return e.country_id = e.country ? e.country.id : null,
        e.state_id = e.state ? e.state.id : null,
        e.city_id = e.city ? e.city.id : null,
        e
    }
    ,
...
angular.module("siteBuilder.public").controller("cart.coupons", ["$scope", "$rootScope", "$cart", function(e, t, n) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        r.then(function(n) {
            e.trigger("cartCoupons_submitSucceed", n),
            e.progress = !1,
            e.reset(),
            t.$broadcast("cart.refresh")
        }),
        r.catch(function(t) {
            e.trigger("cartCoupons_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.removeCoupon = function(r) {
        ...
        e.progress = !0,
        i.then(function(n) {
            e.trigger("cartCoupons_removeSucceed", n),
            e.progress = !1,
            t.$broadcast("cart.refresh")
        }),
        i.catch(function(t) {
            e.trigger("cartCoupons_removeFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("cart", ["$scope", "$rootScope", "$cart", function(e, t, n) {
    e.retrieve = function() {
        if (!t.cartBusy) {
            t.cartBusy = !0,
            t.$broadcast("cart.loading", !0),
            e.trigger("cart_retrieve");
            var r = n.get({
                update: /^\/site\/cart/gi.test(window.location.pathname)
            });
            r.then(function(n) {
                e.trigger("cart_retrieveSucceed", n),
                t.$broadcast("cart.update", n.data.cart),
                t.$broadcast("cart.loading", !1),
                t.cartBusy = !1
            }),
            r.catch(function(n) {
                e.trigger("cart_retrieveFailed", n),
                e.error(n),
                t.$broadcast("cart.loading", !1),
                t.cartBusy = !1
            })
    ...
    e.removeItem = function(t) {
        ...
        t.progress = !0,
        r.then(function(t) {
            e.trigger("cart_removeSucceed", t),
            e.retrieve()
        }),
        r.catch(function(n) {
            e.trigger("cart_removeFailed", n),
            e.error(n),
            t.progress = !1,
            e.retrieve()
        })
    ...
    e.update = function(t) {
        ...
        t.progress = !0,
        r.then(function(t) {
            e.trigger("cart_updateSucceed", t),
            e.retrieve()
        }),
        r.catch(function(n) {
            e.trigger("cart_updateFailed", n),
            e.error(n),
            t.progress = !1,
            e.retrieve()
        })
...
angular.module("siteBuilder.public").controller("cart.payment", ["$scope", "$cart", "$user", "$window", "$analytics", "$timeout", function(e, t, n, r, i, o) {
    ...
    e.retrieve = function() {
        e.ensure(!0),
        e.loading++,
        e.trigger("cartPayment_retrieve", e.model);
        var n = t.getDetails(e.model.token);
        n.then(function(t) {
            e.trigger("cartPayment_retrieveSucceed", t),
            e.model = angular.extend({}, e.model, t.data.details),
            e.loading--,
            e.ready = !0,
            e.anonymouse = e.model.status && e.model.anonymouse,
            e.paid = e.model.status && e.model.status.indexOf("paid") > -1,
            e.downloadable = e.model.status && e.model.status.indexOf("downloadable") > -1,
            e.model.shipping_id = e.model.shipping_class ? e.model.shipping_class.id : null
        }),
        n.catch(function(t) {
            e.trigger("cartPayment_retrieveFailed", t),
            e.error(t),
            e.loading--
        })
    }
    ...
    e.retrieveShippings = function() {
        e.loading++,
        e.trigger("cartPayment_retrieveShippings");
        var n = t.getShippings(e.model.token);
        n.then(function(t) {
            e.trigger("cartPayment_retrieveShippingsSucceed", t),
            e.shippings = t.data.shippings,
            e.loading--
        }),
        n.catch(function(t) {
            e.trigger("cartPayment_retrieveShippingsFailed", t),
            e.error(t),
            e.loading--
        })
    }
    ...
    e.retrieveGateways = function() {
        e.loading++,
        e.trigger("cartPayment_retrieveGateways");
        var n = t.getGateways();
        n.then(function(t) {
            e.trigger("cartPayment_retrieveGatewaysSucceed", t),
            e.accounts = t.data.gateways,
            e.loading--
        }),
        n.catch(function(t) {
            e.trigger("cartPayment_retrieveGatewaysFailed", t),
            e.error(t),
            e.loading--
        })
    }
    ...
    e.retrieveOnlineGateways = function() {
        e.loading++,
        e.trigger("cartPayment_retrieveOnlineGateways");
        var n = t.getOnlineGateways();
        n.then(function(t) {
            e.trigger("cartPayment_retrieveOnlineGatewaysSucceed", t),
            e.gateways = t.data.gateways,
            e.loading--
        }),
        n.catch(function(t) {
            e.trigger("cartPayment_retrieveOnlineGatewaysFailed", t),
            e.error(t),
            e.loading--
        })
    }
    ...
    e.retrieveUser = function() {
        e.loading++,
        e.trigger("cartPayment_retrieveUser");
        var t = n.get();
        t.then(function(t) {
            e.trigger("cartPayment_retrieveUserSucceed", t),
            e.user = t.data.user,
            e.loading--
        }),
        t.catch(function(t) {
            e.trigger("cartPayment_retrieveUserFailed", t),
            e.loading--
        })
    }
    ,
    e.map = function() {
        ...
        return void 0 != t.gateway_id && (t.gateway_id = t.gateway_id.id),
        t
    }
    ,
    e.shipping = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("cartPayment_shippingSucceed", t),
            e.progress = !1,
            angular.extend(e.model, t.data.details)
        }),
        r.catch(function(t) {
            e.trigger("cartPayment_shippingFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        i.then(function(t) {
            e.trigger("cartPayment_submitSucceed", t),
            e.progress = !1,
            e.succeed = t.data,
            !1 === e.succeed.paid && e.retrieve(),
            null != t.data.redirect && (r.location = t.data.redirect)
        }),
        i.catch(function(t) {
            e.trigger("cartPayment_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.$watch("model.mode", function() {
        e.model.gateway_id = null,
        e.dynamicForm.$setPristine(),
        e.validation = null,
        e.gateways && 1 == e.gateways.length && o(function() {
...
angular.module("siteBuilder.public").controller("contact", ["$scope", "$submissions", "$analytics", function(e, t, n) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("contact_submitSucceed", t),
            n.contact(e.model.subject),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data
        }),
        r.catch(function(t) {
            e.trigger("contact_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("formbuilder", ["$scope", "$submissions", "$window", "$analytics", function(e, t, n, r) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        i.then(function(t) {
            e.trigger("formbuilder_submitSucceed", t),
            r.submitForm(),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data,
            null != t.data.redirect && (n.location = t.data.redirect)
        }),
        i.catch(function(t) {
            e.trigger("formbuilder_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("post.commenting", ["$scope", "$element", "$blog", "$analytics", function(e, t, n, r) {
    ...
    ,
    e.reply = function(n) {
        e.trigger("postCommenting_reply", n),
        e.model.parent_id = n,
        e.dynamicForm.$setDirty(),
        t.find("form :input:visible:first").focus()
    }
    ,
    e.focusComment = function() {
        e.trigger("postCommenting_focus", e.model.parent_id),
        angular.element("#comment-" + e.model.parent_id).stop().attr("tabindex", 1).focus().removeAttr("tabindex").fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150)
    }
    ,
    e.submit = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("postCommenting_submitSucceed", t),
            r.postCommenting(),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data
        ...
        t.catch(function(t) {
            e.trigger("postCommenting_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("post.comments.rating", ["$scope", "$blog", "$analytics", function(e, t, n) {
    ...
    e.like = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("postCommentsLike_submitSucceed", t),
            n.postCommentsLike(),
            e.progress = !1,
            angular.extend(e, t.data)
        }),
        r.catch(function(t) {
            e.trigger("postCommentsLike_submitFailed", t),
            e.progress = !1
        })
    }
    ,
    e.dislike = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("postCommentsDislike_submitSucceed", t),
            n.postCommentsDislike(),
            e.progress = !1,
            angular.extend(e, t.data)
        }),
        r.catch(function(t) {
            e.trigger("postCommentsDislike_submitFailed", t),
            e.progress = !1
        })
    }
}
...
angular.module("siteBuilder.public").controller("post.rating", ["$scope", "$blog", "$analytics", function(e, t, n) {
    ...
    e.submit = function(r) {
        ...
        i.then(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("postRating_submitSucceed", t),
            n.postRating(),
            e.progress = !1,
            e.succeed = t.data,
            angular.extend(e.model, t.data),
            e.model.default_rate = t.data.rate
        }),
        i.catch(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("postRating_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("product.commenting", ["$scope", "$element", "$store", "$analytics", function(e, t, n, r) {
    ...
    ,
    e.reply = function(n) {
        e.trigger("productCommenting_reply", n),
        e.model.parent_id = n,
        e.dynamicForm.$setDirty(),
        t.find("form :input:visible:first").focus()
    }
    ,
    e.focusComment = function() {
        e.trigger("productCommenting_focus", e.model.parent_id),
        angular.element("#comment-" + e.model.parent_id).stop().attr("tabindex", 1).focus().removeAttr("tabindex").fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150)
    }
    ,
    e.submit = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("productCommenting_submitSucceed", t),
            r.productCommenting(),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data
        ...
        t.catch(function(t) {
            e.trigger("productCommenting_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("product.comments.rating", ["$scope", "$store", "$analytics", function(e, t, n) {
    ...
    e.like = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("productCommentsLike_submitSucceed", t),
            n.productCommentsLike(),
            e.progress = !1,
            angular.extend(e, t.data)
        }),
        r.catch(function(t) {
            e.trigger("productCommentsLike_submitFailed", t),
            e.progress = !1
        })
    }
    ,
    e.dislike = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("productCommentsDislike_submitSucceed", t),
            n.productCommentsDislike(),
            e.progress = !1,
            angular.extend(e, t.data)
        }),
        r.catch(function(t) {
            e.trigger("productCommentsDislike_submitFailed", t),
            e.progress = !1
        })
    }
}
...
angular.module("siteBuilder.public").controller("product.rating", ["$scope", "$store", "$analytics", function(e, t, n) {
    ...
    e.submit = function(r) {
        ...
        i.then(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("productRating_submitSucceed", t),
            n.productRating(),
            e.progress = !1,
            e.succeed = t.data,
            angular.extend(e.model, t.data),
        ...
        i.catch(function(t) {
            t.data && e.toast(t.data.description),
            e.trigger("productRating_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("quickview", ["$scope", "$rootScope", "$store", "$cart", "$window", "$analytics", function(e, t, n, r, i, o) {
    e.loading = e.progress = e.succeed = e.failed = !1,
    e.model = {},
    e.found = function() {
        return null != e.model.id
    }
    ...
    ,
    e.select = function(t) {
        e.trigger("quickview_select", t),
        angular.extend(e.model, t)
    }
    ,
    e.$on("$quickview", function(t, r) {
        angular.extend(e, r),
        e.trigger("quickview_retrieve", e.id),
        e.succeed = e.failed = !1,
        e.dynamicForm.$setPristine(),
        e.validation = null;
        ...
        a.then(function(t) {
            ...
            n.inquiry ? i.location = n.url : (e.trigger("quickview_retrieveSucceed", t),
            o.productQuickView(e.id),
            e.loading = !1,
            e.model = {
                attributes: {},
                quantity: 1,
        ...
        a.catch(function(t) {
            e.trigger("quickview_retrieveFailed", t),
            e.error(t),
            e.loading = !1
        })
    }),
    e.submit = function() {
        if (e.dynamicForm.$invalid)
            ...
            e.progress = !0,
            n.then(function(n) {
                e.trigger("quickview_addToCartSucceed", n),
                o.addToCart(),
                e.progress = !1,
                e.succeed = n.data,
                e.callback ? i.location = e.callback : t.$broadcast("cart.refresh")
            }),
            n.catch(function(t) {
                e.trigger("quickview_addToCartFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
...
angular.module("siteBuilder.public").controller("recoverypass.confirm", ["$scope", "$rootScope", "$user", function(e, t, n) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("recoveryPass_confirmSucceed", t),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data
        }),
        t.catch(function(t) {
            e.trigger("recoveryPass_confirmFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("recoverypass", ["$scope", "$rootScope", "$user", "$analytics", function(e, t, n, r) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        i.then(function(n) {
            e.trigger("recoveryPass_submitSucceed", n),
            r.recoveryPassword(e.model.contact),
            e.progress = !1,
            e.reset(),
            e.succeed = n.data,
            t.recoveryStep2 = !0
        ...
        i.catch(function(t) {
            e.trigger("recoveryPass_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("search", ["$scope", "$search", "$analytics", "$element", function(e, t, n, r) {
    ...
    e.submit = function() {
        if (e.query) {
            ...
            e.loading = !0,
            o.then(function(t) {
                e.trigger("search_submitSucceed", t),
                n.search(e.query),
                e.items = t.data.result,
                e.loading = !1
            }),
            o.catch(function(t) {
                e.trigger("search_submitFailed", t),
                e.loading = !1
            })
        } else
            e.items = null
...
angular.module("siteBuilder.public").controller("signin", ["$scope", "$rootScope", "$user", "$window", "$analytics", function(e, t, n, r, i) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        o.then(function(n) {
            e.trigger("signin_submitSucceed", n),
            i.signin(e.model.username),
            e.progress = !1,
            e.reset(),
            e.succeed = n.data,
            t.$broadcast("users.signin", n),
            null != n.data.redirect && (r.location = n.data.redirect)
        }),
        o.catch(function(t) {
            e.trigger("signin_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("signup", ["$scope", "$user", "$user.documents", "$mapping", "$window", "$analytics", function(e, t, n, r, i, o) {
    ...
    e.submit = function() {
        if (!e.signedup || !e.upload()) {
            ...
            e.progress = !0,
            n.then(function(t) {
                e.trigger("signup_submitSucceed", t),
                o.signup(e.model.name),
                e.progress = !1,
                e.signedup = !0,
                e.upload() || (e.reset(),
                e.succeed = t.data,
            ...
            n.catch(function(t) {
                e.trigger("signup_submitFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.retrieveCountries = function() {
        ...
        var t = r.getCountries();
        t.then(function(t) {
            e.trigger("signup_retrieveCountriesSucceed", t),
            e.countries = t.data.countries
        }),
        t.catch(function(t) {
            e.trigger("signup_retrieveCountriesFailed", t),
            e.error(t)
        })
    }
    ,
    e.$watch("model.country_id", function(t) {
        if (e.trigger("signup_retrieveStates", t),
        null != t) {
            e.states = e.cities = void 0;
            var n = r.getStates(t);
            e.progress = !0,
            n.then(function(t) {
                e.trigger("signup_retrieveStatesSucceed", t),
                e.progress = !1,
                e.states = t.data.states
            }),
            n.catch(function(t) {
                e.trigger("signup_retrieveStatesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.$watch("model.state_id", function(t) {
        if (e.trigger("signup_retrieveCities", t),
        null != t) {
            e.cities = void 0;
            var n = r.getCities(t);
            e.progress = !0,
            n.then(function(t) {
                e.trigger("signup_retrieveCitiesSucceed", t),
                e.progress = !1,
                e.cities = t.data.cities
            }),
            n.catch(function(t) {
                e.trigger("signup_retrieveCitiesFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
...
angular.module("siteBuilder.public").controller("startup", ["$scope", "$websites", "$user", "$analytics", "$window", function(e, t, n, r, i) {
    ...
    e.validate = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("startup_validateSucceed", t),
            e.progress = !1,
            e.step = t.data.mobile ? "signin" : "signup",
            e.reset(e.model),
            "signin" == e.step && (e.model.username = e.model.mobile)
        }),
        t.catch(function(t) {
            e.trigger("startup_validateFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.signup = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("startup_signupSucceed", t),
            r.signup(e.model.mobile),
            e.progress = !1,
            e.step = "create",
            e.reset(e.model)
        }),
        t.catch(function(t) {
            e.trigger("startup_signupFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.signin = function() {
        ...
        e.progress = !0,
        t.then(function(t) {
            e.trigger("startup_signinSucceed", t),
            r.signin(e.model.mobile),
            e.progress = !1,
            e.step = "create",
            e.reset(e.model)
        }),
        t.catch(function(t) {
            e.trigger("startup_signinFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
    ...
    e.create = function() {
        ...
        e.progress = !0,
        o.then(function(t) {
            e.trigger("startup_createSucceed", t),
            r.createWebsite(n.category, t.data.sub_domain),
            e.progress = !1,
            e.succeed = t.data,
            i.location = t.data.signin_url,
            e.step = "succeed"
        }),
        o.catch(function(t) {
            e.trigger("startup_createFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("store", ["$scope", "$element", "$window", "$http", "$httpParamSerializer", "$compile", "$timeout", function(e, t, n, r, i, o, a) {
    ...
    e.loading = !1,
    e.collect = function() {
        for (var t in e.model = {},
        e.ensure(!0),
        e.filters)
            e.filters[t] = !0 !== e.filters[t] && e.filters[t];
        if (e.model.filter) {
    ...
    e.params = function(t) {
        var n = angular.copy(e.model);
        return n.page = void 0,
        n.sorting = n.sorting || void 0,
        n.query = n.query || void 0,
        n.available = !!n.available || void 0,
        t && (n.available = n.filter = n.query = void 0),
        n
    }
    ,
    e.search = function() {
        ...
        Object.keys(e.filters.collection).forEach(function(n) {
            e.filters.collection[n].forEach(function(i, o, a) {
                a.indexOf(i) == o && !0 === e.filters["filter" + i] && (r.length > 0 && t != n && r.push("&"),
                r.push(i),
                t = n)
            })
        }),
        e.model.filter = r.join(",") || void 0,
        n.history.pushState(null, null, n.location.pathname + "?" + i(e.params())),
        e.load()
    }
    ,
    e.sort = function(t) {
    ...
    e.load = function() {
        ...
        e.loading = !0,
        t.then(function(t) {
            e.trigger("store_loadSucceed", t),
            e.loading = !1,
            e.$broadcast("ajax-content", t.data)
        }),
        t.catch(function(t) {
            e.trigger("store_loadFailed", t),
            e.error(t),
            e.loading = !1
        })
    }
    ,
    e.remove = function() {
        n.history.pushState(null, null, n.location.pathname + "?" + i(e.params(!0))),
        e.load()
    }
    ,
    e.addFilter = function(t, n) {
        var r = t.toString()
          , i = n.toString();
        e.filters.collection[i] = void 0 != e.filters.collection[i] ? e.filters.collection[i] : [],
        e.filters.collection[i].push(r)
    }
    ,
    e.collect()
}
...
angular.module("siteBuilder.public").controller("subscription", ["$scope", "$submissions", "$analytics", function(e, t, n) {
    ...
    e.submit = function() {
        ...
        e.progress = !0,
        r.then(function(t) {
            e.trigger("subscription_submitSucceed", t),
            n.subscribe(),
            e.progress = !1,
            e.reset(),
            e.succeed = t.data
        ...
        r.catch(function(t) {
            e.trigger("subscription_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("templates", ["$scope", "$websites", "$user", "$packages", "$whois", "$analytics", "$window", function(e, t, n, r, i, o, a) {
    ...
    e.selectCategory = function(t, n) {
        e.trigger("templates_selectCategory", t),
        e.model.category = t,
        n && n.preventDefault()
    }
    ,
    e.select = function(t, n) {
        e.trigger("templates_select", t),
        e.model.template_id = t,
        e.categories = n ? n.split(",") : null,
        e.model.category || e.categories && 1 == e.categories.length && (e.model.category = e.categories[0])
    }
    ,
    e.retrievePackage = function() {
        null != e.model.package && (e.loading = !0,
        r.getSingle(e.model.package).then(function(t) {
            e.package = t.data.package,
            e.loading = !1
        }))
    }
    ,
    e.authenticate = function() {
        ...
        return e.progress = !0,
        t.then(function(t) {
            e.trigger("templates_authenticateSucceed", t),
            o[e.model.mode](e.model.mobile || e.model.username),
            e.progress = !1,
            e.authenticated = !0,
            e.submit()
        }),
        t.catch(function(t) {
            e.trigger("templates_authenticateFailed", t),
            e.error(t),
            e.progress = !1
        }),
        !0
    ...
    e.submit = function() {
        if (e.authenticated || !e.authenticate()) {
            var n = angular.copy(e.model);
            null != n.package && (n.package_id = parseInt(n.package) || void 0,
            delete n.package),
            e.trigger("templates_submit", n);
            var r = t.create(n);
            e.progress = !0,
            r.then(function(t) {
                e.trigger("templates_submitSucceed", t),
                o.createWebsite(n.category, t.data.sub_domain),
                e.progress = !1,
                e.succeed = t.data
            }),
            r.catch(function(t) {
                e.trigger("templates_submitFailed", t),
                e.error(t),
                e.progress = !1
            })
        }
    ...
    e.whois = function(t) {
        ...
        e.progress = !0,
        r.then(function(n) {
            e.trigger("templates_whoisSucceed", n),
            o.whois(),
            e.progress = !1,
            angular.extend(e.domain, n.data),
            t && (e.domain.fullname = e.domain.name,
            e.domain.name = e.domain.name.replace(t, ""))
        }),
        r.catch(function(t) {
            e.trigger("templates_whoisFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
...
angular.module("siteBuilder.public").controller("whois", ["$scope", "$whois", "$analytics", function(e, t, n) {
    ...
    ,
    e.submit = function(r) {
        e.trigger("whois_submit", e.model),
        e.succeed = null;
        ...
        e.progress = !0,
        o.then(function(t) {
            e.trigger("whois_submitSucceed", t),
            n.whois(),
            e.progress = !1,
            e.succeed = t.data
        }),
        o.catch(function(t) {
            e.trigger("whois_submitFailed", t),
            e.error(t),
            e.progress = !1
        })
    }
