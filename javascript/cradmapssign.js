!function a(b, c, d) {
    ...
    1: [function(a, b) {
        function c(a, b, c) {
            ...
            if ("undefined" == typeof window.XMLHttpRequest)
                return b(Error("Browser not supported"));
    ...
    3: [function(a, b) {
        !function(a, c, d) {
            ...
            "object" == typeof b && "object" == typeof b.exports ? b.exports = f : "function" == typeof define && define.amd && define(f),
            ...
            f.Util = {
                ...
                bind: function(a, b) {
                    ...
                    if (a.bind)
                        return a.bind.apply(a, c.call(arguments, 1));
                ...
                stamp: function(a) {
                    return a._leaflet_id = a._leaflet_id || ++f.Util.lastId,
                    a._leaflet_id
                },
                lastId: 0,
                throttle: function(a, b, c) {
                    ...
                    ,
                    f = function() {
                        d ? e = arguments : (a.apply(c, arguments),
                        setTimeout(g, b),
                        d = !0)
                    }
                },
            ...
            function() {
                ...
                f.Util.requestAnimFrame = function(b, d, g) {
                    return g && e === c ? (b.call(d),
                    void 0) : e.call(a, f.bind(b, d))
                }
                ,
            ...
            f.Class.extend = function(a) {
                ...
                b.prototype = d;
                for (var e in this)
                    this.hasOwnProperty(e) && "prototype" !== e && (b[e] = this[e]);
                return a.statics && (f.extend(b, a.statics),
                delete a.statics),
                a.includes && (f.Util.extend.apply(null, [d].concat(a.includes)),
                delete a.includes),
                d.options && (a.options = f.Util.extend(f.Util.create(d.options), a.options)),
                f.extend(d, a),
                d._initHooks = [],
            ...
            f.Class.include = function(a) {
                return f.extend(this.prototype, a),
                this
            }
            ,
            f.Class.mergeOptions = function(a) {
                return f.extend(this.prototype.options, a),
                this
            }
            ,
            ...
            f.Evented = f.Class.extend({
                    ...
                    if (this._events && (e = this._events[a])) {
                        ...
                        e)
                            ...
                            h = e.length; h > g; g++) {
                                var i = e[g];
                                if (i.ctx === c && i.fn === b)
                                    return i.fn = f.Util.falseFn,
                                    this._firingCount && (this._events[a] = e = e.slice()),
                                    e.splice(g, 1),
                                    void 0
                            }
                    }
                ...
                fire: function(a, b, c) {
                    ...
                    return c && this._propagateEvent(d),
                    this
                },
                ...
                addEventParent: function(a) {
                    ...
                    this._eventParents[f.stamp(a)] = a,
                    this
                },
                removeEventParent: function(a) {
                    return this._eventParents && delete this._eventParents[f.stamp(a)],
                    this
                },
                _propagateEvent: function(a) {
                    for (var b in this._eventParents)
                        this._eventParents[b].fire(a.type, f.extend({
                            layer: a.target
                        }, a), !0)
                }
            });
            ...
            f.Bounds.prototype = {
                ...
                contains: function(a) {
                    var b, c;
                    return a = "number" == typeof a[0] || a instanceof f.Point ? f.point(a) : f.bounds(a),
            ...
            f.Transformation.prototype = {
                ...
                untransform: function(a, b) {
                    return b = b || 1,
                    new f.Point((a.x / b - this._b) / this._a,(a.y / b - this._d) / this._c)
                }
            },
            f.DomUtil = {
                get: function(a) {
                ...
                addClass: function(a, b) {
                    if (a.classList !== d)
                        for (var c = f.Util.splitWords(b), e = 0, g = c.length; g > e; e++)
                            a.classList.add(c[e]);
                ...
                setPosition: function(a, b) {
                    a._leaflet_pos = b,
                    f.Browser.any3d ? f.DomUtil.setTransform(a, b) : (a.style.left = b.x + "px",
                    a.style.top = b.y + "px")
                },
            ...
            function() {
                ...
                if (f.DomUtil.TRANSITION_END = "webkitTransition" === b || "OTransition" === b ? b + "End" : "transitionend",
                "onselectstart"in c)
                    ...
                    f.DomUtil.disableTextSelection = function() {
                        if (d) {
                            ...
                            this._userSelect = a[d],
                            a[d] = "none"
                        }
                    }
                    ,
                    f.DomUtil.enableTextSelection = function() {
                        d && (c.documentElement.style[d] = this._userSelect,
                ...
                f.DomUtil.preventOutline = function(b) {
                    for (; -1 === b.tabIndex; )
                        b = b.parentNode;
                    b && b.style && (f.DomUtil.restoreOutline(),
                    this._outlineElement = b,
                    this._outlineStyle = b.style.outline,
                    b.style.outline = "none",
                    f.DomEvent.on(a, "keydown", f.DomUtil.restoreOutline, this))
                }
                ,
                f.DomUtil.restoreOutline = function() {
                    ...
                    f.DomEvent.off(a, "keydown", f.DomUtil.restoreOutline, this))
                }
            }(),
            ...
            f.LatLngBounds.prototype = {
                extend: function(a) {
                    var b, c, d = this._southWest, e = this._northEast;
                    if (a instanceof f.LatLng)
                        b = a,
                        c = a;
                    else {
                        if (!(a instanceof f.LatLngBounds))
                            return a ? this.extend(f.latLng(a) || f.latLngBounds(a)) : this;
                        if (b = a._southWest,
                        c = a._northEast,
                        !b || !c)
                            return this
                    }
                    return d || e ? (d.lat = Math.min(b.lat, d.lat),
                    d.lng = Math.min(b.lng, d.lng),
                    e.lat = Math.max(c.lat, e.lat),
                    e.lng = Math.max(c.lng, e.lng)) : (this._southWest = new f.LatLng(b.lat,b.lng),
                    this._northEast = new f.LatLng(c.lat,c.lng)),
                    this
                },
                pad: function(a) {
                ...
                contains: function(a) {
                    ...
                    var b, c, d = this._southWest, e = this._northEast;
                    return a instanceof f.LatLngBounds ? (b = a.getSouthWest(),
            ...
            f.Map = f.Evented.extend({
                ...
                initialize: function(a, b) {
                    ...
                    b.zoom !== d && (this._zoom = this._limitZoom(b.zoom)),
                    b.center && b.zoom !== d && this.setView(f.latLng(b.center), b.zoom, {
                        reset: !0
                    }),
                    this._handlers = [],
                    this._layers = {},
                    ...
                    this._sizeChanged = !0,
                    this.callInitHooks(),
                    this._zoomAnimated = f.DomUtil.TRANSITION && f.Browser.any3d && !f.Browser.mobileOpera && this.options.zoomAnimation,
                    this._zoomAnimated && (this._createAnimProxy(),
                    f.DomEvent.on(this._proxy, f.DomUtil.TRANSITION_END, this._catchTransitionEnd, this)),
                    this._addLayers(this.options.layers)
                },
                setView: function(a, b, c) {
                    if (b = b === d ? this._zoom : this._limitZoom(b),
                ...
                zoomIn: function(a, b) {
                    return a = a || (f.Browser.any3d ? this.options.zoomDelta : 1),
                ...
                panBy: function(a, b) {
                    if (a = f.point(a).round(),
                    b = b || {},
                    !a.x && !a.y)
                        return this.fire("moveend");
                    if (b.animate !== !0 && !this.getSize().contains(a))
                        return this._resetView(this.unproject(this.project(this.getCenter()).add(a)), this.getZoom()),
                        this;
                    if (this._panAnim || (this._panAnim = new f.PosAnimation,
                    this._panAnim.on({
                ...
                flyTo: function(a, b, c) {
                    ...
                    function m() {
                        var c = (Date.now() - x) / z
                          , d = l(c) * y;
                        1 >= c ? (this._flyToFrame = f.Util.requestAnimFrame(m, this),
                        this._move(this.unproject(n.add(o.subtract(n).multiplyBy(k(d) / t)), q), this.getScaleZoom(r / j(d), q), {
                            flyTo: !0
                        })) : this._move(a, b)._moveEnd(!0)
                    }
                    if (c = c || {},
                    c.animate === !1 || !f.Browser.any3d)
                        return this.setView(a, b, c);
                    this._stop();
                ...
                panInsideBounds: function(a, b) {
                    ...
                    return c.equals(d) || this.panTo(d, b),
                ...
                _handleGeolocationResponse: function(a) {
                    ...
                    for (var j in a.coords)
                        "number" == typeof a.coords[j] && (i[j] = a.coords[j]);
                ...
                getBoundsZoom: function(a, b, c) {
                    ...
                    return d = this.getScaleZoom(m, d),
                    l && (d = Math.round(d / (l / 100)) * (l / 100),
                    d = b ? Math.ceil(d / l) * l : Math.floor(d / l) * l),
                    Math.max(e, Math.min(g, d))
                },
                getSize: function() {
                    return (!this._size || this._sizeChanged) && (this._size = new f.Point(this._container.clientWidth,this._container.clientHeight),
                    this._sizeChanged = !1),
                    this._size.clone()
                },
                ...
                project: function(a, b) {
                    return b = b === d ? this._zoom : b,
                    this.options.crs.latLngToPoint(f.latLng(a), b)
                },
                unproject: function(a, b) {
                    return b = b === d ? this._zoom : b,
                    this.options.crs.pointToLatLng(f.point(a), b)
                },
                ...
                _initContainer: function(a) {
                    ...
                    f.DomEvent.addListener(b, "scroll", this._onScroll, this),
                    this._containerId = f.Util.stamp(b)
                },
                _initLayout: function() {
                    var a = this._container;
                    this._fadeAnimated = this.options.fadeAnimation && f.Browser.any3d,
                    f.DomUtil.addClass(a, "leaflet-container" + (f.Browser.touch ? " leaflet-touch" : "") + (f.Browser.retina ? " leaflet-retina" : "") + (f.Browser.ielt9 ? " leaflet-oldie" : "") + (f.Browser.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
                ...
                _initPanes: function() {
                    ...
                    this.options.markerZoomAnimation || (f.DomUtil.addClass(a.markerPane, "leaflet-zoom-hide"),
                    f.DomUtil.addClass(a.shadowPane, "leaflet-zoom-hide"))
                },
                _resetView: function(a, b) {
                    ...
                    var d = this._zoom !== b;
                    this._moveStart(d)._move(a, b)._moveEnd(d),
                    this.fire("viewreset"),
                    c && this.fire("load")
                },
                ...
                _stop: function() {
                    return f.Util.cancelAnimFrame(this._flyToFrame),
                ...
                _initEvents: function(b) {
                    if (f.DomEvent) {
                        this._targets = {},
                        this._targets[f.stamp(this._container)] = this;
                        var c = b ? "off" : "on";
                        f.DomEvent[c](this._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this._handleDOMEvent, this),
                        this.options.trackResize && f.DomEvent[c](a, "resize", this._onResize, this),
                        f.Browser.any3d && this.options.transform3DLimit && this[c]("moveend", this._onMoveEnd)
                    }
                },
                _onResize: function() {
                ...
                _findEventTargets: function(a, b) {
                    for (var c, d = [], e = "mouseout" === b || "mouseover" === b, g = a.target || a.srcElement, h = !1; g; ) {
                        if (c = this._targets[f.stamp(g)],
                        c && ("click" === b || "preclick" === b) && !a._simulated && this._draggableMoved(c)) {
                            h = !0;
                            break
                        }
                        if (c && c.listens(b, !0)) {
                            if (e && !f.DomEvent._isExternalTarget(g, a))
                                break;
                            if (d.push(c),
                            e)
                                break
                    ...
                    return d.length || h || e || !f.DomEvent._isExternalTarget(g, a) || (d = [this]),
                    d
                },
                _handleDOMEvent: function(a) {
                    if (this._loaded && !f.DomEvent._skipped(a)) {
                        var b = "keypress" === a.type && 13 === a.keyCode ? "click" : a.type;
                        "mousedown" === b && f.DomUtil.preventOutline(a.target || a.srcElement),
                ...
                _fireDOMEvent: function(a, b, c) {
                    if ("click" === a.type) {
                        ...
                        d.type = "preclick",
                        this._fireDOMEvent(d, d.type, c)
                    }
                    if (!a._stopped && (c = (c || []).concat(this._findEventTargets(a, b)),
                    c.length)) {
                        var e = c[0];
                        ...
                        if ("keypress" !== a.type) {
                            ...
                            g.containerPoint = h ? this.latLngToContainerPoint(e.getLatLng()) : this.mouseEventToContainerPoint(a),
                            g.layerPoint = this.containerPointToLayerPoint(g.containerPoint),
                            g.latlng = h ? e.getLatLng() : this.layerPointToLatLng(g.layerPoint)
                        }
                        for (var i = 0; i < c.length; i++)
                            if (c[i].fire(b, g, !0),
                            g.originalEvent._stopped || c[i].options.nonBubblingEvents && -1 !== f.Util.indexOf(c[i].options.nonBubblingEvents, b))
                                return
                    }
                },
                ...
                _createAnimProxy: function() {
                    ...
                    this.on("zoomanim", function(b) {
                        var c = f.DomUtil.TRANSFORM
                          , d = a.style[c];
                        f.DomUtil.setTransform(a, this.project(b.center, b.zoom), this.getZoomScale(b.zoom, 1)),
                ...
                _onZoomTransitionEnd: function() {
                    this._animatingZoom && (f.DomUtil.removeClass(this._mapPane, "leaflet-zoom-anim"),
            ...
            f.Layer = f.Evented.extend({
                ...
                addInteractiveTarget: function(a) {
                    return this._map._targets[f.stamp(a)] = this,
                    this
                },
                removeInteractiveTarget: function(a) {
                    return delete this._map._targets[f.stamp(a)],
                    this
                },
            ...
            f.Map.include({
                ...
                _addZoomLimit: function(a) {
                    (isNaN(a.options.maxZoom) || !isNaN(a.options.minZoom)) && (this._zoomBoundLayers[f.stamp(a)] = a,
                ...
                _updateZoomLevels: function() {
                    ...
                    for (var e in this._zoomBoundLayers) {
                        ...
                        a = f.minZoom === d ? a : Math.min(a, f.minZoom),
                        b = f.maxZoom === d ? b : Math.max(b, f.maxZoom)
                    }
                    this._layersMaxZoom = b === -1 / 0 ? d : b,
                    this._layersMinZoom = 1 / 0 === a ? d : a,
                    c !== this._getZoomSpan() && this.fire("zoomlevelschange"),
                    this.options.maxZoom === d && this._layersMaxZoom && this.getZoom() > this._layersMaxZoom && this.setZoom(this._layersMaxZoom),
                    this.options.minZoom === d && this._layersMinZoom && this.getZoom() < this._layersMinZoom && this.setZoom(this._layersMinZoom)
                }
            });
            ...
            f.DomEvent = {
                ...
                _on: function(b, c, d, e) {
                    ...
                    return f.Browser.pointer && 0 === c.indexOf("touch") ? this.addPointerListener(b, c, i, g) : f.Browser.touch && "dblclick" === c && this.addDoubleTapListener ? this.addDoubleTapListener(b, i, g) : "addEventListener"in b ? "mousewheel" === c ? b.addEventListener("onwheel"in b ? "wheel" : "mousewheel", i, !1) : "mouseenter" === c || "mouseleave" === c ? (i = function(c) {
                        c = c || a.event,
                        f.DomEvent._isExternalTarget(b, c) && j(c)
                    }
                    ,
                    ...
                    b.addEventListener(c, i, !1)) : "attachEvent"in b && b.attachEvent("on" + c, i),
                    b[h] = b[h] || {},
                    b[h][g] = i,
                    this
                },
                ...
                disableClickPropagation: function(a) {
                    ...
                    return f.DomEvent.on(a, f.Draggable.START.join(" "), b),
                    f.DomEvent.on(a, {
                ...
                _filterClick: function(a, b) {
                    ...
                    return d && d > 100 && 500 > d || a.target._simulatedClick && !a._simulated ? (f.DomEvent.stop(a),
                    void 0) : (f.DomEvent._lastClick = c,
                    b(a),
                    void 0)
                }
            },
            ...
            f.PosAnimation = f.Evented.extend({
                ...
                _step: function(a) {
                    ...
                    c > b ? this._runFrame(this._easeOut(b / c), a) : (this._runFrame(1),
                    this._complete())
                },
                _runFrame: function(a, b) {
                    var c = this._startPos.add(this._offset.multiplyBy(a));
                    b && c._round(),
                    f.DomUtil.setPosition(this._el, c),
                    this.fire("step")
                },
                _complete: function() {
            ...
            f.Projection.Mercator = {
                ...
                project: function(a) {
                    ...
                    return d = -c * Math.log(Math.max(i, 1e-10)),
                    new f.Point(a.lng * b * c,d)
                },
                unproject: function(a) {
                    for (var b, c = 180 / Math.PI, d = this.R, e = this.R_MINOR / d, g = Math.sqrt(1 - e * e), h = Math.exp(-a.y / d), i = Math.PI / 2 - 2 * Math.atan(h), j = 0, k = .1; 15 > j && Math.abs(k) > 1e-7; j++)
                        b = g * Math.sin(i),
                        b = Math.pow((1 - b) / (1 + b), g / 2),
                        k = Math.PI / 2 - 2 * Math.atan(h * b) - i,
                        i += k;
            ...
            f.GridLayer = f.Layer.extend({
                ...
                bringToFront: function() {
                    return this._map && (f.DomUtil.toFront(this._container),
                    this._setAutoZIndex(Math.max)),
                    this
                },
                bringToBack: function() {
                    return this._map && (f.DomUtil.toBack(this._container),
                ...
                getEvents: function() {
                    ...
                    return this.options.updateWhenIdle || (this._onMove || (this._onMove = f.Util.throttle(this._onMoveEnd, this.options.updateInterval, this)),
                    a.move = this._onMove),
                ...
                _setAutoZIndex: function(a) {
                    for (var b, c = this.getPane().children, d = -a(-1 / 0, 1 / 0), e = 0, f = c.length; f > e; e++)
                        b = c[e].style.zIndex,
                        c[e] !== this._container && b && (d = a(d, +b));
                    isFinite(d) && (this.options.zIndex = d + a(-1, 1),
                    this._updateZIndex())
                },
                    ...
                    if (this._map && !f.Browser.ielt9) {
                        ...
                        for (var d in this._tiles) {
                            ...
                            if (e.current && e.loaded) {
                                ...
                                f.DomUtil.setOpacity(e.el, g),
                                1 > g ? b = !0 : (e.active && (c = !0),
                                e.active = !0)
                            }
                        }
                        c && !this._noPrune && this._pruneTiles(),
                        b && (f.Util.cancelAnimFrame(this._fadeFrame),
                        this._fadeFrame = f.Util.requestAnimFrame(this._updateOpacity, this))
                    }
                },
                _initContainer: function() {
                    this._container || (this._container = f.DomUtil.create("div", "leaflet-layer " + (this.options.className || "")),
                    this._updateZIndex(),
                ...
                _updateLevels: function() {
                    ...
                    for (var c in this._levels)
                        this._levels[c].el.children.length || c === a ? this._levels[c].el.style.zIndex = b - Math.abs(a - c) : (f.DomUtil.remove(this._levels[c].el),
                        this._removeTilesAtZoom(c),
                        delete this._levels[c]);
                    var e = this._levels[a]
                      , g = this._map;
                    return e || (e = this._levels[a] = {},
                    e.el = f.DomUtil.create("div", "leaflet-tile-container leaflet-zoom-animated", this._container),
                    e.el.style.zIndex = b,
                    e.origin = g.project(g.unproject(g.getPixelOrigin()), a).round(),
                    e.zoom = a,
                    this._setZoomTransform(e, g.getCenter(), g.getZoom()),
                    f.Util.falseFn(e.el.offsetWidth)),
                    this._level = e,
                    e
                },
                ...
                _invalidateAll: function() {
                    for (var a in this._levels)
                        f.DomUtil.remove(this._levels[a].el),
                ...
                _retainParent: function(a, b, c, d) {
                    ...
                    var j = this._tileCoordsToKey(i)
                      , k = this._tiles[j];
                    return k && k.active ? (k.retain = !0,
                    !0) : (k && k.loaded && (k.retain = !0),
                    h > d ? this._retainParent(e, g, h, d) : !1)
                },
                    ...
                    for (var e = 2 * a; 2 * a + 2 > e; e++)
                        for (var g = 2 * b; 2 * b + 2 > g; g++) {
                            ...
                            var i = this._tileCoordsToKey(h)
                              , j = this._tiles[i];
                            j && j.active ? j.retain = !0 : (j && j.loaded && (j.retain = !0),
                            d > c + 1 && this._retainChildren(e, g, c + 1, d))
                        }
                },
                ...
                _setZoomTransforms: function(a, b) {
                    for (var c in this._levels)
                        this._setZoomTransform(this._levels[c], a, b)
                },
                ...
                _resetGrid: function() {
                    ...
                    this._wrapX = b.wrapLng && !this.options.noWrap && [Math.floor(a.project([0, b.wrapLng[0]], d).x / c.x), Math.ceil(a.project([0, b.wrapLng[1]], d).x / c.y)],
                ...
                _tileCoordsToBounds: function(a) {
                    var b = this._map
                      ...
                      , g = b.unproject(d, a.z)
                      , h = b.unproject(e, a.z);
                    return this.options.noWrap || (g = b.wrapLatLng(g),
                    h = b.wrapLatLng(h)),
                    new f.LatLngBounds(g,h)
                },
                ...
                _initTile: function(a) {
                    ...
                    a.onselectstart = f.Util.falseFn,
                    a.onmousemove = f.Util.falseFn,
                    f.Browser.ielt9 && this.options.opacity < 1 && f.DomUtil.setOpacity(a, this.options.opacity),
                    f.Browser.android && !f.Browser.android23 && (a.style.WebkitBackfaceVisibility = "hidden")
                },
                _addTile: function(a, b) {
                    ...
                    this._initTile(e),
                    this.createTile.length < 2 && f.Util.requestAnimFrame(f.bind(this._tileReady, this, a, null, e)),
                    f.DomUtil.setPosition(e, c),
                    this._tiles[d] = {
                        el: e,
                        coords: a,
                        current: !0
                ...
                _tileReady: function(a, b, c) {
                    if (this._map) {
                        ...
                        c = this._tiles[d],
                        c && (c.loaded = +new Date,
                        this._map._fadeAnimated ? (f.DomUtil.setOpacity(c.el, 0),
                        f.Util.cancelAnimFrame(this._fadeFrame),
                        this._fadeFrame = f.Util.requestAnimFrame(this._updateOpacity, this)) : (c.active = !0,
                        this._pruneTiles()),
                        b || (f.DomUtil.addClass(c.el, "leaflet-tile-loaded"),
                        this.fire("tileload", {
                            tile: c.el,
                            coords: a
                        })),
                        ...
                        this.fire("load"),
                        f.Browser.ielt9 || !this._map._fadeAnimated ? f.Util.requestAnimFrame(this._pruneTiles, this) : setTimeout(f.bind(this._pruneTiles, this), 250)))
                    }
                },
            ...
            f.TileLayer = f.GridLayer.extend({
                ...
                initialize: function(a, b) {
                    ...
                    f.Browser.android || this.on("tileunload", this._onTileRemove)
                },
                setUrl: function(a, b) {
                    return this._url = a,
                    b || this.redraw(),
                ...
                createTile: function(a, b) {
                    ...
                    return f.DomEvent.on(d, "load", f.bind(this._tileOnLoad, this, b, d)),
                    f.DomEvent.on(d, "error", f.bind(this._tileOnError, this, b, d)),
                ...
                _abortLoading: function() {
                    var a, b;
                    for (a in this._tiles)
                        this._tiles[a].coords.z !== this._tileZoom && (b = this._tiles[a].el,
                        b.onload = f.Util.falseFn,
                        b.onerror = f.Util.falseFn,
                        b.complete || (b.src = f.Util.emptyImageUrl,
                        f.DomUtil.remove(b)))
                }
            }),
            ...
            f.TileLayer.WMS = f.TileLayer.extend({
                ...
                initialize: function(a, b) {
                    ...
                    for (var d in b)
                        d in this.options || (c[d] = b[d]);
                    b = f.setOptions(this, b),
                    c.width = c.height = b.tileSize * (b.detectRetina && f.Browser.retina ? 2 : 1),
                    this.wmsParams = c
                },
                onAdd: function(a) {
                ...
                setParams: function(a, b) {
                    return f.extend(this.wmsParams, a),
                    b || this.redraw(),
                    this
                }
            }),
            ...
            f.ImageOverlay = f.Layer.extend({
                ...
                onAdd: function() {
                    ...
                    this.options.opacity < 1 && this._updateOpacity()),
                    this.options.interactive && (f.DomUtil.addClass(this._image, "leaflet-interactive"),
                ...
                bringToFront: function() {
                    return this._map && f.DomUtil.toFront(this._image),
                    this
                },
                bringToBack: function() {
                    return this._map && f.DomUtil.toBack(this._image),
                    this
                },
                setUrl: function(a) {
                    return this._url = a,
                ...
                _initImage: function() {
                    ...
                    a.onselectstart = f.Util.falseFn,
                    a.onmousemove = f.Util.falseFn,
                    a.onload = f.bind(this.fire, this, "load"),
            ...
            f.Icon = f.Class.extend({
                ...
                _createIcon: function(a, b) {
                    ...
                    return this._setIconStyles(d, a),
                    d
                },
                _setIconStyles: function(a, b) {
                    ...
                    g && (a.style.marginLeft = -g.x + "px",
                    a.style.marginTop = -g.y + "px"),
                    e && (a.style.width = e.x + "px",
                    a.style.height = e.y + "px")
                },
                _createImg: function(a, b) {
                    return b = b || c.createElement("img"),
                    b.src = a,
                    b
                },
            ...
            f.Icon.Default = f.Icon.extend({
                ...
                _getIconUrl: function(a) {
                    return f.Icon.Default.imagePath || (f.Icon.Default.imagePath = this._detectIconPath()),
                    (this.options.imagePath || f.Icon.Default.imagePath) + f.Icon.prototype._getIconUrl.call(this, a)
                },
                _detectIconPath: function() {
                    ...
                    return c.body.removeChild(a),
                    0 === b.indexOf("url") ? b.replace(/^url\([\"\']?/, "").replace(/marker-icon\.png[\"\']?\)$/, "") : ""
                }
            }),
            f.Marker = f.Layer.extend({
                ...
                setLatLng: function(a) {
                    var b = this._latlng;
                    return this._latlng = f.latLng(a),
                    this.update(),
                    this.fire("move", {
                        oldLatLng: b,
                        latlng: this._latlng
                ...
                _initIcon: function() {
                    ...
                    g = !0),
                    e && f.DomUtil.addClass(e, b),
                    this._shadow = e,
                    a.opacity < 1 && this._updateOpacity(),
                    d && this.getPane().appendChild(this._icon),
                    this._initInteraction(),
                    e && g && this.getPane("shadowPane").appendChild(this._shadow)
                },
                ...
                _removeShadow: function() {
                    this._shadow && f.DomUtil.remove(this._shadow),
                    this._shadow = null
                },
                _setPos: function(a) {
                ...
                _initInteraction: function() {
                    if (this.options.interactive && (f.DomUtil.addClass(this._icon, "leaflet-interactive"),
                    this.addInteractiveTarget(this._icon),
                    f.Handler.MarkerDrag)) {
                        var a = this.options.draggable;
                        this.dragging && (a = this.dragging.enabled(),
                        this.dragging.disable()),
                        this.dragging = new f.Handler.MarkerDrag(this),
                ...
                _updateOpacity: function() {
                    ...
                    f.DomUtil.setOpacity(this._icon, a),
                    this._shadow && f.DomUtil.setOpacity(this._shadow, a)
                },
            ...
            f.DivIcon = f.Icon.extend({
                ...
                createIcon: function(a) {
                    var b = a && "DIV" === a.tagName ? a : c.createElement("div")
                      , d = this.options;
                    if (b.innerHTML = d.html !== !1 ? d.html : "",
                    d.bgPos) {
            ...
            f.DivOverlay = f.Layer.extend({
                ...
                onAdd: function(a) {
                    ...
                    a._fadeAnimated && f.DomUtil.setOpacity(this._container, 0),
                    clearTimeout(this._removeTimeout),
                    this.getPane().appendChild(this._container),
                    this.update(),
                    a._fadeAnimated && f.DomUtil.setOpacity(this._container, 1),
                    this.bringToFront()
                },
                onRemove: function(a) {
                    a._fadeAnimated ? (f.DomUtil.setOpacity(this._container, 0),
                    this._removeTimeout = setTimeout(f.bind(f.DomUtil.remove, f.DomUtil, this._container), 200)) : f.DomUtil.remove(this._container)
                },
                getLatLng: function() {
                    return this._latlng
                },
                ...
                _updatePosition: function() {
                    if (this._map) {
                        ...
                        this._container.style.bottom = d + "px",
            ...
            f.Popup = f.DivOverlay.extend({
                ...
                onAdd: function(a) {
                    f.DivOverlay.prototype.onAdd.call(this, a),
                    a.fire("popupopen", {
                        popup: this
                    }),
                    ...
                    this._source instanceof f.Path || this._source.on("preclick", f.DomEvent.stopPropagation))
                },
                onRemove: function(a) {
                    f.DivOverlay.prototype.onRemove.call(this, a),
                    a.fire("popupclose", {
                        popup: this
                    }),
                    ...
                    this._source instanceof f.Path || this._source.off("preclick", f.DomEvent.stopPropagation))
                },
                getEvents: function() {
                ...
                _initLayout: function() {
                    ...
                    this._contentNode = f.DomUtil.create("div", a + "-content", d),
                    f.DomEvent.disableClickPropagation(d).disableScrollPropagation(this._contentNode).on(d, "contextmenu", f.DomEvent.stopPropagation),
                ...
                _updateLayout: function() {
                    ...
                    e && d > e ? (b.height = e + "px",
                    f.DomUtil.addClass(a, g)) : f.DomUtil.removeClass(a, g),
                ...
                _adjustPan: function() {
                    if (!(!this.options.autoPan || this._map._panAnim && this._map._panAnim._inProgress)) {
                        ...
                        var g = a.layerPointToContainerPoint(e)
                          ...
                          , l = 0
                          , m = 0;
                        g.x + d + j.x > k.x && (l = g.x + d - k.x + j.x),
                        g.x - l - i.x < 0 && (l = g.x - i.x),
                        g.y + c + j.y > k.y && (m = g.y + c - k.y + j.y),
                        g.y - m - i.y < 0 && (m = g.y - i.y),
            ...
            f.Map.include({
                openPopup: function(a, b, c) {
                    return a instanceof f.Popup || (a = new f.Popup(c).setContent(a)),
                    b && a.setLatLng(b),
            ...
            f.Layer.include({
                bindPopup: function(a, b) {
                    return a instanceof f.Popup ? (f.setOptions(a, b),
                    this._popup = a,
                    a._source = this) : ((!this._popup || b) && (this._popup = new f.Popup(b,this)),
                ...
                openPopup: function(a, b) {
                    if (a instanceof f.Layer || (b = a,
                    a = this),
                    a instanceof f.FeatureGroup)
                        for (var c in this._layers) {
                            a = this._layers[c];
                            break
                        }
                ...
                _openPopup: function(a) {
                    ...
                    if (this._popup && this._map)
                        return f.DomEvent.stop(a),
                        b instanceof f.Path ? (this.openPopup(a.layer || a.target, a.latlng),
                        void 0) : (this._map.hasLayer(this._popup) && this._popup._source === b ? this.closePopup() : this.openPopup(b, a.latlng),
                        void 0)
                },
            ...
            f.Tooltip = f.DivOverlay.extend({
                ...
                getEvents: function() {
                    var a = f.DivOverlay.prototype.getEvents.call(this);
                    return f.Browser.touch && !this.options.permanent && (a.preclick = this._close),
                    a
                },
                _close: function() {
                ...
                _setPosition: function(a) {
                    var b = this._map
                      ...
                      , k = this._getAnchor();
                    "top" === g ? a = a.add(f.point(-h / 2 + j.x, -i + j.y + k.y, !0)) : "bottom" === g ? a = a.subtract(f.point(h / 2 - j.x, -j.y, !0)) : "center" === g ? a = a.subtract(f.point(h / 2 + j.x, i / 2 - k.y + j.y, !0)) : "right" === g || "auto" === g && e.x < d.x ? (g = "right",
                    a = a.add(f.point(j.x + k.x, k.y - i / 2 + j.y, !0))) : (g = "left",
                    a = a.subtract(f.point(h + k.x - j.x, i / 2 - k.y - j.y, !0))),
                    f.DomUtil.removeClass(c, "leaflet-tooltip-right"),
                    f.DomUtil.removeClass(c, "leaflet-tooltip-left"),
                    f.DomUtil.removeClass(c, "leaflet-tooltip-top"),
                    f.DomUtil.removeClass(c, "leaflet-tooltip-bottom"),
                    f.DomUtil.addClass(c, "leaflet-tooltip-" + g),
                ...
                setOpacity: function(a) {
                    ...
                    this._container && f.DomUtil.setOpacity(this._container, a)
                },
                _animateZoom: function(a) {
                    var b = this._map._latLngToNewLayerPoint(this._latlng, a.zoom, a.center);
                    this._setPosition(b)
            ...
            f.Map.include({
                openTooltip: function(a, b, c) {
                    return a instanceof f.Tooltip || (a = new f.Tooltip(c).setContent(a)),
                    b && a.setLatLng(b),
            ...
            f.Layer.include({
                bindTooltip: function(a, b) {
                    return a instanceof f.Tooltip ? (f.setOptions(a, b),
                    this._tooltip = a,
                    a._source = this) : ((!this._tooltip || b) && (this._tooltip = f.tooltip(b, this)),
                ...
                _initTooltipInteractions: function(a) {
                    if (a || !this._tooltipHandlersAdded) {
                        ...
                        f.Browser.touch && (c.click = this._openTooltip)),
                        this[b](c),
                ...
                openTooltip: function(a, b) {
                    ...
                    this._tooltip.options.interactive && this._tooltip._container && (f.DomUtil.addClass(this._tooltip._container, "leaflet-clickable"),
                    this.addInteractiveTarget(this._tooltip._container))),
                    this
                },
                closeTooltip: function() {
                    return this._tooltip && (this._tooltip._close(),
                    this._tooltip.options.interactive && this._tooltip._container && (f.DomUtil.removeClass(this._tooltip._container, "leaflet-clickable"),
            ...
            f.Renderer = f.Layer.extend({
                ...
                onAdd: function() {
                    ...
                    this._zoomAnimated && f.DomUtil.addClass(this._container, "leaflet-zoom-animated")),
                    this.getPane().appendChild(this._container),
                    this._update(),
                ...
                _update: function() {
                    ...
                    this._bounds = new f.Bounds(c,c.add(b.multiplyBy(1 + 2 * a)).round()),
            ...
            f.Map.include({
                getRenderer: function(a) {
                    ...
                    return b || (b = this._renderer = this.options.preferCanvas && f.canvas() || f.svg()),
                    this.hasLayer(b) || this.addLayer(b),
                    b
                },
                _getPaneRenderer: function(a) {
                    if ("overlayPane" === a || a === d)
                        return !1;
            ...
            f.LineUtil = {
                ...
                _simplifyDP: function(a, b) {
                    var c = a.length
                      ...
                      , f = new e(c);
                    f[0] = f[c - 1] = 1,
                    this._simplifyDPStep(a, f, b, 0, c - 1);
                    var g, h = [];
                    for (g = 0; c > g; g++)
                        f[g] && h.push(a[g]);
                    return h
                ...
                clipSegment: function(a, b, c, d, e) {
                    ...
                    for (this._lastCode = j; ; ) {
                        ...
                        if (i & j)
                            return !1;
                        f = i || j,
                        g = this._getEdgeIntersection(a, b, f, c, e),
                ...
                _getEdgeIntersection: function(a, b, c, d, e) {
                    ...
                    return 8 & c ? (g = a.x + i * (l.y - a.y) / j,
                    h = l.y) : 4 & c ? (g = a.x + i * (k.y - a.y) / j,
                    h = k.y) : 2 & c ? (g = l.x,
                    h = a.y + j * (l.x - a.x) / i) : 1 & c && (g = k.x,
                    h = a.y + j * (k.x - a.x) / i),
                    new f.Point(g,h,e)
                },
                ...
                _sqClosestPointOnSegment: function(a, b, c, d) {
                    var e, g = b.x, h = b.y, i = c.x - g, j = c.y - h, k = i * i + j * j;
                    return k > 0 && (e = ((a.x - g) * i + (a.y - h) * j) / k,
                    e > 1 ? (g = c.x,
                    h = c.y) : e > 0 && (g += i * e,
                    h += j * e)),
                    i = a.x - g,
                    j = a.y - h,
                    d ? i * i + j * j : new f.Point(g,h)
                }
            },
            f.Polyline = f.Path.extend({
                ...
                closestLayerPoint: function(a) {
                    ...
                    return e && (e.distance = Math.sqrt(d)),
                    e
                },
                getCenter: function() {
                    if (!this._map)
                    ...
                    for (a = 0,
                    b = 0; i - 1 > a; a++)
                        b += h[a].distanceTo(h[a + 1]) / 2;
                    if (0 === b)
                        return this._map.layerPointToLatLng(h[0]);
                    for (a = 0,
                    d = 0; i - 1 > a; a++)
                        if (e = h[a],
                        f = h[a + 1],
                        ...
                        d > b)
                            return g = (d - b) / c,
                            this._map.layerPointToLatLng([f.x - g * (f.x - e.x), f.y - g * (f.y - e.y)])
                },
                getBounds: function() {
                    return this._bounds
                },
                ...
                _setLatLngs: function(a) {
                    this._bounds = new f.LatLngBounds,
                ...
                _convertLatLngs: function(a) {
                    for (var b = [], c = f.Polyline._flat(a), d = 0, e = a.length; e > d; d++)
                        c ? (b[d] = f.latLng(a[d]),
                ...
                _projectLatlngs: function(a, b, c) {
                    var d, e, g = a[0]instanceof f.LatLng, h = a.length;
                    if (g) {
                        for (e = [],
                        d = 0; h > d; d++)
                            e[d] = this._map.latLngToLayerPoint(a[d]),
                            c.extend(e[d]);
                        b.push(e)
                    } else
                        for (d = 0; h > d; d++)
                            this._projectLatlngs(a[d], b, c)
                },
                _clipPoints: function() {
                    ...
                    this._pxBounds && this._pxBounds.intersects(a)) {
                        if (this.options.noClip)
                            return this._parts = this._rings,
                            void 0;
                        var b, c, d, e, g, h, i, j = this._parts;
                        for (b = 0,
                        d = 0,
                        e = this._rings.length; e > b; b++)
                            for (i = this._rings[b],
                            c = 0,
                            g = i.length; g - 1 > c; c++)
                                h = f.LineUtil.clipSegment(i[c], i[c + 1], a, c, !0),
                                h && (j[d] = j[d] || [],
                                j[d].push(h[0]),
                                (h[1] !== i[c + 1] || c === g - 2) && (j[d].push(h[1]),
                                d++))
                    }
                },
                _simplifyPoints: function() {
                    for (var a = this._parts, b = this.options.smoothFactor, c = 0, d = a.length; d > c; c++)
                        a[c] = f.LineUtil.simplify(a[c], b)
                },
                _update: function() {
            ...
            ,
            f.PolyUtil = {},
            f.PolyUtil.clipPolygon = function(a, b, c) {
                var d, e, g, h, i, j, k, l, m, n = [1, 4, 2, 8], o = f.LineUtil;
                for (e = 0,
                k = a.length; k > e; e++)
                    a[e]._code = o._getBitCode(a[e], b);
                for (h = 0; 4 > h; h++) {
                    for (l = n[h],
                    d = [],
                    e = 0,
                    ...
                    g = k - 1; k > e; g = e++)
                        i = a[e],
                        j = a[g],
                        i._code & l ? j._code & l || (m = o._getEdgeIntersection(j, i, l, b, c),
                        m._code = o._getBitCode(m, b),
                        d.push(m)) : (j._code & l && (m = o._getEdgeIntersection(j, i, l, b, c),
                        m._code = o._getBitCode(m, b),
                        d.push(m)),
                        d.push(i));
                    a = d
            ...
            f.Polygon = f.Polyline.extend({
                ...
                getCenter: function() {
                    ...
                    b = k - 1; k > a; b = a++)
                        ...
                        h += (c.y + d.y) * e,
                        f += 3 * e;
                    return i = 0 === f ? j[0] : [g / f, h / f],
                    this._map.layerPointToLatLng(i)
                },
                _convertLatLngs: function(a) {
                    var b = f.Polyline.prototype._convertLatLngs.call(this, a)
                      , c = b.length;
                    return c >= 2 && b[0]instanceof f.LatLng && b[0].equals(b[c - 1]) && b.pop(),
                    b
                },
                _setLatLngs: function(a) {
                    f.Polyline.prototype._setLatLngs.call(this, a),
                    f.Polyline._flat(this._latlngs) && (this._latlngs = [this._latlngs])
                },
                _defaultShape: function() {
                ...
                _clipPoints: function() {
                    var a = this._renderer._bounds
                      ...
                      , c = new f.Point(b,b);
                    if (a = new f.Bounds(a.min.subtract(c),a.max.add(c)),
                    this._parts = [],
                    this._pxBounds && this._pxBounds.intersects(a)) {
                        if (this.options.noClip)
                            return this._parts = this._rings,
                            void 0;
                        for (var d, e = 0, g = this._rings.length; g > e; e++)
                            d = f.PolyUtil.clipPolygon(this._rings[e], a, !0),
            ...
            f.CircleMarker = f.Path.extend({
                ...
                setStyle: function(a) {
                    ...
                    return f.Path.prototype.setStyle.call(this, a),
                    this.setRadius(b),
                    this
                },
                _project: function() {
            ...
            f.Circle = f.CircleMarker.extend({
                ...
                _project: function() {
                    ...
                    if (d.distance === f.CRS.Earth.distance) {
                        ...
                        (isNaN(l) || 0 === l) && (l = g / Math.cos(Math.PI / 180 * b)),
                        this._point = j.subtract(c.getPixelOrigin()),
                        ...
                        this._radius = this._point.x - c.latLngToLayerPoint(m).x
                    }
                    this._updateBounds()
                }
            }),
            ...
            f.SVG = f.Renderer.extend({
                ...
                _initContainer: function() {
                    this._container = f.SVG.create("svg"),
                    this._container.setAttribute("pointer-events", "none"),
                    this._rootGroup = f.SVG.create("g"),
                ...
                _update: function() {
                    if (!this._map._animatingZoom || !this._bounds) {
                        ...
                        c.setAttribute("width", b.x),
                        c.setAttribute("height", b.y)),
                        f.DomUtil.setPosition(c, a.min),
                ...
                _initPath: function(a) {
                    ...
                    a.options.className && f.DomUtil.addClass(b, a.options.className),
                    a.options.interactive && f.DomUtil.addClass(b, "leaflet-interactive"),
                    this._updateStyle(a),
                    this._layers[f.stamp(a)] = a
                },
                _addPath: function(a) {
                ...
                _removePath: function(a) {
                    f.DomUtil.remove(a._path),
                    a.removeInteractiveTarget(a._path),
                    delete this._layers[f.stamp(a)]
                },
                ...
                _updateStyle: function(a) {
                    var b = a._path
                      , c = a.options;
                    b && (c.stroke ? (b.setAttribute("stroke", c.color),
                    ...
                    c.fill ? (b.setAttribute("fill", c.fillColor || c.color),
            ...
            f.Browser.svg = !(!c.createElementNS || !f.SVG.create("svg").createSVGRect),
            f.svg = function(a) {
            ...
            f.SVG.include(f.Browser.vml ? {
                ...
                _update: function() {
                    this._map._animatingZoom || (f.Renderer.prototype._update.call(this),
                    this.fire("update"))
                },
                _initPath: function(a) {
                    var b = a._container = f.SVG.create("shape");
                    f.DomUtil.addClass(b, "leaflet-vml-shape " + (this.options.className || "")),
                    b.coordsize = "1 1",
                    a._path = f.SVG.create("path"),
                ...
                _updateStyle: function(a) {
                    ...
                    e.stroked = !!d.stroke,
                    e.filled = !!d.fill,
                    d.stroke ? (b || (b = a._stroke = f.SVG.create("stroke")),
                    e.appendChild(b),
                    b.weight = d.weight + "px",
                    b.color = d.color,
                    b.opacity = d.opacity,
                    b.dashStyle = d.dashArray ? f.Util.isArray(d.dashArray) ? d.dashArray.join(" ") : d.dashArray.replace(/( *, *)/g, " ") : "",
                    b.endcap = d.lineCap.replace("butt", "flat"),
                    b.joinstyle = d.lineJoin) : b && (e.removeChild(b),
                    a._stroke = null),
                    d.fill ? (c || (c = a._fill = f.SVG.create("fill")),
                    e.appendChild(c),
                    c.color = d.fillColor || d.color,
                    c.opacity = d.fillOpacity) : c && (e.removeChild(c),
                    a._fill = null)
                },
                _updateCircle: function(a) {
            ...
            f.Canvas = f.Renderer.extend({
                onAdd: function() {
                    f.Renderer.prototype.onAdd.call(this),
                    this._draw()
                },
                _initContainer: function() {
                    var a = this._container = c.createElement("canvas");
                    f.DomEvent.on(a, "mousemove", f.Util.throttle(this._onMouseMove, 32, this), this).on(a, "click dblclick mousedown mouseup contextmenu", this._onClick, this).on(a, "mouseout", this._handleMouseOut, this),
                ...
                _update: function() {
                    if (!this._map._animatingZoom || !this._bounds) {
                        ...
                        f.DomUtil.setPosition(b, a.min),
                        b.width = d * c.x,
                        b.height = d * c.y,
                        b.style.width = c.x + "px",
                        b.style.height = c.y + "px",
                        f.Browser.retina && this._ctx.scale(2, 2),
                ...
                _extendRedrawBounds: function(a) {
                    ...
                    this._redrawBounds = this._redrawBounds || new f.Bounds,
                ...
                _draw: function() {
                    ...
                    b) {
                        var c = b.getSize();
                        this._ctx.beginPath(),
                        this._ctx.rect(b.min.x, b.min.y, c.x, c.y),
                        this._ctx.clip()
                    }
                    this._drawing = !0;
                ...
                _updatePoly: function(a, b) {
                    if (this._drawing) {
                        ...
                        if (h) {
                            for (this._drawnLayers[a._leaflet_id] = a,
                            i.beginPath(),
                            i.setLineDash && i.setLineDash(a.options && a.options._dashArray || []),
                            c = 0; h > c; c++) {
                                for (d = 0,
                                e = g[c].length; e > d; d++)
                                    f = g[c][d],
                ...
                _fillStroke: function(a, b) {
                    var c = b.options;
                    c.fill && (a.globalAlpha = c.fillOpacity,
                    a.fillStyle = c.fillColor || c.color,
                    a.fill(c.fillRule || "evenodd")),
                    c.stroke && 0 !== c.weight && (a.globalAlpha = c.opacity,
                ...
                _handleMouseOut: function(a) {
                    ...
                    b && (f.DomUtil.removeClass(this._container, "leaflet-interactive"),
                ...
                _handleMouseHover: function(a, b) {
                    for (var c, d, e = this._drawFirst; e; e = e.next)
                        c = e.layer,
                        c.options.interactive && c._containsPoint(b) && (d = c);
                    d !== this._hoveredLayer && (this._handleMouseOut(a),
                    d && (f.DomUtil.addClass(this._container, "leaflet-interactive"),
            ...
            f.Polyline.prototype._containsPoint = function(a, b) {
                ...
                g = this._parts.length; g > c; c++)
                    ...
                    h = i.length,
                    e = h - 1; h > d; e = d++)
                        if ((b || 0 !== d) && f.LineUtil.pointToSegmentDistance(a, i[e], i[d]) <= j)
                            return !0;
                return !1
            }
            ,
            ...
            f.GeoJSON = f.FeatureGroup.extend({
                ...
                addData: function(a) {
                    ...
                    return h ? (h.feature = f.GeoJSON.asFeature(a),
                    h.defaultOptions = h.options,
                    this.resetStyle(h),
                    g.onEachFeature && g.onEachFeature(a, h),
                    this.addLayer(h)) : this
                },
                resetStyle: function(a) {
                    return a.options = f.Util.extend({}, a.defaultOptions),
            ...
            f.extend(f.GeoJSON, {
                geometryToLayer: function(a, b) {
                    var c, d, e, g, h = "Feature" === a.type ? a.geometry : a, i = h ? h.coordinates : null, j = [], k = b && b.pointToLayer, l = b && b.coordsToLatLng || this.coordsToLatLng;
                    if (!i && !h)
                        return null;
                    switch (h.type) {
                    case "Point":
                        return c = l(i),
                        k ? k(a, c) : new f.Marker(c);
                    case "MultiPoint":
                        for (e = 0,
                        g = i.length; g > e; e++)
                            c = l(i[e]),
                            j.push(k ? k(a, c) : new f.Marker(c));
                        return new f.FeatureGroup(j);
                    case "LineString":
                    case "MultiLineString":
                        return d = this.coordsToLatLngs(i, "LineString" === h.type ? 0 : 1, l),
                        new f.Polyline(d,b);
                    case "Polygon":
                    case "MultiPolygon":
                        return d = this.coordsToLatLngs(i, "Polygon" === h.type ? 1 : 2, l),
                        new f.Polygon(d,b);
                    case "GeometryCollection":
                        for (e = 0,
                        g = h.geometries.length; g > e; e++) {
                ...
                coordsToLatLngs: function(a, b, c) {
                    for (var d, e = [], f = 0, g = a.length; g > f; f++)
                        d = b ? this.coordsToLatLngs(a[f], b - 1, c) : (c || this.coordsToLatLng)(a[f]),
                        e.push(d);
                    return e
                },
                ...
                latLngsToCoords: function(a, b, c) {
                    for (var d = [], e = 0, g = a.length; g > e; e++)
                        d.push(b ? f.GeoJSON.latLngsToCoords(a[e], b - 1, c) : f.GeoJSON.latLngToCoords(a[e]));
                    return !b && c && d.push(d[0]),
                    d
                },
            ...
            f.Marker.include(i),
            f.Circle.include(i),
            f.CircleMarker.include(i),
            f.Polyline.prototype.toGeoJSON = function() {
            ...
            f.Draggable = f.Evented.extend({
                ...
                enable: function() {
                    this._enabled || (f.DomEvent.on(this._dragStartTarget, f.Draggable.START.join(" "), this._onDown, this),
                    this._enabled = !0)
                },
                disable: function() {
                    this._enabled && (f.Draggable._dragging === this && this.finishDrag(),
                    f.DomEvent.off(this._dragStartTarget, f.Draggable.START.join(" "), this._onDown, this),
                    this._enabled = !1,
                    this._moved = !1)
                },
                _onDown: function(a) {
                    if (!a._simulated && this._enabled && (this._moved = !1,
                    !f.DomUtil.hasClass(this._element, "leaflet-zoom-anim") && !(f.Draggable._dragging || a.shiftKey || 1 !== a.which && 1 !== a.button && !a.touches || (f.Draggable._dragging = this,
                    this._preventOutline && f.DomUtil.preventOutline(this._element),
                    f.DomUtil.disableImageDrag(),
                    f.DomUtil.disableTextSelection(),
                    this._moving)))) {
                        this.fire("down");
                        var b = a.touches ? a.touches[0] : a;
                        this._startPoint = new f.Point(b.clientX,b.clientY),
                        f.DomEvent.on(c, f.Draggable.MOVE[a.type], this._onMove, this).on(c, f.Draggable.END[a.type], this._onUp, this)
                    }
                },
                _onMove: function(b) {
                    if (!b._simulated && this._enabled) {
                        ...
                        (g.x || g.y) && (Math.abs(g.x) + Math.abs(g.y) < this.options.clickTolerance || (f.DomEvent.preventDefault(b),
                        this._moved || (this.fire("dragstart"),
                        this._moved = !0,
                        this._startPos = f.DomUtil.getPosition(this._element).subtract(g),
                        f.DomUtil.addClass(c.body, "leaflet-dragging"),
                        this._lastTarget = b.target || b.srcElement,
                        ...
                        f.DomUtil.addClass(this._lastTarget, "leaflet-drag-target")),
                        this._newPos = this._startPos.add(g),
                        this._moving = !0,
                        f.Util.cancelAnimFrame(this._animRequest),
                        this._lastEvent = b,
                        this._animRequest = f.Util.requestAnimFrame(this._updatePosition, this, !0)))
                    }
                },
                _updatePosition: function() {
                    var a = {
                ...
                finishDrag: function() {
                    f.DomUtil.removeClass(c.body, "leaflet-dragging"),
                    this._lastTarget && (f.DomUtil.removeClass(this._lastTarget, "leaflet-drag-target"),
                    this._lastTarget = null);
                    for (var a in f.Draggable.MOVE)
                        f.DomEvent.off(c, f.Draggable.MOVE[a], this._onMove, this).off(c, f.Draggable.END[a], this._onUp, this);
            ...
            f.Map.Drag = f.Handler.extend({
                addHooks: function() {
                    ...
                    f.DomUtil.addClass(this._map._container, "leaflet-grab leaflet-touch-drag"),
                    this._draggable.enable(),
                    this._positions = [],
                    this._times = []
                },
                removeHooks: function() {
                    f.DomUtil.removeClass(this._map._container, "leaflet-grab"),
                    f.DomUtil.removeClass(this._map._container, "leaflet-touch-drag"),
                ...
                _onDragStart: function() {
                    ...
                    if (this._map.options.maxBounds && this._map.options.maxBoundsViscosity) {
                        ...
                        this._offsetLimit = f.bounds(this._map.latLngToContainerPoint(b.getNorthWest()).multiplyBy(-1), this._map.latLngToContainerPoint(b.getSouthEast()).multiplyBy(-1).add(this._map.getSize())),
                ...
                _onDrag: function(a) {
                    if (this._map.options.inertia) {
                        ...
                        this._times.push(b),
                        b - this._times[0] > 50 && (this._positions.shift(),
                        this._times.shift())
                    }
                ...
                _onDragEnd: function(a) {
                    ...
                    d)
                        ...
                        n.x || n.y ? (n = b._limitOffset(n, b.options.maxBounds),
                        f.Util.requestAnimFrame(function() {
                            b.panBy(n, {
                                duration: m,
                                easeLinearity: h,
            ...
            f.Map.ScrollWheelZoom = f.Handler.extend({
                ...
                _onWheelScroll: function(a) {
                    ...
                    this._timer = setTimeout(f.bind(this._performZoom, this), d),
                    f.DomEvent.stop(a)
                },
            ...
            f.extend(f.DomEvent, {
                ...
                addDoubleTapListener: function(a, b, c) {
                    function d(a) {
                        var b;
                        if (b = f.Browser.pointer ? f.DomEvent._pointersCount : a.touches.length,
                        !(b > 1)) {
                            var c = Date.now()
                              , d = c - (g || c);
                    ...
                    f.Browser.edge || a.addEventListener("dblclick", b, !1),
                    this
                },
                removeDoubleTapListener: function(a, b) {
                    var c = "_leaflet_"
                      ...
                      , g = a[c + "dblclick" + b];
                    return a.removeEventListener(this._touchstart, d, !1),
                    a.removeEventListener(this._touchend, e, !1),
                    f.Browser.edge || a.removeEventListener("dblclick", g, !1),
                    this
                }
            }),
            f.extend(f.DomEvent, {
                ...
                _addPointerStart: function(a, b, d) {
                    var e = f.bind(function(a) {
                        if ("mouse" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_MOUSE) {
                            if (!(this.TAG_WHITE_LIST.indexOf(a.target.tagName) < 0))
                                return;
                            f.DomEvent.preventDefault(a)
                        }
                        this._handlePointer(a, b)
                    }, this);
                    if (a["_leaflet_touchstart" + d] = e,
                    a.addEventListener(this.POINTER_DOWN, e, !1),
                    !this._pointerDocListener) {
                        var g = f.bind(this._globalPointerUp, this);
                        c.documentElement.addEventListener(this.POINTER_DOWN, f.bind(this._globalPointerDown, this), !0),
                        c.documentElement.addEventListener(this.POINTER_MOVE, f.bind(this._globalPointerMove, this), !0),
                        c.documentElement.addEventListener(this.POINTER_UP, g, !0),
                        c.documentElement.addEventListener(this.POINTER_CANCEL, g, !0),
                ...
                _addPointerMove: function(a, b, c) {
                    ...
                    a.addEventListener(this.POINTER_MOVE, d, !1)
                },
            ...
            f.Map.TouchZoom = f.Handler.extend({
                addHooks: function() {
                    f.DomUtil.addClass(this._map._container, "leaflet-touch-zoom"),
                    f.DomEvent.on(this._map._container, "touchstart", this._onTouchStart, this)
                },
                removeHooks: function() {
                    f.DomUtil.removeClass(this._map._container, "leaflet-touch-zoom"),
                ...
                _onTouchStart: function(a) {
                    ...
                    if (a.touches && 2 === a.touches.length && !b._animatingZoom && !this._zooming) {
                        ...
                        "center" !== b.options.touchZoom && (this._pinchStartLatLng = b.containerPointToLatLng(d.add(e)._divideBy(2))),
                        this._startDist = d.distanceTo(e),
                        this._startZoom = b.getZoom(),
                        this._moved = !1,
                        this._zooming = !0,
                        b._stop(),
                        f.DomEvent.on(c, "touchmove", this._onTouchMove, this).on(c, "touchend", this._onTouchEnd, this),
                        f.DomEvent.preventDefault(a)
                    }
                },
                _onTouchMove: function(a) {
                    if (a.touches && 2 === a.touches.length && this._zooming) {
                        ...
                        !b.options.bounceAtZoomLimits && (this._zoom < b.getMinZoom() && 1 > e || this._zoom > b.getMaxZoom() && e > 1) && (this._zoom = b._limitZoom(this._zoom)),
                        ...
                        this._animRequest = f.Util.requestAnimFrame(h, this, !0),
                        f.DomEvent.preventDefault(a)
                    }
                },
                _onTouchEnd: function() {
                    ...
                    f.Util.cancelAnimFrame(this._animRequest),
                    f.DomEvent.off(c, "touchmove", this._onTouchMove).off(c, "touchend", this._onTouchEnd),
            ...
            f.Map.Tap = f.Handler.extend({
                ...
                _onDown: function(a) {
                    if (a.touches) {
                        if (f.DomEvent.preventDefault(a),
                        this._fireClick = !0,
                        a.touches.length > 1)
                        ...
                        var b = a.touches[0]
                          , d = b.target;
                        this._startPos = this._newPos = new f.Point(b.clientX,b.clientY),
                        d.tagName && "a" === d.tagName.toLowerCase() && f.DomUtil.addClass(d, "leaflet-active"),
                ...
                _onUp: function(a) {
                    ...
                    this._fireClick && a && a.changedTouches) {
                        var b = a.changedTouches[0]
                          , d = b.target;
                        d && d.tagName && "a" === d.tagName.toLowerCase() && f.DomUtil.removeClass(d, "leaflet-active"),
                ...
                _onMove: function(a) {
                    ...
                    this._simulateEvent("mousemove", b)
                },
                _simulateEvent: function(b, d) {
                    var e = c.createEvent("MouseEvents");
                    e._simulated = !0,
                    d.target._simulatedClick = !0,
                    e.initMouseEvent(b, !0, !0, a, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null),
            ...
            f.Map.BoxZoom = f.Handler.extend({
                ...
                _onMouseDown: function(a) {
                    return !a.shiftKey || 1 !== a.which && 1 !== a.button ? !1 : (this._resetState(),
                    f.DomUtil.disableTextSelection(),
                    f.DomUtil.disableImageDrag(),
                ...
                _onMouseMove: function(a) {
                    ...
                    this._box = f.DomUtil.create("div", "leaflet-zoom-box", this._container),
                    f.DomUtil.addClass(this._container, "leaflet-crosshair"),
                    this._map.fire("boxzoomstart")),
                    this._point = this._map.mouseEventToContainerPoint(a);
                    var b = new f.Bounds(this._point,this._startPoint)
                      , c = b.getSize();
                    f.DomUtil.setPosition(this._box, b.min),
                    this._box.style.width = c.x + "px",
                    this._box.style.height = c.y + "px"
                },
                _finish: function() {
                    this._moved && (f.DomUtil.remove(this._box),
                    f.DomUtil.removeClass(this._container, "leaflet-crosshair")),
                    f.DomUtil.enableTextSelection(),
                    f.DomUtil.enableImageDrag(),
                    f.DomEvent.off(c, {
                        contextmenu: f.DomEvent.stop,
                ...
                _onMouseUp: function(a) {
                    if ((1 === a.which || 1 === a.button) && (this._finish(),
                    this._moved)) {
                    ...
                    if (!(a.altKey || a.ctrlKey || a.metaKey)) {
                        ...
                        if (c in this._panKeys) {
                            if (d._panAnim && d._panAnim._inProgress)
                                return;
                            b = this._panKeys[c],
                            a.shiftKey && (b = f.point(b).multiplyBy(3)),
                            d.panBy(b),
            ...
            f.Handler.MarkerDrag = f.Handler.extend({
                ...
                addHooks: function() {
                    ...
                    this._draggable || (this._draggable = new f.Draggable(a,a,!0)),
                    this._draggable.on({
                        dragstart: this._onDragStart,
                        drag: this._onDrag,
                        dragend: this._onDragEnd
                    }, this).enable(),
                    f.DomUtil.addClass(a, "leaflet-marker-draggable")
                },
                removeHooks: function() {
                    this._draggable.off({
                        dragstart: this._onDragStart,
                    ...
                    this._marker._icon && f.DomUtil.removeClass(this._marker._icon, "leaflet-marker-draggable")
                },
                moved: function() {
                    return this._draggable && this._draggable._moved
                },
            ...
            f.Control = f.Class.extend({
                ...
                addTo: function(a) {
                    ...
                    return f.DomUtil.addClass(b, "leaflet-control"),
                    -1 !== c.indexOf("bottom") ? d.insertBefore(b, d.firstChild) : d.appendChild(b),
                    this
                },
                remove: function() {
                    return this._map ? (f.DomUtil.remove(this._container),
            ...
            f.Control.Zoom = f.Control.extend({
                ...
                _createButton: function(a, b, c, d, e) {
                    ...
                    f.DomEvent.on(g, "mousedown dblclick", f.DomEvent.stopPropagation).on(g, "click", f.DomEvent.stop).on(g, "click", e, this).on(g, "click", this._refocusOnMap, this),
                    g
                },
                _updateDisabled: function() {
                    ...
                    (this._disabled || a._zoom === a.getMinZoom()) && f.DomUtil.addClass(this._zoomOutButton, b),
                    (this._disabled || a._zoom === a.getMaxZoom()) && f.DomUtil.addClass(this._zoomInButton, b)
                }
            }),
            f.Map.mergeOptions({
                zoomControl: !0
            ...
            f.Control.Attribution = f.Control.extend({
                ...
                onAdd: function(a) {
                    ...
                    f.DomEvent && f.DomEvent.disableClickPropagation(this._container);
            ...
            f.Control.Scale = f.Control.extend({
                ...
                onAdd: function(a) {
                    var b = "leaflet-control-scale"
                      ...
                      , d = this.options;
                    return this._addScales(d, b + "-line", c),
                ...
                _addScales: function(a, b, c) {
                    a.metric && (this._mScale = f.DomUtil.create("div", b, c)),
                    a.imperial && (this._iScale = f.DomUtil.create("div", b, c))
                },
                _update: function() {
                    var a = this._map
                      , b = a.getSize().y / 2
                ...
                _updateImperial: function(a) {
                    ...
                    this._updateScale(this._iScale, c + " mi", c / b)) : (d = this._getRoundNum(e),
                    this._updateScale(this._iScale, d + " ft", d / e))
                },
                _updateScale: function(a, b, c) {
                    a.style.width = Math.round(this.options.maxWidth * c) + "px",
                    a.innerHTML = b
                },
            ...
            f.Control.Layers = f.Control.extend({
                ...
                removeLayer: function(a) {
                    ...
                    return b && this._layers.splice(this._layers.indexOf(b), 1),
                    this._map ? this._update() : this
                },
                expand: function() {
                    ...
                    return a < this._form.clientHeight ? (f.DomUtil.addClass(this._form, "leaflet-control-layers-scrollbar"),
                    this._form.style.height = a + "px") : f.DomUtil.removeClass(this._form, "leaflet-control-layers-scrollbar"),
                    this._checkDisabledLayers(),
                    this
                },
                collapse: function() {
                    return f.DomUtil.removeClass(this._container, "leaflet-control-layers-expanded"),
                    this
                },
                _initLayout: function() {
                    ...
                    f.DomEvent.disableClickPropagation(b),
                    f.Browser.touch || f.DomEvent.disableScrollPropagation(b);
                    ...
                    d.href = "#",
                    d.title = "Layers",
                    f.Browser.touch ? f.DomEvent.on(d, "click", f.DomEvent.stop).on(d, "click", this.expand, this) : f.DomEvent.on(d, "focus", this.expand, this),
                ...
                _getLayer: function(a) {
                    for (var b = 0; b < this._layers.length; b++)
                        if (this._layers[b] && f.stamp(this._layers[b].layer) === a)
                ...
                _update: function() {
                    ...
                    for (c = 0; c < this._layers.length; c++)
                        ...
                        a = a || !d.overlay,
                        e += d.overlay ? 0 : 1;
                    return this.options.hideSingleBase && (a = a && e > 1,
                ...
                _addItem: function(a) {
                    var b, d = c.createElement("label"), e = this._map.hasLayer(a.layer);
                    a.overlay ? (b = c.createElement("input"),
                    b.type = "checkbox",
                    b.className = "leaflet-control-layers-selector",
                    b.defaultChecked = e) : b = this._createRadioElement("leaflet-base-layers", e),
                    b.layerId = f.stamp(a.layer),
                    f.DomEvent.on(b, "click", this._onInputClick, this);
                ...
                _onInputClick: function() {
                    ...
                    for (var g = d.length - 1; g >= 0; g--)
                        ...
                        c = this._map.hasLayer(b),
                        a.checked && !c ? e.push(b) : !a.checked && c && f.push(b);
                    for (g = 0; g < f.length; g++)
                        this._map.removeLayer(f[g]);
                    for (g = 0; g < e.length; g++)
                        this._map.addLayer(e[g]);
                    this._handlingClick = !1,
                    this._refocusOnMap()
                },
                _checkDisabledLayers: function() {
                    for (var a, b, c = this._form.getElementsByTagName("input"), e = this._map.getZoom(), f = c.length - 1; f >= 0; f--)
                        a = c[f],
                        b = this._getLayer(a.layerId).layer,
                        a.disabled = b.options.minZoom !== d && e < b.options.minZoom || b.options.maxZoom !== d && e > b.options.maxZoom
                },
                _expand: function() {
                    return this.expand()
                },
    ...
    4: [function(a, b, c) {
        !function(a, b) {
            "object" == typeof c && c && "string" != typeof c.nodeName ? b(c) : "function" == typeof define && define.amd ? define(["exports"], b) : (a.Mustache = {},
            b(a.Mustache))
        }(this, function(a) {
            function b(a) {
    ...
    6: [function(a, b) {
        var c = function() {
            ...
            function b(a, b, f, g, h, j, k) {
                ...
                return j && ("string" == typeof j ? l.setRawQuery(j.replace(/[^?&=0-9A-Za-z_\-~.%]/g, e)) : l.setAllParameters(j)),
                l
            }
            function c(a) {
            ...
            function g(a) {
                if (null === a)
                    return null;
                for (var b, c = f(a), d = l; (b = c.replace(d, "$1")) != c; c = b)
                    ;
                return c
            }
            function h(a, b) {
                var c = a.clone()
                  , d = b.hasScheme();
                d ? c.setRawScheme(b.getRawScheme()) : d = b.hasCredentials(),
                d ? c.setRawCredentials(b.getRawCredentials()) : d = b.hasDomain(),
                d ? c.setRawDomain(b.getRawDomain()) : d = b.hasPort();
                var e = b.getRawPath()
                  , f = g(e);
                if (d)
                    c.setPort(b.getPort()),
                    ...
                    f = f && f.replace(m, ""),
                    f !== e && c.setRawPath(f);
                return d ? c.setRawPath(f) : d = b.hasQuery(),
                d ? c.setRawQuery(b.getRawQuery()) : d = b.hasFragment(),
                d && c.setRawFragment(b.getRawFragment()),
                c
            }
            ...
            i.prototype.toString = function() {
                var a = [];
                return null !== this.scheme_ && a.push(this.scheme_, ":"),
                null !== this.domain_ && (a.push("//"),
                null !== this.credentials_ && a.push(this.credentials_, "@"),
                a.push(this.domain_),
                null !== this.port_ && a.push(":", this.port_.toString())),
                null !== this.path_ && a.push(this.path_),
                null !== this.query_ && a.push("?", this.query_),
                null !== this.fragment_ && a.push("#", this.fragment_),
                a.join("")
            }
            ,
            ...
            i.prototype.setScheme = function(a) {
                return this.scheme_ = d(a, o),
                this
            }
            ,
            i.prototype.setRawScheme = function(a) {
                return this.scheme_ = a ? a : null,
                this
            }
            ,
            ...
            i.prototype.setCredentials = function(a) {
                return this.credentials_ = d(a, o),
                this
            }
            ,
            i.prototype.setRawCredentials = function(a) {
                return this.credentials_ = a ? a : null,
                this
            }
            ,
            ...
            i.prototype.setPort = function(a) {
                if (a) {
                    if (a = Number(a),
                    a !== (65535 & a))
                        throw new Error("Bad port number " + a);
                    this.port_ = "" + a
                } else
                    this.port_ = null;
                return this
            ...
            i.prototype.setRawPath = function(a) {
                return a ? (a = String(a),
                this.path_ = !this.domain_ || /^\//.test(a) ? a : "/" + a) : this.path_ = null,
                this
            }
            ,
            ...
            i.prototype.setAllParameters = function(a) {
                ...
                for (var f = [], g = "", h = 0; h < a.length; ) {
                    var d = a[h++]
                      , e = a[h++];
                    f.push(g, encodeURIComponent(d.toString())),
                    g = "&",
                    e && f.push("=", encodeURIComponent(e.toString()))
                }
                return this.query_ = f.join(""),
                this
            }
            ,
                ...
                if (!this.paramCache_) {
                    ...
                    if (a) {
                        for (var b = a.split(/[&\?]/), c = [], d = -1, e = 0; e < b.length; ++e) {
                            var f = b[e].match(/^([^=]*)(?:=(.*))?$/);
                            c[++d] = decodeURIComponent(f[1]).replace(/\+/g, " "),
                            c[++d] = decodeURIComponent(f[2] || "").replace(/\+/g, " ")
                        }
                        this.paramCache_ = c
                    } else
                        this.paramCache_ = []
            ...
            i.prototype.setParameterValues = function(a, b) {
                ...
                for (var c = 0, d = this.paramCache_, e = [], f = 0; f < d.length; f += 2)
                    a === d[f] ? c < b.length && e.push(a, b[c++]) : e.push(d[f], d[f + 1]);
                for (; c < b.length; )
                    e.push(a, b[c++]);
                return this.setAllParameters(e),
                this
            }
            ,
            ...
            i.prototype.getParameterValues = function(a) {
                ...
                for (var b = [], c = 0; c < this.paramCache_.length; c += 2)
                    a === this.paramCache_[c] && b.push(this.paramCache_[c + 1]);
                return b
            }
            ,
            ...
            i.prototype.getParameterValue = function(a) {
                ...
                for (var b = 0; b < this.paramCache_.length; b += 2)
                    if (a === this.paramCache_[b])
                        return this.paramCache_[b + 1];
                return null
            }
            ,
            ...
            i.prototype.setFragment = function(a) {
                return this.fragment_ = a ? encodeURIComponent(a) : null,
                this
            }
            ,
            i.prototype.setRawFragment = function(a) {
                return this.fragment_ = a ? a : null,
                this
            }
            ,
        ...
        d.ELEMENT_DOM_INTERFACES = d.ELEMENT_DOM_INTERFACES,
        d.ueffects = {
            NOT_LOADED: 0,
            SAME_DOCUMENT: 1,
            NEW_DOCUMENT: 2
        },
        d.ueffects = d.ueffects,
        d.URIEFFECTS = {
            "a::href": 2,
            "area::href": 2,
            "blockquote::cite": 0,
        ...
        var e = function(a) {
            function b(a) {
                ...
                var b = a.match(G);
                if (b)
                    return String.fromCharCode(parseInt(b[1], 10));
                if (b = a.match(H))
                    return String.fromCharCode(parseInt(b[1], 16));
                if (J && I.test(a)) {
                    J.innerHTML = "&" + a + ";";
                    var c = J.textContent;
                    return F[a] = c,
            ...
            function l(b, c, d, e, f) {
                try {
                    ...
                    for (var g, h, i, j = d, l = c.length; l > j; ) {
                        ...
                        switch (m) {
                        case "&":
                            M.test(q) ? (b.pcdata && b.pcdata("&" + q, f, V, k(b, c, j, e, f)),
                            j++) : b.pcdata && b.pcdata("&amp;", f, V, k(b, c, j, e, f));
                            break;
                        case "</":
                            (g = /^([-\w:]+)[^\'\"]*/.exec(q)) ? g[0].length === q.length && ">" === c[j + 1] ? (j += 2,
                            i = g[1].toLowerCase(),
                            b.endTag && b.endTag(i, f, V, k(b, c, j, e, f))) : j = n(c, j, b, f, V, e) : b.pcdata && b.pcdata("&lt;/", f, V, k(b, c, j, e, f));
                            break;
                        case "<":
                            if (g = /^([-\w:]+)\s*\/?/.exec(q))
                                if (g[0].length === q.length && ">" === c[j + 1]) {
                                    j += 2,
                                    i = g[1].toLowerCase(),
                                    b.startTag && b.startTag(i, [], f, V, k(b, c, j, e, f));
                                    var r = a.ELEMENTS[i];
                                    if (r & U) {
                                        var s = {
                                            name: i,
            ...
            function m(a) {
                ...
                T)
                    return a.split(b);
                for (var c, d = [], e = 0; null !== (c = b.exec(a)); )
            ...
            function n(a, b, c, d, e, f) {
                var g = q(a, b);
                return g ? (c.endTag && c.endTag(g.name, d, e, k(c, a, b, f, d)),
                g.next) : a.length
            }
            function o(a, b, c, d, e, f) {
                var g = q(a, b);
                return g ? (c.startTag && c.startTag(g.name, g.attrs, d, e, k(c, a, g.next, f, d)),
                g.eflags & U ? p(a, g, c, d, e, f) : g.next) : a.length
            }
            function p(b, c, d, e, f, g) {
                ...
                if (c.eflags & a.eflags.CDATA)
                    d.cdata && d.cdata(n, e, f, k(d, b, m, g, e));
                else {
                    if (!(c.eflags & a.eflags.RCDATA))
                        throw new Error("bug");
            ...
            function q(b, c) {
                ...
                e.eflags = a.ELEMENTS[e.name];
                for (var f = b[c].substr(d[0].length), g = c + 1, h = b.length; h > g && ">" !== b[g]; g++)
                    f += b[g];
                if (g >= h)
                    return void 0;
                for (var i = []; "" !== f; )
            ...
            function r(a) {
                var b = a.charCodeAt(0);
                return (34 === b || 39 === b) && (a = a.substr(1, a.length - 2)),
                f(e(a))
            }
            function s(b) {
                    ...
                    startTag: function(e, f, h) {
                        if (!d && a.ELEMENTS.hasOwnProperty(e)) {
                            ...
                            if (!(i & a.eflags.FOLDABLE)) {
                                ...
                                f = j.attribs;
                                var k, l;
                                if ("tagName"in j ? (l = j.tagName,
                                k = a.ELEMENTS[l]) : (l = e,
                                k = i),
                                i & a.eflags.OPTIONAL_ENDTAG) {
                                    var m = c[c.length - 1];
                                ...
                                h.push(">"),
                                i & a.eflags.EMPTY && !(k & a.eflags.EMPTY) && h.push("</", l, ">")
                            }
                        }
                    },
                    endTag: function(b, e) {
                            ...
                            if (!(f & (a.eflags.EMPTY | a.eflags.FOLDABLE))) {
                                ...
                                if (f & a.eflags.OPTIONAL_ENDTAG)
                                    for (g = c.length; --g >= 0; ) {
                                        ...
                                        if (h === b)
                                            break;
                                        if (!(a.ELEMENTS[h] & a.eflags.OPTIONAL_ENDTAG))
                                            return
                                    }
                                else
            ...
            function v(a, b, c) {
                var d;
                return d = b + "::" + c,
                a.hasOwnProperty(d) ? a[d] : (d = "*::" + c,
                a.hasOwnProperty(d) ? a[d] : void 0)
            }
            function w(b, c) {
            ...
            function y(b, c, d, e, f) {
                for (var g = 0; g < c.length; g += 2) {
                    var h, i = c[g], j = c[g + 1], k = j, l = null;
                    if (h = b + "::" + i,
                    (a.ATTRIBS.hasOwnProperty(h) || (h = "*::" + i,
                    a.ATTRIBS.hasOwnProperty(h))) && (l = a.ATTRIBS[h]),
                    null !== l)
                        switch (l) {
                        case a.atype.NONE:
                            break;
                        ...
                        case a.atype.URI_FRAGMENT:
                            j && "#" === j.charAt(0) ? (j = j.substring(1),
                            j = e ? e(j) : j,
                            null !== j && void 0 !== j && (j = "#" + j)) : j = null,
                            f && u(f, b, i, k, j);
                            break;
                        default:
                            j = null,
            ...
            function z(b, c, d) {
                return function(e, f) {
                    return a.ELEMENTS[e] & a.eflags.UNSAFE ? (d && u(d, e, void 0, void 0, void 0),
                    void 0) : {
                        attribs: y(e, f, b, c, d)
                    }
                }
            ...
            var C, D, E;
            "undefined" != typeof window && (C = window.parseCssDeclarations,
            D = window.sanitizeCssProperty,
            E = window.cssSchema);
            var F = {
                lt: "<",
                LT: "<",
              ...
              , Y = {};
            return Y.escapeAttrib = Y.escapeAttrib = g,
            Y.makeHtmlSanitizer = Y.makeHtmlSanitizer = s,
            Y.makeSaxParser = Y.makeSaxParser = i,
            Y.makeTagPolicy = Y.makeTagPolicy = z,
            Y.normalizeRCData = Y.normalizeRCData = h,
            Y.sanitize = Y.sanitize = B,
            Y.sanitizeAttribs = Y.sanitizeAttribs = y,
            Y.sanitizeWithPolicy = Y.sanitizeWithPolicy = A,
            Y.unescapeEntities = Y.unescapeEntities = f,
            Y
        }(d)
          , f = e.sanitize;
        d.ATTRIBS["*::style"] = 0,
        d.ELEMENTS.style = 0,
        d.ATTRIBS["a::target"] = 0,
        d.ELEMENTS.video = 0,
        d.ATTRIBS["video::src"] = 0,
        d.ATTRIBS["video::poster"] = 0,
        d.ATTRIBS["video::controls"] = 0,
        d.ELEMENTS.audio = 0,
        d.ATTRIBS["audio::src"] = 0,
        d.ATTRIBS["video::autoplay"] = 0,
        d.ATTRIBS["video::controls"] = 0,
        "undefined" != typeof b && (b.exports = f)
    }
    , {}],
    7: [function(a, b) {
        b.exports = {
        ...
        var c = a("./util")
          ...
          , h = L.FeatureGroup.extend({
            ...
            initialize: function(a, b) {
                L.setOptions(this, b),
                this._layers = {},
                "string" == typeof a ? c.idUrl(a, this) : a && "object" == typeof a && this.setGeoJSON(a)
            },
            setGeoJSON: function(a) {
                return this._geojson = a,
                this.clearLayers(),
                this._initialize(a),
                this
            },
            ...
            loadURL: function(a) {
                ...
                this._request = e(a, L.bind(function(b, d) {
                    this._request = null,
                    b && "abort" !== b.type ? (c.log("could not load features at " + a),
                    this.fire("error", {
                        error: b
                    })) : d && (this.setGeoJSON(d),
                    this.fire("ready"))
            ...
            _initialize: function(a) {
                ...
                if (d)
                    for (b = 0,
                    c = d.length; c > b; b++)
                        (d[b].geometries || d[b].geometry || d[b].features) && this._initialize(d[b]);
                    ...
                    var e = {
                      ...
                      , l = k === g.style;
                    !(k && "setStyle"in i) || l && (i instanceof L.Circle || i instanceof L.CircleMarker) || ("function" == typeof k && (k = k(a)),
                    i.setStyle(k)),
                    i.feature = a,
                    j && i.bindPopup(j, this.options.popupOptions),
                    this.addLayer(i)
                }
            }
        });
        b.exports.FeatureLayer = h,
        b.exports.featureLayer = function(a, b) {
            return new h(a,b)
        }
    }
    , {
    ...
    11: [function(a, b) {
        ...
        b.exports = function(a, b) {
            if (b = b || L.mapbox.accessToken,
            !b && c.REQUIRE_ACCESS_TOKEN)
                throw new Error("An API access token is required to use Mapbox.js. See https://www.mapbox.com/mapbox.js/api/v" + d + "/api-access-tokens/");
            var e = "https:" === document.location.protocol || c.FORCE_HTTPS ? c.HTTPS_URL : c.HTTP_URL;
            if (e = e.replace(/\/v4$/, ""),
            e += a,
            c.REQUIRE_ACCESS_TOKEN) {
                if ("s" === b[0])
                    throw new Error("Use a public access token (pk.*) with Mapbox.js, not a secret access token (sk.*). See https://www.mapbox.com/mapbox.js/api/v" + d + "/api-access-tokens/");
        ...
        b.exports.tileJSON = function(a, c) {
            if (0 === a.indexOf("mapbox://styles"))
                throw new Error("Styles created with Mapbox Studio need to be used with L.mapbox.styleLayer, not L.mapbox.tileLayer");
            if (-1 !== a.indexOf("/"))
                return a;
            var d = b.exports("/v4/" + a + ".json", c);
            return 0 === d.indexOf("https") && (d += "&secure"),
            d
        }
        ,
        b.exports.style = function(a, c) {
            if (-1 === a.indexOf("mapbox://styles/"))
                throw new Error("Incorrectly formatted Mapbox style at " + a);
    ...
    12: [function(a, b) {
        ...
        b.exports = function(a, b) {
            function h(a, b) {
                var c = Math.pow(10, b);
                return a.lat = Math.round(a.lat * c) / c,
                a.lng = Math.round(a.lng * c) / c,
                a
            }
            b || (b = {});
            var i = {};
            return d.strict(a, "string"),
            -1 === a.indexOf("/") && (a = e("/geocoding/v5/" + a + "/{query}.json", b.accessToken, 5)),
            i.getURL = function() {
                return a
            }
            ,
            i.queryURL = function(a) {
                ...
                if (b) {
                    if (a.types && (j += c(a.types) ? "&types=" + a.types.join() : "&types=" + a.types),
                    a.country && (j += c(a.country) ? "&country=" + a.country.join() : "&country=" + a.country),
                    a.bbox && (j += c(a.bbox) ? "&bbox=" + a.bbox.join() : "&bbox=" + a.bbox),
                    a.proximity) {
            ...
            i.query = function(a, b) {
                return d.strict(b, "function"),
                g(i.queryURL(a), function(a, c) {
                    if (c && (c.length || c.features)) {
                        var e = {
                            results: c
                        };
                        c.features && c.features.length && (e.latlng = [c.features[0].center[1], c.features[0].center[0]],
                        c.features[0].bbox && (e.bounds = c.features[0].bbox,
                        e.lbounds = d.lbounds(e.bounds))),
                        b(null, e)
                    } else
                        b(a || !0)
                }),
            ...
            i.reverseQuery = function(a, b) {
                function c(a) {
                    var b;
                    return b = void 0 !== a.lat && void 0 !== a.lng ? L.latLng(a.lat, a.lng) : void 0 !== a.lat && void 0 !== a.lon ? L.latLng(a.lat, a.lon) : L.latLng(a[1], a[0]),
                    b = h(b, 5),
                    b.lng + "," + b.lat
                }
                var d = "";
    ...
    13: [function(a, b) {
        ...
        var c = a("./geocoder")
          ...
          , e = L.Control.extend({
            ...
            onAdd: function(a) {
                ...
                L.DomEvent.addListener(f, "submit", this._geocode, this),
                L.DomEvent.addListener(g, "keyup", this._autocomplete, this),
                L.DomEvent.disableClickPropagation(b),
                this._map = a,
                this._results = d,
                this._input = g,
                this._form = f,
                this.options.keepOpen ? L.DomUtil.addClass(b, "active") : (this._map.on("click", this._closeIfOpen, this),
                L.DomEvent.addListener(c, "click", this._toggle, this)),
                b
            },
            _updateSubmit: function(a, b) {
                ...
                a || !b)
                    ...
                    var c = [];
                    b.results && b.results.features && (c = b.results.features),
                    1 === c.length ? (this.fire("autoselect", {
                        feature: c[0]
                    }),
                    this.fire("found", {
                        results: b.results
                    }),
                    this._chooseResult(c[0]),
                    this._closeIfOpen()) : c.length > 1 ? (this.fire("found", {
                        results: b.results
                    }),
                    this._displayResults(c)) : (this.fire("notfound"),
            ...
            _geocode: function(a) {
                return L.DomEvent.preventDefault(a),
        ...
        b.exports.GeocoderControl = e,
        b.exports.geocoderControl = function(a, b) {
            return new e(a,b)
        }
    }
    , {
    ...
    15: [function(a, b) {
        ...
        var c = a("./util")
          ...
          , e = L.Control.extend({
            ...
            initialize: function(a, b) {
                L.Util.setOptions(this, b),
                c.strict_instance(a, L.Class, "L.mapbox.gridLayer"),
                this._layer = a
            },
            setTemplate: function(a) {
                return c.strict(a, "string"),
                this.options.template = a,
                this
            },
            _template: function(a, b) {
                if (b) {
                    ...
                    if (c) {
                        var e = {};
                        return e["__" + a + "__"] = !0,
                        this.options.sanitizer(d.to_html(c, L.extend(e, b)))
                    }
                }
            },
            _show: function(a, b) {
                a !== this._currentContent && (this._currentContent = a,
                this.options.follow ? (this._popup.setContent(a).setLatLng(b.latLng),
                this._map._popup !== this._popup && this._popup.openOn(this._map)) : (this._container.style.display = "block",
                this._contentWrapper.innerHTML = a))
            },
            hide: function() {
            ...
            _mouseover: function(a) {
                if (a.data ? L.DomUtil.addClass(this._map._container, "map-clickable") : L.DomUtil.removeClass(this._map._container, "map-clickable"),
                !this._pinned) {
            ...
            _click: function(a) {
                ...
                if (this.options.location && b && 0 === b.search(/^https?:/))
                    return this._navigateTo(this._template("location", a.data));
                if (this.options.pinnable) {
                    var c = this._template("full", a.data);
                    !c && this.options.touchTeaser && L.Browser.touch && (c = this._template("teaser", a.data)),
                    c ? (L.DomUtil.addClass(this._container, "closable"),
                    this._pinned = !0,
                    this._show(c, a)) : this._pinned && (L.DomUtil.removeClass(this._container, "closable"),
                    this._pinned = !1,
                    this.hide())
                }
            },
            ...
            _createClosebutton: function(a, b) {
                ...
                return c.innerHTML = "close",
                c.href = "#",
                c.title = "close",
                L.DomEvent.on(c, "click", L.DomEvent.stopPropagation).on(c, "mousedown", L.DomEvent.stopPropagation).on(c, "dblclick", L.DomEvent.stopPropagation).on(c, "click", L.DomEvent.preventDefault).on(c, "click", b, this),
                c
            },
            onAdd: function(a) {
                this._map = a;
                ...
                this._createClosebutton(c, this.hide),
                c.appendChild(d),
                this._contentWrapper = d,
                this._popup = new L.Popup({
                    autoPan: !1,
                    closeOnClick: !1
                }),
                a.on("popupclose", this._onPopupClose, this),
                L.DomEvent.disableClickPropagation(c).addListener(c, "mousewheel", L.DomEvent.stopPropagation),
                this._layer.on("mouseover", this._mouseover, this).on("mousemove", this._mousemove, this).on("click", this._click, this),
                c
            },
            onRemove: function(a) {
                a.off("popupclose", this._onPopupClose, this),
                this._layer.off("mouseover", this._mouseover, this).off("mousemove", this._mousemove, this).off("click", this._click, this)
            }
        });
        b.exports.GridControl = e,
        b.exports.gridControl = function(a, b) {
            return new e(a,b)
        }
    }
    , {
    ...
    16: [function(a, b) {
        ...
        var c = a("./util")
          ...
          , f = L.Layer.extend({
            ...
            initialize: function(a, b) {
                L.Util.setOptions(this, b),
                this._loadTileJSON(a)
            },
            _setTileJSON: function(a) {
                return c.strict(a, "object"),
            ...
            getData: function(a, b) {
                if (this.active()) {
                    ...
                    return g = (g + i) % i,
                    h = (h + i) % i,
                    this._getTile(c.getZoom(), g, h, function(a) {
                ...
                if (this.active()) {
                    ...
                    if (!(b > this.options.maxZoom || b < this.options.minZoom))
                        for (var d = L.bounds(a.min.divideBy(c)._floor(), a.max.divideBy(c)._floor()), e = this._map.options.crs.scale(b) / c, f = d.min.x; f <= d.max.x; f++)
                            for (var g = d.min.y; g <= d.max.y; g++)
                                this._getTile(b, (f % e + e) % e, (g % e + e) % e)
                }
            },
            _getTile: function(a, b, c, f) {
                var g = a + "_" + b + "_" + c
                  , h = L.point(b, c);
                if (h.z = a,
                this._tileShouldBeLoaded(h)) {
                    if (g in this._cache) {
                        if (!f)
                            return;
                        return "function" == typeof this._cache[g] ? f(this._cache[g]) : this._cache[g].push(f),
                        void 0
                    }
                    this._cache[g] = [],
                    f && this._cache[g].push(f),
                    d(this._getTileURL(h), L.bind(function(a, b) {
                        var c = this._cache[g];
                        this._cache[g] = e(b);
            ...
            _tileShouldBeLoaded: function(a) {
                if (a.z > this.options.maxZoom || a.z < this.options.minZoom)
                    return !1;
                if (this.options.bounds) {
                    var b = 256
                      , c = a.multiplyBy(b)
                    ...
                    if (!this.options.bounds.intersects(g))
                        return !1
                }
                return !0
            }
        });
        b.exports.GridLayer = f,
        b.exports.gridLayer = function(a, b) {
            return new f(a,b)
        }
    }
    , {
    ...
    19: [function(a, b) {
        ...
        var c = L.Control.extend({
            ...
            addLegend: function(a) {
                return a ? (this._legends[a] || (this._legends[a] = 0),
                this._legends[a]++,
                this._update()) : this
            },
            removeLegend: function(a) {
                return a ? (this._legends[a] && this._legends[a]--,
                this._update()) : this
            },
            _update: function() {
                if (!this._map)
                ...
                for (var b in this._legends)
                    if (this._legends.hasOwnProperty(b) && this._legends[b]) {
                        ...
                        c.innerHTML = this.options.sanitizer(b),
                        a = "block"
                    }
                return this._container.style.display = a,
                this
            }
        });
        b.exports.LegendControl = c,
        b.exports.legendControl = function(a) {
            return new c(a)
        }
    }
    , {
    ...
    20: [function(a, b) {
        ...
        b.exports = {
            _loadTileJSON: function(a) {
                "string" == typeof a ? (a = d.tileJSON(a, this.options && this.options.accessToken),
                c(a, L.bind(function(b, c) {
                    b ? (e.log("could not load TileJSON at " + a),
                    this.fire("error", {
                        error: b
                    })) : c && (this._setTileJSON(c),
                    this.fire("ready"))
        ...
        var d = a("./tile_layer").tileLayer
          ...
          , l = L.Map.extend({
            ...
            initialize: function(a, b, l) {
                if (L.Map.prototype.initialize.call(this, a, L.extend({}, L.Map.prototype.options, l)),
                this.attributionControl) {
                    this.attributionControl.setPrefix("");
                    var m = this.options.attributionControl.compact;
                    (m || m !== !1 && this._container.offsetWidth <= 640) && L.DomUtil.addClass(this.attributionControl._container, "leaflet-compact-attribution"),
                    void 0 === m && this.on("resize", function() {
                ...
                this.options.tileLayer && (this.tileLayer = d(void 0, c(this.options.tileLayer, this.options.accessToken)),
                this.addLayer(this.tileLayer)),
                this.options.featureLayer && (this.featureLayer = e(void 0, c(this.options.featureLayer, this.options.accessToken)),
                this.addLayer(this.featureLayer)),
                this.options.gridLayer && (this.gridLayer = f(void 0, c(this.options.gridLayer, this.options.accessToken)),
                this.addLayer(this.gridLayer)),
                this.options.gridLayer && this.options.gridControl && (this.gridControl = g(this.gridLayer, this.options.gridControl),
                this.addControl(this.gridControl)),
                this.options.legendControl && (this.legendControl = i(this.options.legendControl),
                this.addControl(this.legendControl)),
                this.options.shareControl && (this.shareControl = h(void 0, c(this.options.shareControl, this.options.accessToken)),
                this.addControl(this.shareControl)),
                this._mapboxLogoControl = j(this.options.mapboxLogoControl),
                this.addControl(this._mapboxLogoControl),
                this._loadTileJSON(b),
            ...
            _initialize: function(a) {
                if (this.tileLayer && (this.tileLayer._setTileJSON(a),
                this._updateLayer(this.tileLayer)),
                this.featureLayer && !this.featureLayer.getGeoJSON() && a.data && a.data[0] && this.featureLayer.loadURL(a.data[0]),
                this.gridLayer && (this.gridLayer._setTileJSON(a),
                this._updateLayer(this.gridLayer)),
                this.legendControl && a.legend && this.legendControl.addLegend(a.legend),
                this.shareControl && this.shareControl._setTileJSON(a),
                this._mapboxLogoControl._setTileJSON(a),
                !this._loaded && a.center) {
            ...
            _onLayerAdd: function(a) {
                "on"in a.layer && a.layer.on("ready", this._onLayerReady, this),
                window.setTimeout(L.bind(this._updateMapFeedbackLink, this), 0)
            },
            _onLayerRemove: function(a) {
                "on"in a.layer && a.layer.off("ready", this._onLayerReady, this),
                window.setTimeout(L.bind(this._updateMapFeedbackLink, this), 0)
            },
            ...
            _updateLayer: function(a) {
                a.options && (this.attributionControl && this._loaded && a.getAttribution && this.attributionControl.addAttribution(a.getAttribution()),
                L.stamp(a)in this._zoomBoundLayers || !a.options.maxZoom && !a.options.minZoom || (this._zoomBoundLayers[L.stamp(a)] = a),
                this._updateMapFeedbackLink(),
                this._updateZoomLevels())
            }
        });
        b.exports.Map = l,
        b.exports.map = function(a, b, c) {
            return new l(a,b,c)
        }
    }
    , {
    ...
    23: [function(a, b) {
        ...
        b.exports.MapboxLogoControl = c,
        b.exports.mapboxLogoControl = function(a) {
            return new c(a)
        }
    }
    , {}],
    24: [function(a, b) {
        ...
        function e(a, b) {
            if (!a || !a.properties)
                return "";
            var c = "";
            return a.properties.title && (c += '<div class="marker-title">' + a.properties.title + "</div>"),
            a.properties.description && (c += '<div class="marker-description">' + a.properties.description + "</div>"),
            (b || h)(c)
        }
        var f = a("./format_url")
          , g = a("./util")
    ...
    25: [function(a, b) {
        ...
        b.exports = function(a, b) {
            function g(a, c) {
                !a && c && (c = JSON.parse(c.responseText)),
                b(a, c)
            }
            return d(a, "string"),
            d(b, "function"),
            a = a.replace(f, function(a, b) {
        ...
        var c = a("./format_url")
          , d = L.Control.extend({
            ...
            onAdd: function(a) {
                ...
                L.DomEvent.addListener(c, "click", this._shareClick, this),
                L.DomEvent.disableClickPropagation(b),
                this._map.on("mousedown", this._clickOut, this),
                b
            },
            _clickOut: function(a) {
                return this._sharing ? (L.DomEvent.preventDefault(a),
            ...
            _shareClick: function(a) {
                ...
                if (L.DomEvent.stop(a),
                this._sharing)
                    return this._clickOut(a);
                ...
                s.setAttribute("class", "mapbox-share-buttons"),
                s.appendChild(o),
                s.appendChild(n),
                s.appendChild(p),
                this._sharing.appendChild(q),
                this._sharing.appendChild(s);
                ...
                L.DomEvent.addListener(v, "click", this._clickOut, this),
                L.DomEvent.addListener(t, "click", function(a) {
                    a.target.focus(),
                    a.target.select()
                })
            }
        });
        b.exports.ShareControl = d,
        b.exports.shareControl = function(a, b) {
            return new d(a,b)
        }
    }
    , {
    ...
    27: [function(a, b) {
        ...
        var f = {
          ...
          , g = [["stroke", "color"], ["stroke-width", "weight"], ["stroke-opacity", "opacity"], ["fill", "fillColor"], ["fill-opacity", "fillOpacity"]];
        b.exports = {
            style: e,
            defaults: f
        }
    ...
    28: [function(a, b) {
        ...
        var c = a("./util")
          ...
          , f = L.TileLayer.extend({
            ...
            _getAttribution: function(a) {
                ...
                e(b, L.bind(function(f, g) {
                    ...
                    e(d.tileJSON(h.join(), this.options.accessToken), L.bind(function(b, d) {
                        b ? (c.log("could not load TileJSON at " + a),
                        this.fire("error", {
                            error: b
                        })) : d && (c.strict(d, "object"),
                        this.options.attribution = this.options.sanitizer(d.attribution),
                        this._tilejson = d,
                        this.fire("ready"))
                    }, this))
                }, this))
            ...
            _formatTileURL: function(a) {
                if ("string" == typeof a) {
                    -1 === a.indexOf("mapbox://styles/") && (c.log("Incorrectly formatted Mapbox style at " + a),
                    this.fire("error"));
        ...
        b.exports.StyleLayer = f,
        b.exports.styleLayer = function(a, b) {
            return new f(a,b)
        }
    }
    , {
    ...
    29: [function(a, b) {
        ...
        var c = a("./util")
          ...
          , e = L.TileLayer.extend({
            ...
            initialize: function(a, b) {
                ...
                this._tilejson = {},
                b && b.format && c.strict_oneof(b.format, this.formats),
                this._loadTileJSON(a)
            },
            setFormat: function(a) {
                return c.strict(a, "string"),
                this.options.format = a,
                this.redraw(),
                this
            },
            setUrl: null,
            _setTileJSON: function(a) {
                if (c.strict(a, "object"),
                !this.options.format) {
        ...
        b.exports.TileLayer = e,
        b.exports.tileLayer = function(a, b) {
            return new e(a,b)
        }
    }
    , {
    ...
    30: [function(a, b) {
        ...
        b.exports = {
            ...
            strict: function(a, b) {
                if (typeof a !== b)
                    throw new Error("Invalid argument: " + b + " expected")
            },
            strict_instance: function(a, b, c) {
                if (!(a instanceof b))
                    throw new Error("Invalid argument: " + c + " expected")
            },
            strict_oneof: function(a, b) {
                if (!c(a, b))
                    throw new Error("Invalid argument: " + a + " given, valid values are " + b.join(", "))
            },
            strip_tags: function(a) {
                return a.replace(/<[^<]+>/g, "")
            },
            lbounds: function(a) {
                return new L.LatLngBounds([[a[1], a[0]], [a[3], a[2]]])
            }
        }
    }
    , {}],
    ...
    32: [function(a, b) {
        ...
        b.exports = function(a) {
            ...
            b.query = function(a, d, f) {
                return c.strict(f, "function"),
                e(b.queryURL(a, d), function(a, b) {
    ...
    33: [function(a, b) {
        ...
        L.cedarmaps.VERSION = a("../package.json").version,
        L.cedarmaps.geocoder = a("./geocoder"),
        L.cedarmaps.staticMap = a("./static_map"),
        L.cedarmaps.nearby = a("./nearby"),
        L.cedarmaps.distance = a("./distance"),
        L.cedarmaps.administrativeBoundaries = a("./administrative_boundaries"),
        L.cedarmaps.direction = a("./direction"),
        L.cedarmaps.map = c.map,
        L.cedarmaps.Map = c.Map,
        L.cedarmaps.tileLayer = d.tileLayer,
        L.cedarmaps.TileLayer = d.TileLayer,
        L.cedarmaps.geocoderControl = e.geocoderControl,
        L.cedarmaps.GeocoderControl = e.GeocoderControl,
        b.exports = L.cedarmaps,
        window.L.Icon.Default.imagePath = ("https:" === document.location.protocol || "http:" === document.location.protocol ? "" : "https:") + "//api.cedarmaps.com/cedarmaps.js/v" + a("../package.json").version + "/images/"
    }
    , {
        "../package.json": 31,
    ...
    34: [function(a, b) {
        ...
        var c = L.Control.extend({
            ...
            onAdd: function() {
                return this._container = L.DomUtil.create("a", "cedarmaps-logo"),
        ...
        b.exports.CedarmapsLogoControl = c,
        b.exports.cedarmapsLogoControl = function(a) {
            return new c(a)
        }
    }
    , {}],
    ...
    37: [function(a, b) {
        ...
        var c = a("./config")
          ...
          , e = a("./request");
        b.exports = function(a, b) {
            if (a.profile || (a.profile = "cedarmaps.driving"),
            !a.points || !d(a.points))
                throw "Cedarmaps: Bad input.";
            for (var f = "", g = 0, h = a.points.length; h > g; g++)
                f += a.points[g].from.lat + "," + a.points[g].from.lng + ";",
                f += a.points[g].to.lat + "," + a.points[g].to.lng,
                f += "/";
    ...
    38: [function(a, b) {
        ...
        var c = a("./config")
          , d = a("../package.json").version;
        b.exports = function(a, b) {
            if (b = b || L.cedarmaps.accessToken,
            !b && c.REQUIRE_ACCESS_TOKEN)
                throw new Error("An API access token is required to use cedarmaps.js. See https://www.mapbox.com/mapbox.js/api/v" + d + "/api-access-tokens/");
            var e = "https:" === document.location.protocol || c.FORCE_HTTPS ? c.HTTPS_URL : c.HTTP_URL;
            if (e = e.replace(/\/v4$/, ""),
            e += a,
            e += -1 !== e.indexOf("?") ? "&access_token=" : "?access_token=",
    ...
    39: [function(a, b) {
        ...
        b.exports = function(a, b) {
            ...
            var g = {};
            return d.strict(a, "string"),
            -1 === a.indexOf("/") && (a = e("/geocode/" + a + "/{query}.json", b.accessToken, 5)),
            g.getURL = function() {
                return a
            }
            ,
            g.queryURL = function(a) {
                ...
                return b && a.limit && (h += "&limit=" + a.limit),
                b && a.distance && (h += "&distance=" + a.distance),
                b && a.ne && a.sw && (h += "&ne=" + a.ne + "&sw=" + a.sw),
                b && a.type && (h += c(a.type) ? "&type=" + a.type.join(",") : "&type=" + a.type),
                h
            }
            ,
            g.query = function(a, b) {
                return d.strict(b, "function"),
                f(g.queryURL(a), function(a, c) {
        ...
        L.Control.extend({
            ...
            _updateSubmit: function(a, b) {
                ...
                a || !b)
                    ...
                    var c = [];
                    b.results && b.results.length && (c = b.results),
                    1 === c.length ? (this.fire("autoselect", {
                        feature: c[0]
                    }),
                    this.fire("found", {
            ...
            _displayResults: function(a) {
                for (var b = 0, c = Math.min(a.length, 10); c > b; b++) {
                    var d = a[b]
                      , e = d.name
                      , f = [];
                    d.components.city && f.push(d.components.city),
                    d.components.districts[0] && f.push(d.components.districts[0]),
                    d.components.localities[0] && f.push(d.components.localities[0]);
                    var g = f.join("، ");
                    if (e.length) {
        ...
        var d = a("mapbox.js/src/map")
          ...
          , g = d.Map.extend({
            initialize: function(a, b, g) {
                d.Map.prototype.initialize.call(this, a, b, L.extend({}, d.Map.prototype.options, g)),
                this.options.tileLayer && 0 !== Object.keys(this.options.tileLayer).length && (this.tileLayer = e(void 0, c(this.options.tileLayer, this.options.accessToken)),
                this.addLayer(this.tileLayer)),
                this._cedarmapsLogoControl = f(this.options.cedarmapsLogoControl),
                this.addControl(this._cedarmapsLogoControl)
            },
            _initialize: function(a) {
                d.Map.prototype._initialize.call(this, a),
                this._cedarmapsLogoControl._setTileJSON(a)
            }
        });
        b.exports.Map = g,
        b.exports.map = function(a, b, c) {
    ...
    43: [function(a, b) {
        ...
        b.exports = function(a, b, d) {
            var e = {
                toFarsi: function(a) {
                    if (a) {
                        for (var b = ["ي", "ك", "‍", "دِ", "بِ", "زِ", "ذِ", "ِشِ", "ِسِ", "‌", "ى", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], c = ["ی", "ک", "", "د", "ب", "ز", "ذ", "ش", "س", "", "ی", "۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], d = 0, e = b.length; e > d; d++)
                            a = a.replace(new RegExp(b[d],"g"), c[d]);
                        return a
                    }
                },
              ...
              , f = function(a) {
                for (var b in m)
                    p.removeLayer(m[b]);
                if (d.categories)
                    for (var e = 0, f = d.categories.length; f > e; e++)
                        !function(b) {
                                ...
                                c("https://www.kikojas.com/api/search?cat=" + i[e].name + "&latlng=" + a.lat + "," + a.lng + "&limit=" + (d.poiLimit ? d.poiLimit : 3) + "&distance=" + (d.seachDistance ? d.seachDistance : 2), function(b, c) {
                                    ...
                                    if (200 === h.meta.code) {
                                        ...
                                        j.forEach(function(b) {
                                            ...
                                            c += d.noPoiLink && 1 == d.noPoiLink ? '<div class="title">' + b.full_name + "</div>" : '<div class="title"><a href="https://www.kikojas.com' + b.url + '" target="_blank">' + b.full_name + "</a></div>",
                                            c += '<div class="category">' + b.categories[0].name + '</div>                                                        <div class="address">' + b.address + '</div>                                                    </div>                                                </div>                                                <div class="routing" data-from="' + a.lat + "," + a.lng + '" data-to="' + b.latlng + '" onclick="routing(this)")">                                                    <span class="distance">در حال محاسبه فاصله <img src="https://tools.kikojas.com/images/loading-14-blue.gif"/></span>                                                    <div class="route">مسیریابی <img src="https://tools.kikojas.com/images/route-icon.png"/></div>                                                </div>                                                <div class="clear"></div>                                            </div>';
                                            var h = L.marker({
                                                lon: b.lng,
                                                lat: b.lat
                                            }, {
                                              ...
                                              , k = new g(h);
                                            h.on("mouseover", k.onMarkerMouseOver).on("mouseout", k.onMarkerMouseOut),
                                            f.addLayer(h),
                                            j.push(h)
                                        }, this)
                                    }
              ...
              , g = function(a) {
                function b(b) {
                    var c, d = a._icon, e = d.style.backgroundPosition, f = e.split(" ");
                    switch (b) {
                    case "hover":
                        var g = parseInt(d.style.zIndex);
                        d.style.zIndex = g + 1e4,
                        c = f[0] + " -53px";
                        break;
                    case "normal":
                        var g = parseInt(d.style.zIndex);
                ...
                return this.activeMarker = null,
                {
                    onMarkerMouseOver: function() {
                        a.isActive || (null !== self.activeMarker && b("inactive"),
                        b("hover"))
                    },
            ...
            }, j = new L.LatLng(35.393,51.0219), k = new L.LatLng(35.8267,51.6426), l = new L.LatLngBounds(j,k), m = {}, n = "https://api.cedarmaps.com/v1/tiles/cedarmaps.streets.json?access_token=" + L.cedarmaps.accessToken, o = document.getElementById(a);
            ...
            L.Control.CategoryToggle = L.Control.extend({
                onAdd: function(b) {
                    ...
                    var e = (document.getElementById(a).offsetWidth,
                    L.DomUtil.create("ul"));
                    if (L.DomUtil.addClass(e, "tg-list"),
                    d.categories)
                        for (var f = 0, g = d.categories.length; g > f; f++) {
                            ...
                            if (i[h]) {
                                ...
                                l.setAttribute("id", j.slug);
                                var n = L.DomUtil.create("label", "tgl-btn");
                                n.setAttribute("data-tg-off", j.short_name),
                                n.setAttribute("data-tg-on", j.short_name),
                                n.setAttribute("data-toggle", "on"),
                                n.setAttribute("data-cat", d.categories[f]),
                                n.setAttribute("for", j.slug),
                                k.appendChild(l),
                                k.appendChild(n),
                                k.onclick = function(a) {
                                    if (a.target.getAttribute("data-cat")) {
                                        "on" == a.target.getAttribute("data-toggle") ? (b.removeLayer(m[a.target.getAttribute("data-cat")]),
                                        a.target.setAttribute("data-toggle", "off")) : (b.addLayer(m[a.target.getAttribute("data-cat")]),
                                        a.target.setAttribute("data-toggle", "on"));
                                        var c = [];
                                        for (var d in m)
                                            m[d].getBounds().isValid() && c.push(m[d].getBounds());
            ...
            window.routing = function(a) {
                a && a.getAttribute("data-from") && a.getAttribute("data-to") && c("https://api.cedarmaps.com/v1/direction/cedarmaps.driving/" + a.getAttribute("data-from") + ";" + a.getAttribute("data-to") + "?access_token=" + L.cedarmaps.accessToken, function(a, b) {
                    ...
                    c.routes && c.routes.length > 0 && (h && p.removeLayer(h),
                    h = L.geoJson(c.routes[0].geometry),
                    h.addTo(p))
                })
            }
            ,
            window.distance = function(a) {
                if (a && a.getAttribute("data-from") && a.getAttribute("data-to")) {
                    ...
                    d && d.removeAttribute("id"),
                    a.getElementsByClassName("distance")[0].setAttribute("id", "to-replace"),
                    c(b, function(a, b) {
                        if (a)
                            throw a;
                        var c = JSON.parse(b.response).result
                        ...
                        if (d) {
                            if (c.routes && c.routes.length > 0) {
                                ...
                                f > 1e3 && (f /= 1e3,
                                g = "کیلومتر"),
                                d.innerHTML = "فاصله رانندگی تا مکان مورد نظر شما: " + e.toFarsi(e.digitSeperator(Math.round(f))) + " " + g
                            }
    ...
    45: [function(a, b) {
        ...
        var c = a("./config");
        b.exports = function(a) {
            if (a.maptype || (a.maptype = "light"),
            a.alttext || (a.alttext = "Cedarmaps static image."),
            a.position) {
                if ("object" != typeof a.position)
                    throw "Unknown value for position."
            } else
                a.position = "auto";
            if (!a.dimensions)
                throw "Cedarmaps: No dimensions specified.";
            if ("object" != typeof a.dimensions)
                throw "Unknown value for position.";
            ...
            if (a.qs && a.qs.length > 0) {
                for (var f = [], g = 0, h = a.qs.length; h > g; g++)
                    a.qs[g].marker_url || (a.qs[g].marker_url = "marker-default"),
                    f.push(a.qs[g].marker_url),
                    f.push(a.qs[g].lat + "," + a.qs[g].lng);
                e += "&markers=" + f.join("|")
            }
            var i = function() {
                return e
              ...
              , j = function(b) {
                ...
                if (!document.querySelector(b))
                    throw "Cedarmaps: Could not find element " + b;
                var c = document.createElement("img");
                c.setAttribute("src", e),
                c.setAttribute("alt", a.alttext);
    ...
    46: [function(a, b) {
        "use strict";
        var c = (a("mapbox.js/src/util"),
        a("mapbox.js/src/tile_layer"))
